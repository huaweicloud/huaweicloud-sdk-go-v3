...
``` bash
# 安装华为云 Go SDK 库
go get github.com/RandolphCYG/huaweicloud-sdk-go-v3
```

## 代码示例

- 使用如下代码在指定 Region 下查询 VPC 列表，实际使用中请将 `vpc "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/vpc/v2"`
  替换为您使用的产品/服务相应的 `{service} "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/{service}/{version}"`
...
import (
    ...
    vpc "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/vpc/v2"
    "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/vpc/v2/model"
    "net/http"
)
...
每个版本的详细更改记录可在 [变更日志](https://github.com/RandolphCYG/huaweicloud-sdk-go-v3/blob/master/CHANGELOG_CN.md) 中查看。
...
import (
    // 增加region依赖
    "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/iam/v3/region"
)
