...
- The following example shows how to query a list of VPCs in a specific region, you need to substitute your
  real `{service} "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/{service}/{version}"`
  for `vpc "github.com/RandolphCYG/huaweicloud-sdk-go-v3/services/vpc/v2"` in actual use, and initialize the client
...
the [CHANGELOG.md](https://github.com/RandolphCYG/huaweicloud-sdk-go-v3/blob/master/CHANGELOG.md).
