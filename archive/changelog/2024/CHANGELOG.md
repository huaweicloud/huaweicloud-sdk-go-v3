...
- _Features_
  - Support RoundTripper configuration.
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Bug Fix_
  - None
- _Change_
  - Add non-empty check to method WithAk/WithSk of CredentialsBuilder.
...
- _Features_
  - None
- _Bug Fix_
  - The specified maximum number of retries is inconsistent with the actual number of retries.
  - After upgrading from a lower version, the compatibility issue of the Sign function in the signer package cannot be found.
- _Change_
  - None
...
- _Features_
  - Add `SafeBuild` method for credentials and clients that do not cause panic. For details, see [README](./README.md).
- _Bug Fix_
  - None
- _Change_
  - None
