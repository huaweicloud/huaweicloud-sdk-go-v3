...
type InstanceRequest struct {
	...
	Ha *Ha `json:"ha,omitempty" xml:"ha"`
	...
	DataVip *string `json:"data_vip,omitempty" xml:"data_vip"`
	...
	DsspoolId *string `json:"dsspool_id,omitempty" xml:"dsspool_id"`

	// 只读实例的主实例ID。创建只读实例时必选，其它场景不可选。
	ReplicaOfId *string `json:"replica_of_id,omitempty" xml:"replica_of_id"`

	RestorePoint *RestorePoint `json:"restore_point,omitempty" xml:"restore_point"`
	...
	Collation *string `json:"collation,omitempty" xml:"collation"`

	// 标签列表。单个实例总标签数上限10个。
	Tags *[]TagWithKeyValue `json:"tags,omitempty" xml:"tags"`

	UnchangeableParam *UnchangeableParam `json:"unchangeable_param,omitempty" xml:"unchangeable_param"`
