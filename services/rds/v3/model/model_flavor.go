...
type Flavor struct {
	...
	AzStatus map[string]string `json:"az_status" xml:"az_status"`

	// 规格所在az的描述。
	AzDesc map[string]string `json:"az_desc" xml:"az_desc"`
	...
	GroupType string `json:"group_type" xml:"group_type"`
}
