...
// ListDbAgentJobsResult 数据库代理作业响应信息。
type ListDbAgentJobsResult struct {
...
func (o ListDbAgentJobsResult) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListDbAgentJobsResult struct{}"
	}

	return strings.Join([]string{"ListDbAgentJobsResult", string(data)}, " ")
}
