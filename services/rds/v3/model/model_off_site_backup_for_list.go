...
type OffSiteBackupForList struct {
	...
	Status OffSiteBackupForListStatus `json:"status" xml:"status"`

	// 备份类型，取值：  - “auto”: 自动全量备份 - “incremental”: 自动增量备份
	Type OffSiteBackupForListType `json:"type" xml:"type"`

	// 备份大小，单位为KB。
	Size int64 `json:"size" xml:"size"`

	Datastore *ParaGroupDatastore `json:"datastore" xml:"datastore"`
