...
type SparseBackupPolicyForUpdate struct {
...
func (o SparseBackupPolicyForUpdate) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SparseBackupPolicyForUpdate struct{}"
	}

	return strings.Join([]string{"SparseBackupPolicyForUpdate", string(data)}, " ")
}
