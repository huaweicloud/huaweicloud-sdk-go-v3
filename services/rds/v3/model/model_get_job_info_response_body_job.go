...
type GetJobInfoResponseBodyJob struct {
	...
	Status GetJobInfoResponseBodyJobStatus `json:"status" xml:"status"`
	...
	Instance *GetTaskDetailListRspJobsInstance `json:"instance" xml:"instance"`

	// 根据不同的任务，显示不同的内容。
	Entities *interface{} `json:"entities,omitempty" xml:"entities"`
