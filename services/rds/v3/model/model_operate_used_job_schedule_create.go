...
// OperateUsedJobScheduleCreate 策略信息。
type OperateUsedJobScheduleCreate struct {
...
func (o OperateUsedJobScheduleCreate) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "OperateUsedJobScheduleCreate struct{}"
	}

	return strings.Join([]string{"OperateUsedJobScheduleCreate", string(data)}, " ")
}
