...
// OperateUsedJobScheduleModifyPub 策略信息。
type OperateUsedJobScheduleModifyPub struct {
...
func (o OperateUsedJobScheduleModifyPub) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "OperateUsedJobScheduleModifyPub struct{}"
	}

	return strings.Join([]string{"OperateUsedJobScheduleModifyPub", string(data)}, " ")
}
