...
// 用户及其权限。
type PgUserWithPrivilege struct {
...
func (o PgUserWithPrivilege) String() string {
	data, err := json.Marshal(o)
	if err != nil {
		return "PgUserWithPrivilege struct{}"
	}

	return strings.Join([]string{"PgUserWithPrivilege", string(data)}, " ")
}
