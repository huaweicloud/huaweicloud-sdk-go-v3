...
type MetricAlarms struct {
	...
	// 告警名称。
	AlarmName string `json:"alarm_name" xml:"alarm_name"`

	// 告警描述。
	AlarmDescription *string `json:"alarm_description,omitempty" xml:"alarm_description"`

	Metric *MetricInfoForAlarm `json:"metric" xml:"metric"`
	...
	AlarmType *MetricAlarmsAlarmType `json:"alarm_type,omitempty" xml:"alarm_type"`
	...
	AlarmActionBeginTime *string `json:"alarm_action_begin_time,omitempty" xml:"alarm_action_begin_time"`

	// 告警规则生效的结束时间，告警规则仅在生效时间内发送通知消息。例如alarm_action_begin_time为8:00，alarm_action_end_time为20:00时，则对应的告警规则仅在08:00-20:00发送通知消息。
	AlarmActionEndTime *string `json:"alarm_action_end_time,omitempty" xml:"alarm_action_end_time"`
	...
	AlarmState string `json:"alarm_state" xml:"alarm_state"`
