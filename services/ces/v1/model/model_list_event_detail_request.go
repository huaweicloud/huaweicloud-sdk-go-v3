...
type ListEventDetailRequest struct {
	...
	EventType ListEventDetailRequestEventType `json:"event_type" xml:"event_type"`

	// 事件名称，值为系统产生的事件名称，或用户自定义上报的事件名称。
	EventSource *string `json:"event_source,omitempty" xml:"event_source"`

	// 事件的级别，值为Critical，Major，Minor，Info；Critical为紧急，Major为重要，Minor为次要，Info为提示。
	EventLevel *string `json:"event_level,omitempty" xml:"event_level"`
	...
	EventState *string `json:"event_state,omitempty" xml:"event_state"`
