...
type AlarmTemplate struct {
	...
	// 自定义告警模板描述。
	TemplateDescription *string `json:"template_description,omitempty" xml:"template_description"`
	...
	DimensionName *string `json:"dimension_name,omitempty" xml:"dimension_name"`

	// 自定义告警模板添加的一组或者多个告警策略。
	TemplateItems *[]TemplateItem `json:"template_items,omitempty" xml:"template_items"`
