...
func GenReqDefForListAlarmHistories() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("CreateTimeFrom").
		WithJsonTag("create_time_from").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("CreateTimeTo").
		WithJsonTag("create_time_to").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Offset").
		WithJsonTag("offset").
...
func GenReqDefForListAlarmRules() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ResourceLevel").
		WithJsonTag("resource_level").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Offset").
		WithJsonTag("offset").
...
func GenReqDefForListResourceGroupsServicesResources() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ExtendRelationId").
		WithJsonTag("extend_relation_id").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ProductName").
		WithJsonTag("product_name").
...
func GenReqDefForUpdateResourceGroupAssociationAlarmTemplate() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v2/{project_id}/resource-groups/{group_id}/alarm-templates/async-association").
		WithResponse(new(model.UpdateResourceGroupAssociationAlarmTemplateResponse)).
		WithContentType("application/json")
