...
type WidgetMetric struct {
	...
	YAxisPosition *WidgetMetricYAxisPosition `json:"y_axis_position,omitempty"`
...
type WidgetMetricYAxisPosition struct {
	value string
}

type WidgetMetricYAxisPositionEnum struct {
	LEFT  WidgetMetricYAxisPosition
	RIGHT WidgetMetricYAxisPosition
}

func GetWidgetMetricYAxisPositionEnum() WidgetMetricYAxisPositionEnum {
	return WidgetMetricYAxisPositionEnum{
		LEFT: WidgetMetricYAxisPosition{
			value: "left",
		},
		RIGHT: WidgetMetricYAxisPosition{
...
func (c WidgetMetricYAxisPosition) Value() string {
	return c.value
}

func (c WidgetMetricYAxisPosition) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *WidgetMetricYAxisPosition) UnmarshalJSON(b []byte) error {
