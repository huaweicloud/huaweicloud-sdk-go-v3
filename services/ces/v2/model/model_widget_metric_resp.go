...
type WidgetMetricResp struct {
	...
	YAxisPosition *WidgetMetricRespYAxisPosition `json:"y_axis_position,omitempty"`
...
type WidgetMetricRespYAxisPosition struct {
	value string
}

type WidgetMetricRespYAxisPositionEnum struct {
	LEFT  WidgetMetricRespYAxisPosition
	RIGHT WidgetMetricRespYAxisPosition
}

func GetWidgetMetricRespYAxisPositionEnum() WidgetMetricRespYAxisPositionEnum {
	return WidgetMetricRespYAxisPositionEnum{
		LEFT: WidgetMetricRespYAxisPosition{
			value: "left",
		},
		RIGHT: WidgetMetricRespYAxisPosition{
...
func (c WidgetMetricRespYAxisPosition) Value() string {
	return c.value
}

func (c WidgetMetricRespYAxisPosition) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *WidgetMetricRespYAxisPosition) UnmarshalJSON(b []byte) error {
