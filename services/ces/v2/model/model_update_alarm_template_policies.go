...
type UpdateAlarmTemplatePolicies struct {
...
func (o UpdateAlarmTemplatePolicies) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateAlarmTemplatePolicies struct{}"
	}

	return strings.Join([]string{"UpdateAlarmTemplatePolicies", string(data)}, " ")
}
