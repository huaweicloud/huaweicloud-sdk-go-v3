...
type AlarmCondition struct {
	...
	Period AlarmConditionPeriod `json:"period" xml:"period"`
	...
	SuppressDuration *AlarmConditionSuppressDuration `json:"suppress_duration,omitempty" xml:"suppress_duration"`
}
