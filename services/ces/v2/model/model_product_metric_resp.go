...
func (o ProductMetricResp) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProductMetricResp struct{}"
	}

	return strings.Join([]string{"ProductMetricResp", string(data)}, " ")
}
