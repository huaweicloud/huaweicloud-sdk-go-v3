...
// DownloadImportTemplateRequest Request Object
...
func (o DownloadImportTemplateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DownloadImportTemplateRequest struct{}"
	}

	return strings.Join([]string{"DownloadImportTemplateRequest", string(data)}, " ")
}
