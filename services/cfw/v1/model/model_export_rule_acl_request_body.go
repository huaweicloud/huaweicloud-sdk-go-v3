...
type ExportRuleAclRequestBody struct {
...
func (o ExportRuleAclRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExportRuleAclRequestBody struct{}"
	}

	return strings.Join([]string{"ExportRuleAclRequestBody", string(data)}, " ")
}
