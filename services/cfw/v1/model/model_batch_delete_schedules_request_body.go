...
type BatchDeleteSchedulesRequestBody struct {
...
func (o BatchDeleteSchedulesRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchDeleteSchedulesRequestBody struct{}"
	}

	return strings.Join([]string{"BatchDeleteSchedulesRequestBody", string(data)}, " ")
}
