...
type RuleAclResponseData struct {
...
func (o RuleAclResponseData) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RuleAclResponseData struct{}"
	}

	return strings.Join([]string{"RuleAclResponseData", string(data)}, " ")
}
