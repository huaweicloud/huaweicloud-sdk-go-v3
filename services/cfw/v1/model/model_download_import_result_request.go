...
// DownloadImportResultRequest Request Object
...
func (o DownloadImportResultRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DownloadImportResultRequest struct{}"
	}

	return strings.Join([]string{"DownloadImportResultRequest", string(data)}, " ")
}
