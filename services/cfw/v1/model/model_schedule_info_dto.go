...
type ScheduleInfoDto struct {
	...
	Periodic *[]ScheduleInfoDtoPeriodic `json:"periodic,omitempty"`

	Absolute *ScheduleInfoDtoAbsolute `json:"absolute,omitempty"`
}

func (o ScheduleInfoDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ScheduleInfoDto struct{}"
	}

	return strings.Join([]string{"ScheduleInfoDto", string(data)}, " ")
}
