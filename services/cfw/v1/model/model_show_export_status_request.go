...
// ShowExportStatusRequest Request Object
type ShowExportStatusRequest struct {
...
func (o ShowExportStatusRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowExportStatusRequest struct{}"
	}

	return strings.Join([]string{"ShowExportStatusRequest", string(data)}, " ")
}
