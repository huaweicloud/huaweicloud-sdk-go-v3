...
func (o BatchDeleteDomainSetRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchDeleteDomainSetRequest struct{}"
	}

	return strings.Join([]string{"BatchDeleteDomainSetRequest", string(data)}, " ")
}
