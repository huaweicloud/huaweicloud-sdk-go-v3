...
// ListReportHistoryRequest Request Object
type ListReportHistoryRequest struct {
...
func (o ListReportHistoryRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListReportHistoryRequest struct{}"
	}

	return strings.Join([]string{"ListReportHistoryRequest", string(data)}, " ")
}
