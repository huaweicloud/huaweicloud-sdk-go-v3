...
type DailyLog struct {
	...
	// 触发时流量
	TriggerBps int32 `json:"trigger_bps" xml:"trigger_bps"`

	// 触发时报文速率
	TriggerPps int32 `json:"trigger_pps" xml:"trigger_pps"`

	// 触发时HTTP请求速率
	TriggerHttpPps int32 `json:"trigger_http_pps" xml:"trigger_http_pps"`
}
