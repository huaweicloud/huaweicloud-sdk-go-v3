...
func (o CreateInstanceAccessControlAttributeConfigurationRequest) String() string {
	...
	if err != nil {
		return "CreateInstanceAccessControlAttributeConfigurationRequest struct{}"
	}

	return strings.Join([]string{"CreateInstanceAccessControlAttributeConfigurationRequest", string(data)}, " ")
}
