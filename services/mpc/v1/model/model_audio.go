...
type Audio struct {
	...
	OutputPolicy *AudioOutputPolicy `json:"output_policy,omitempty" xml:"output_policy"`

	// 音频编码格式。  取值如下：  - 1：AAC格式。 - 2：HEAAC1格式 。 - 3：HEAAC2格式。 - 4：MP3格式 。
	Codec int32 `json:"codec" xml:"codec"`
	...
	SampleRate int32 `json:"sample_rate" xml:"sample_rate"`
