...
type ListSummaryRequest struct {
	Range ListSummaryRequestRange `json:"range"`
}

func (o ListSummaryRequest) String() string {
	data, _ := json.Marshal(o)
	return strings.Join([]string{"ListSummaryRequest", string(data)}, " ")
}

type ListSummaryRequestRange struct {
	value string
}

type ListSummaryRequestRangeEnum struct {
	WEEK  ListSummaryRequestRange
	MONTH ListSummaryRequestRange
}

func GetListSummaryRequestRangeEnum() ListSummaryRequestRangeEnum {
	return ListSummaryRequestRangeEnum{
		WEEK: ListSummaryRequestRange{
			value: "week",
		},
		MONTH: ListSummaryRequestRange{
...
func (c ListSummaryRequestRange) MarshalJSON() ([]byte, error) {
	return json.Marshal(c.value)
}

func (c *ListSummaryRequestRange) UnmarshalJSON(b []byte) error {
