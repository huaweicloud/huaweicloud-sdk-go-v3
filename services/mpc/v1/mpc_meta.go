...
func GenReqDefForCreateAgenciesTask() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/agencies").
		WithResponse(new(model.CreateAgenciesTaskResponse)).
		WithContentType("application/json")
...
func GenReqDefForListAllObsObjList() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		...
		WithResponse(new(model.ListAllObsObjListResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateEditingJob() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/editing/jobs").
		WithResponse(new(model.CreateEditingJobResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteEditingJob() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v1/{project_id}/editing/jobs").
		WithResponse(new(model.DeleteEditingJobResponse)).
		WithContentType("application/json")
...
func GenReqDefForListEditingJob() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/editing/jobs").
		WithResponse(new(model.ListEditingJobResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateEditingJobs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/editing/jobs").
		WithResponse(new(model.CreateEditingJobsResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteEditingJobs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v2/{project_id}/editing/jobs/{job_id}").
		WithResponse(new(model.DeleteEditingJobsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListEditingJobs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/editing/jobs").
		WithResponse(new(model.ListEditingJobsResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteTranscodingTaskByConsole() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		...
		WithResponse(new(model.DeleteTranscodingTaskByConsoleResponse)).
		WithContentType("application/json")
...
func GenReqDefForListStatSummary() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		...
		WithResponse(new(model.ListStatSummaryResponse)).
		WithContentType("application/json")
