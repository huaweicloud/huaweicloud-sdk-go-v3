...
func (o ExternalShowGlobalDcGateway) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExternalShowGlobalDcGateway struct{}"
	}

	return strings.Join([]string{"ExternalShowGlobalDcGateway", string(data)}, " ")
}
