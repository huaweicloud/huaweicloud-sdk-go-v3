...
func (o ExternalUpdateGlobalDcGateway) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExternalUpdateGlobalDcGateway struct{}"
	}

	return strings.Join([]string{"ExternalUpdateGlobalDcGateway", string(data)}, " ")
}
