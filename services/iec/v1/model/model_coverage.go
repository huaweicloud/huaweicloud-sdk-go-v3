...
type Coverage struct {
	...
	CoveragePolicy string `json:"coverage_policy" xml:"coverage_policy"`
	...
	CoverageLevel string `json:"coverage_level" xml:"coverage_level"`

	// 区域及购买数量列表。
	CoverageSites []CoverageSite `json:"coverage_sites" xml:"coverage_sites"`
}
...
func (o Coverage) String() string {
	...
	return strings.Join([]string{"Coverage", string(data)}, " ")
}
