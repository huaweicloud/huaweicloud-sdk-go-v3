...
type SecurityGroupRule struct {
	...
	Direction *SecurityGroupRuleDirection `json:"direction,omitempty" xml:"direction"`

	// IP协议类型。  取值范围：IPv4[，IPv6](tag:hide)  约束：不填默认值为IPv4
	Ethertype *SecurityGroupRuleEthertype `json:"ethertype,omitempty" xml:"ethertype"`
