...
type Resource struct {
	...
	WithPrefix *bool `json:"with_prefix,omitempty" xml:"with_prefix"`

	// 待发放边缘实例的系统镜像，需要指定已创建镜像的ID。 > 镜像的ID可以从控制台或者参考本文档的“查询边镜像列表”的章节获取。
	ImageRef string `json:"image_ref" xml:"image_ref"`
	...
	AdminPass *string `json:"admin_pass,omitempty" xml:"admin_pass"`

	// 密钥对名称。
	KeyName *string `json:"key_name,omitempty" xml:"key_name"`

	NetConfig *NetConfig `json:"net_config" xml:"net_config"`

	Bandwidth *BandwidthConfig `json:"bandwidth,omitempty" xml:"bandwidth"`

	RootVolume *RootVolume `json:"root_volume" xml:"root_volume"`

	// 边缘实例对应数据盘相关配置。每一个数据结构代表一块待创建的数据盘。  约束：目前边缘实例最多可挂载2块数据盘
	DataVolumes *[]DataVolume `json:"data_volumes,omitempty" xml:"data_volumes"`

	// 边缘实例数量。 不传该字段时默认取值为1。
	Count *int32 `json:"count,omitempty" xml:"count"`

	// 边缘业务对应安全组信息。
	SecurityGroups *[]SecurityGroupOption `json:"security_groups,omitempty" xml:"security_groups"`
