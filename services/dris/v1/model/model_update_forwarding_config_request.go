...
// UpdateForwardingConfigRequest Request Object
...
func (o UpdateForwardingConfigRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateForwardingConfigRequest struct{}"
	}

	return strings.Join([]string{"UpdateForwardingConfigRequest", string(data)}, " ")
}
