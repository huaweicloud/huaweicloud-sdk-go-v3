...
// CreateTrafficControllerResponse Response Object
...
func (o CreateTrafficControllerResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateTrafficControllerResponse struct{}"
	}

	return strings.Join([]string{"CreateTrafficControllerResponse", string(data)}, " ")
}
