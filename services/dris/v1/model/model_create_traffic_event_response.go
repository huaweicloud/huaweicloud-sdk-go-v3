...
// CreateTrafficEventResponse Response Object
...
func (o CreateTrafficEventResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateTrafficEventResponse struct{}"
	}

	return strings.Join([]string{"CreateTrafficEventResponse", string(data)}, " ")
}
