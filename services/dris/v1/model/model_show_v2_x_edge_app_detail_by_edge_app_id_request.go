...
// ShowV2XEdgeAppDetailByEdgeAppIdRequest Request Object
...
func (o ShowV2XEdgeAppDetailByEdgeAppIdRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowV2XEdgeAppDetailByEdgeAppIdRequest struct{}"
	}

	return strings.Join([]string{"ShowV2XEdgeAppDetailByEdgeAppIdRequest", string(data)}, " ")
}
