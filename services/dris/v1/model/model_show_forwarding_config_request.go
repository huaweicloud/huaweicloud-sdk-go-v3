...
// ShowForwardingConfigRequest Request Object
...
func (o ShowForwardingConfigRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowForwardingConfigRequest struct{}"
	}

	return strings.Join([]string{"ShowForwardingConfigRequest", string(data)}, " ")
}
