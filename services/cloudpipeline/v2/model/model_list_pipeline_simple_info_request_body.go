...
type ListPipelineSimpleInfoRequestBody struct {
	...
	ProjectIds *string `json:"project_ids,omitempty" xml:"project_ids"`

	// 创建人id。该参数存在，逗号分隔，id个数取值[0,10]
	CreatorIds *string `json:"creator_ids,omitempty" xml:"creator_ids"`

	// 执行人id。该参数存在，逗号分隔，id个数取值[0,10]；
	ExecutorIds *string `json:"executor_ids,omitempty" xml:"executor_ids"`
