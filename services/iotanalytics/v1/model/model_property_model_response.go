...
type PropertyModelResponse struct {
	...
	SourceType string `json:"source_type" xml:"source_type"`

	DataSchema *DataSchema `json:"data_schema" xml:"data_schema"`
	...
	IsTag *bool `json:"is_tag,omitempty" xml:"is_tag"`

	// 属性ID
	PropertyId *string `json:"property_id,omitempty" xml:"property_id"`
}

func (o PropertyModelResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PropertyModelResponse struct{}"
	}

	return strings.Join([]string{"PropertyModelResponse", string(data)}, " ")
}
