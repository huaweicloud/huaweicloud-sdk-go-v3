...
type OutputRequest struct {
	...
	OutputStaticAssetId *string `json:"output_static_asset_id,omitempty" xml:"output_static_asset_id"`
	...
	OutputDynamicAssetId *string `json:"output_dynamic_asset_id,omitempty" xml:"output_dynamic_asset_id"`
}
