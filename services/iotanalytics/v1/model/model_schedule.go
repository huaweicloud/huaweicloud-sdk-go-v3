...
type Schedule struct {
	...
	CronExpression string `json:"cron_expression" xml:"cron_expression"`
	...
	NextFireTime *string `json:"next_fire_time,omitempty" xml:"next_fire_time"`

	// 仅在查询作业和查询所有作业接口的响应返回。下一次调度开始时间。
	PrevFireTime *string `json:"prev_fire_time,omitempty" xml:"prev_fire_time"`
}
