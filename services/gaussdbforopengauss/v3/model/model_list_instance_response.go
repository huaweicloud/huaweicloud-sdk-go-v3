...
type ListInstanceResponse struct {
	...
	Datastore *ListDatastore `json:"datastore" xml:"datastore"`
	...
	FlavorInfo *ListFlavorInfo `json:"flavor_info" xml:"flavor_info"`

	Volume *ListVolume `json:"volume" xml:"volume"`
	...
	BackupStrategy *OpenGaussBackupStrategyForListResponse `json:"backup_strategy" xml:"backup_strategy"`

	// 可维护时间窗，为UTC时间。
	MaintenanceWindow string `json:"maintenance_window" xml:"maintenance_window"`

	// 实例节点信息。
	Nodes []interface{} `json:"nodes" xml:"nodes"`
	...
	InstanceMode string `json:"instance_mode" xml:"instance_mode"`

	// 磁盘加密密钥ID。只有创建磁盘加密实例才会显示该参数。
	DiskEncryptionId string `json:"disk_encryption_id" xml:"disk_encryption_id"`

	ChargeInfo *OpenGaussChargeInfoListResponse `json:"charge_info" xml:"charge_info"`
