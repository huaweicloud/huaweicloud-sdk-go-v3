...
type OpenGaussChargeInfo struct {
	...
	ChargeMode OpenGaussChargeInfoChargeMode `json:"charge_mode" xml:"charge_mode"`

	// 订购周期类型。month：包月。year：包年。 说明： “charge_mode”为“prePaid”时生效，且为必选值。
	PeriodType *OpenGaussChargeInfoPeriodType `json:"period_type,omitempty" xml:"period_type"`
