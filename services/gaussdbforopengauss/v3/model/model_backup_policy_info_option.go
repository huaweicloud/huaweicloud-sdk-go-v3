...
// BackupPolicyInfoOption 备份策略信息
type BackupPolicyInfoOption struct {
...
func (o BackupPolicyInfoOption) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BackupPolicyInfoOption struct{}"
	}

	return strings.Join([]string{"BackupPolicyInfoOption", string(data)}, " ")
}
