...
type ListInstancesDetailsRequest struct {
	...
	ChargeMode *ListInstancesDetailsRequestChargeMode `json:"charge_mode,omitempty"`
}
...
func GetListInstancesDetailsRequestTypeEnum() ListInstancesDetailsRequestTypeEnum {
	return ListInstancesDetailsRequestTypeEnum{
		ENTERPRISE: ListInstancesDetailsRequestType{
			value: "Enterprise",
		},
		HA: ListInstancesDetailsRequestType{
...
func GetListInstancesDetailsRequestDatastoreTypeEnum() ListInstancesDetailsRequestDatastoreTypeEnum {
	return ListInstancesDetailsRequestDatastoreTypeEnum{
		GAUSS_DB: ListInstancesDetailsRequestDatastoreType{
			value: "GaussDB",
		},
	}
...
type ListInstancesDetailsRequestChargeModeEnum struct {
	POST_PAID ListInstancesDetailsRequestChargeMode
	PRE_PAID  ListInstancesDetailsRequestChargeMode
}

func GetListInstancesDetailsRequestChargeModeEnum() ListInstancesDetailsRequestChargeModeEnum {
	return ListInstancesDetailsRequestChargeModeEnum{
		POST_PAID: ListInstancesDetailsRequestChargeMode{
			value: "postPaid",
		},
		PRE_PAID: ListInstancesDetailsRequestChargeMode{
