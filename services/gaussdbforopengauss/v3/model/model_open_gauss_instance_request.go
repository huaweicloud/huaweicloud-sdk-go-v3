...
type OpenGaussInstanceRequest struct {
	...
	Datastore *OpenGaussDatastore `json:"datastore" xml:"datastore"`

	Ha *OpenGaussHa `json:"ha" xml:"ha"`
	...
	BackupStrategy *OpenGaussBackupStrategy `json:"backup_strategy,omitempty" xml:"backup_strategy"`
	...
	Volume *OpenGaussVolume `json:"volume" xml:"volume"`
	...
	ChargeInfo *OpenGaussChargeInfo `json:"charge_info,omitempty" xml:"charge_info"`
	...
	ShardingNum *int32 `json:"sharding_num,omitempty" xml:"sharding_num"`

	// 仅分布式形态需要填写该参数。协调节点数量，取值范围1~9。CN数量必须小于或等于两倍的分片数。
	CoordinatorNum *int32 `json:"coordinator_num,omitempty" xml:"coordinator_num"`
	...
	ReplicaNum *OpenGaussInstanceRequestReplicaNum `json:"replica_num,omitempty" xml:"replica_num"`
	...
	EnableForceSwitch *bool `json:"enable_force_switch,omitempty" xml:"enable_force_switch"`
}
