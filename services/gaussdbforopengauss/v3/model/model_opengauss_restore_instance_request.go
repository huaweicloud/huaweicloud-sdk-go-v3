...
type OpengaussRestoreInstanceRequest struct {
	...
	RestorePoint *RestorePoint `json:"restore_point" xml:"restore_point"`
	...
	EnableParallelRestore *bool `json:"enable_parallel_restore,omitempty" xml:"enable_parallel_restore"`
