...
// CreateDatabaseInstanceResult 实例信息。
type CreateDatabaseInstanceResult struct {
...
func (o CreateDatabaseInstanceResult) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateDatabaseInstanceResult struct{}"
	}

	return strings.Join([]string{"CreateDatabaseInstanceResult", string(data)}, " ")
}
