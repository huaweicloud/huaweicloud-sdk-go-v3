...
type HbaConfOption struct {
	...
	Type HbaConfOptionType `json:"type"`
	...
	Method HbaConfOptionMethod `json:"method"`
}

func (o HbaConfOption) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "HbaConfOption struct{}"
	}

	return strings.Join([]string{"HbaConfOption", string(data)}, " ")
}

type HbaConfOptionType struct {
	value string
}

type HbaConfOptionTypeEnum struct {
	HOST      HbaConfOptionType
	HOSTNOSSL HbaConfOptionType
	HOSTSSL   HbaConfOptionType
}

func GetHbaConfOptionTypeEnum() HbaConfOptionTypeEnum {
	return HbaConfOptionTypeEnum{
		HOST: HbaConfOptionType{
			value: "host",
		},
		HOSTNOSSL: HbaConfOptionType{
...
func (c HbaConfOptionType) Value() string {
	return c.value
}

func (c HbaConfOptionType) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *HbaConfOptionType) UnmarshalJSON(b []byte) error {
...
type HbaConfOptionMethod struct {
	value string
}

type HbaConfOptionMethodEnum struct {
	REJECT HbaConfOptionMethod
	MD5    HbaConfOptionMethod
	SHA256 HbaConfOptionMethod
	SM3    HbaConfOptionMethod
	CERT   HbaConfOptionMethod
}

func GetHbaConfOptionMethodEnum() HbaConfOptionMethodEnum {
	return HbaConfOptionMethodEnum{
		REJECT: HbaConfOptionMethod{
			value: "reject",
		},
		MD5: HbaConfOptionMethod{
...
func (c HbaConfOptionMethod) Value() string {
	return c.value
}

func (c HbaConfOptionMethod) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *HbaConfOptionMethod) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
