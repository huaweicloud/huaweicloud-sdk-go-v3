...
type PrePaidServerDataVolumeExtendParam struct {
	...
	ResourceSpecCode *string `json:"resourceSpecCode,omitempty" xml:"resourceSpecCode"`

	// 磁盘产品资源类型。  > 说明： >  > 废弃字段。
	ResourceType *string `json:"resourceType,omitempty" xml:"resourceType"`
	...
	SnapshotId *string `json:"snapshotId,omitempty" xml:"snapshotId"`
}
