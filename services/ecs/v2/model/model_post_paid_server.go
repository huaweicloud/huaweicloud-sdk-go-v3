...
type PostPaidServer struct {
	...
	AutoTerminateTime *string `json:"auto_terminate_time,omitempty" xml:"auto_terminate_time"`
	...
	BatchCreateInMultiAz *bool `json:"batch_create_in_multi_az,omitempty" xml:"batch_create_in_multi_az"`

	// 创建云服务器数量。  约束：  - 不传该字段时默认取值为1。 - 租户的配额足够时，最大值为500。
	Count *int32 `json:"count,omitempty" xml:"count"`

	// 云服务器对应数据盘相关配置。每一个数据结构代表一块待创建的数据盘。 约束：目前新创建的弹性云服务器最多可挂载23块数据盘。
	DataVolumes *[]PostPaidServerDataVolume `json:"data_volumes,omitempty" xml:"data_volumes"`

	Extendparam *PostPaidServerExtendParam `json:"extendparam,omitempty" xml:"extendparam"`
	...
	FlavorRef string `json:"flavorRef" xml:"flavorRef"`
	...
	ImageRef string `json:"imageRef" xml:"imageRef"`

	// 当批量创建弹性云服务器时，云服务器名称是否允许重名，当count大于1的时候该参数生效。默认为True。  - True，表示允许重名。 - False，表示不允许重名。
	IsAutoRename *bool `json:"isAutoRename,omitempty" xml:"isAutoRename"`
	...
	Nics []PostPaidServerNic `json:"nics" xml:"nics"`

	OsschedulerHints *PostPaidServerSchedulerHints `json:"os:scheduler_hints,omitempty" xml:"os:scheduler_hints"`

	Publicip *PostPaidServerPublicip `json:"publicip,omitempty" xml:"publicip"`

	RootVolume *PostPaidServerRootVolume `json:"root_volume" xml:"root_volume"`

	// 云服务器对应安全组信息。  约束：当该值指定为空时，默认给云服务器绑定default安全组。
	SecurityGroups *[]PostPaidServerSecurityGroup `json:"security_groups,omitempty" xml:"security_groups"`

	// 弹性云服务器的标签。  > 说明： >  > 创建弹性云服务器时，一台弹性云服务器最多可以添加10个标签。 > 公有云新增server_tags字段，该字段与tags字段功能相同，支持的key、value取值范围更广，建议使用server_tags字段。
	ServerTags *[]PostPaidServerTag `json:"server_tags,omitempty" xml:"server_tags"`
