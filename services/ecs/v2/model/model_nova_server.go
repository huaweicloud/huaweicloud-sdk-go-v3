...
type NovaServer struct {
	...
	Status NovaServerStatus `json:"status" xml:"status"`
	...
	Flavor *NovaServerFlavor `json:"flavor" xml:"flavor"`

	Image *NovaServerImage `json:"image" xml:"image"`
	...
	// 云服务器对应的网络地址信息。
	Addresses map[string][]NovaNetwork `json:"addresses" xml:"addresses"`

	// 云服务器所属安全组列表。
	SecurityGroups []NovaServerSecurityGroup `json:"security_groups" xml:"security_groups"`
	...
	OSDCFdiskConfig NovaServerOSDCFdiskConfig `json:"OS-DCF:diskConfig" xml:"OS-DCF:diskConfig"`
	...
	OSEXTSTStaskState NovaServerOSEXTSTStaskState `json:"OS-EXT-STS:task_state" xml:"OS-EXT-STS:task_state"`
	...
	OSEXTSTSvmState NovaServerOSEXTSTSvmState `json:"OS-EXT-STS:vm_state" xml:"OS-EXT-STS:vm_state"`
	...
	// 云服务器挂载的云磁盘信息。
	OsExtendedVolumesvolumesAttached []NovaServerVolume `json:"os-extended-volumes:volumes_attached" xml:"os-extended-volumes:volumes_attached"`

	Fault *NovaServerFault `json:"fault,omitempty" xml:"fault"`

	// 弹性云服务器的描述信息。  微版本2.19后支持
	Description *string `json:"description,omitempty" xml:"description"`

	// nova-compute状态。  - UP：服务正常 - UNKNOWN：状态未知 - DOWN：服务异常 - MAINTENANCE：维护状态 - 空字符串：弹性云服务器无主机信息
	HostStatus NovaServerHostStatus `json:"host_status" xml:"host_status"`
	...
	OsschedulerHints *NovaServerSchedulerHints `json:"os:scheduler_hints,omitempty" xml:"os:scheduler_hints"`
}
