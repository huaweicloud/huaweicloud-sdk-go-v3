...
type NovaCreateServersResult struct {
	...
	OSDCFdiskConfig NovaCreateServersResultOSDCFdiskConfig `json:"OS-DCF:diskConfig" xml:"OS-DCF:diskConfig"`

	// 通过返回的reservation_id，可以过滤查询到本次创建的弹性云服务器。  > 说明： >  > 批量创建弹性云服务器时，支持使用该字段。
	ReservationId *string `json:"reservation_id,omitempty" xml:"reservation_id"`

	// Windows弹性云服务器Administrator用户的密码。
	AdminPass string `json:"adminPass" xml:"adminPass"`
}
