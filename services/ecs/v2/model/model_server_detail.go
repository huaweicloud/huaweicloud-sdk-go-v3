...
type ServerDetail struct {
	...
	// 弹性云服务器所在主机的主机名称。
	OSEXTSRVATTRhost string `json:"OS-EXT-SRV-ATTR:host" xml:"OS-EXT-SRV-ATTR:host"`

	// 弹性云服务器的网络属性。
	Addresses map[string][]ServerAddress `json:"addresses" xml:"addresses"`

	// 弹性云服务器使用的密钥对名称。
	KeyName string `json:"key_name" xml:"key_name"`

	Image *ServerImage `json:"image" xml:"image"`

	// 扩展属性，弹性云服务器当前任务的状态。  取值范围请参考[云服务器状态](https://support.huaweicloud.com/api-ecs/ecs_08_0002.html)表3。
	OSEXTSTStaskState string `json:"OS-EXT-STS:task_state" xml:"OS-EXT-STS:task_state"`

	// 扩展属性，弹性云服务器当前状态。  云服务器状态说明请参考[云服务器状态](https://support.huaweicloud.com/api-ecs/ecs_08_0002.html)。
	OSEXTSTSvmState string `json:"OS-EXT-STS:vm_state" xml:"OS-EXT-STS:vm_state"`

	// 扩展属性，弹性云服务器别名。
	OSEXTSRVATTRinstanceName string `json:"OS-EXT-SRV-ATTR:instance_name" xml:"OS-EXT-SRV-ATTR:instance_name"`

	// 扩展属性，弹性云服务器所在虚拟化主机名。
	OSEXTSRVATTRhypervisorHostname string `json:"OS-EXT-SRV-ATTR:hypervisor_hostname" xml:"OS-EXT-SRV-ATTR:hypervisor_hostname"`

	Flavor *ServerFlavor `json:"flavor" xml:"flavor"`

	// 弹性云服务器ID，格式为UUID。
	Id string `json:"id" xml:"id"`

	// 弹性云服务器所属安全组列表。
	SecurityGroups []ServerSecurityGroup `json:"security_groups" xml:"security_groups"`

	// 扩展属性，弹性云服务器所在可用区名称。
	OSEXTAZavailabilityZone string `json:"OS-EXT-AZ:availability_zone" xml:"OS-EXT-AZ:availability_zone"`
	...
	// 预留属性。
	AccessIPv4 string `json:"accessIPv4" xml:"accessIPv4"`

	// 预留属性。
	AccessIPv6 string `json:"accessIPv6" xml:"accessIPv6"`

	Fault *ServerFault `json:"fault,omitempty" xml:"fault"`

	// 弹性云服务器进度。
	Progress *int32 `json:"progress,omitempty" xml:"progress"`

	// 扩展属性，弹性云服务器电源状态。
	OSEXTSTSpowerState int32 `json:"OS-EXT-STS:power_state" xml:"OS-EXT-STS:power_state"`

	// config drive信息。
	ConfigDrive string `json:"config_drive" xml:"config_drive"`
	...
	OSSRVUSGlaunchedAt string `json:"OS-SRV-USG:launched_at" xml:"OS-SRV-USG:launched_at"`

	// 弹性云服务器删除时间。  时间格式例如：2019-05-22T03:23:59.000000
	OSSRVUSGterminatedAt string `json:"OS-SRV-USG:terminated_at" xml:"OS-SRV-USG:terminated_at"`

	// 挂载到弹性云服务器上的磁盘。
	OsExtendedVolumesvolumesAttached []ServerExtendVolumeAttachment `json:"os-extended-volumes:volumes_attached" xml:"os-extended-volumes:volumes_attached"`

	// 弹性云服务器的描述信息。
	Description *string `json:"description,omitempty" xml:"description"`

	// nova-compute状态。  - UP：服务正常 - UNKNOWN：状态未知 - DOWN：服务异常 - MAINTENANCE：维护状态 - 空字符串：弹性云服务器无主机信息
	HostStatus string `json:"host_status" xml:"host_status"`

	// 弹性云服务器的主机名。
	OSEXTSRVATTRhostname string `json:"OS-EXT-SRV-ATTR:hostname" xml:"OS-EXT-SRV-ATTR:hostname"`

	// 批量创建场景，弹性云服务器的预留ID。
	OSEXTSRVATTRreservationId *string `json:"OS-EXT-SRV-ATTR:reservation_id,omitempty" xml:"OS-EXT-SRV-ATTR:reservation_id"`

	// 批量创建场景，弹性云服务器的启动顺序。
	OSEXTSRVATTRlaunchIndex int32 `json:"OS-EXT-SRV-ATTR:launch_index" xml:"OS-EXT-SRV-ATTR:launch_index"`

	// 若使用AMI格式的镜像，则表示kernel image的UUID；否则，留空。
	OSEXTSRVATTRkernelId string `json:"OS-EXT-SRV-ATTR:kernel_id" xml:"OS-EXT-SRV-ATTR:kernel_id"`

	// 若使用AMI格式镜像，则表示ramdisk image的UUID；否则，留空。
	OSEXTSRVATTRramdiskId string `json:"OS-EXT-SRV-ATTR:ramdisk_id" xml:"OS-EXT-SRV-ATTR:ramdisk_id"`

	// 弹性云服务器系统盘的设备名称。
	OSEXTSRVATTRrootDeviceName string `json:"OS-EXT-SRV-ATTR:root_device_name" xml:"OS-EXT-SRV-ATTR:root_device_name"`
	...
	OsschedulerHints *ServerSchedulerHints `json:"os:scheduler_hints,omitempty" xml:"os:scheduler_hints"`

	// 弹性云服务器所属的企业项目ID。
	EnterpriseProjectId *string `json:"enterprise_project_id,omitempty" xml:"enterprise_project_id"`

	// 弹性云服务器系统标签。
	SysTags *[]ServerSystemTag `json:"sys_tags,omitempty" xml:"sys_tags"`

	CpuOptions *CpuOptions `json:"cpu_options,omitempty" xml:"cpu_options"`

	Hypervisor *Hypervisor `json:"hypervisor,omitempty" xml:"hypervisor"`
}
