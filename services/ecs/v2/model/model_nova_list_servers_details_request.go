...
type NovaListServersDetailsRequest struct {
	...
	NotTags *string `json:"not-tags,omitempty" xml:"not-tags"`
	...
	SortKey *NovaListServersDetailsRequestSortKey `json:"sort_key,omitempty" xml:"sort_key"`
	...
	Status *NovaListServersDetailsRequestStatus `json:"status,omitempty" xml:"status"`
