...
type FlavorExtraSpec struct {
	...
	InstanceVnicinstanceBandwidth int32 `json:"instance_vnic:instance_bandwidth"`
	// 最大网卡个数，最大为4。
	InstanceVnicmaxCount int32 `json:"instance_vnic:max_count"`
	...
	ExtraSpeciopersistentGrant *bool `json:"extra_spec:io:persistent_grant,omitempty"`
