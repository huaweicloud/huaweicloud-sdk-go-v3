...
type PostPaidServerExtendParam struct {
	...
	InterruptionPolicy *PostPaidServerExtendParamInterruptionPolicy `json:"interruption_policy,omitempty" xml:"interruption_policy"`
	...
	CbCsbsBackup *string `json:"CB_CSBS_BACKUP,omitempty" xml:"CB_CSBS_BACKUP"`
}
