...
type PrePaidServer struct {
	...
	Nics []PrePaidServerNic `json:"nics" xml:"nics"`

	Publicip *PrePaidServerPublicip `json:"publicip,omitempty" xml:"publicip"`
	...
	RootVolume *PrePaidServerRootVolume `json:"root_volume" xml:"root_volume"`

	// 云服务器对应数据盘相关配置。每一个数据结构代表一块待创建的数据盘。   约束：目前新创建的弹性云服务器最多可挂载23块数据盘。
	DataVolumes *[]PrePaidServerDataVolume `json:"data_volumes,omitempty" xml:"data_volumes"`

	// 云服务器对应安全组信息。  约束：当该值指定为空时，默认给云服务器绑定default安全组。
	SecurityGroups *[]PrePaidServerSecurityGroup `json:"security_groups,omitempty" xml:"security_groups"`
	...
	Extendparam *PrePaidServerExtendParam `json:"extendparam,omitempty" xml:"extendparam"`
	...
	OsschedulerHints *PrePaidServerSchedulerHints `json:"os:scheduler_hints,omitempty" xml:"os:scheduler_hints"`
	...
	ServerTags *[]PrePaidServerTag `json:"server_tags,omitempty" xml:"server_tags"`
