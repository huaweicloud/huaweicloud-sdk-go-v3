...
type PostPaidServerRootVolume struct {
	...
	Volumetype PostPaidServerRootVolumeVolumetype `json:"volumetype" xml:"volumetype"`
	...
	ClusterType *PostPaidServerRootVolumeClusterType `json:"cluster_type,omitempty" xml:"cluster_type"`

	// 使用SDI规格创建虚拟机时请关注该参数，如果该参数值为true，说明创建的为scsi类型的卷
	ClusterId *string `json:"cluster_id,omitempty" xml:"cluster_id"`

	Extendparam *PostPaidServerRootVolumeExtendParam `json:"extendparam,omitempty" xml:"extendparam"`
}
