...
type PrePaidServerRootVolume struct {
	...
	Volumetype PrePaidServerRootVolumeVolumetype `json:"volumetype" xml:"volumetype"`
	...
	Extendparam *PrePaidServerRootVolumeExtendParam `json:"extendparam,omitempty" xml:"extendparam"`

	// 云服务器系统盘对应的磁盘存储类型。 磁盘存储类型枚举值： DSS：专属存储类型
	ClusterType *PrePaidServerRootVolumeClusterType `json:"cluster_type,omitempty" xml:"cluster_type"`
