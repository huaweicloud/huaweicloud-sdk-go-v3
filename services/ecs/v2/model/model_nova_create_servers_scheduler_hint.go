...
type NovaCreateServersSchedulerHint struct {
	...
	DifferentHost *[]string `json:"different_host,omitempty" xml:"different_host"`

	// 与指定的弹性云服务器满足亲和性。   当前不支持该功能。
	SameHost *[]string `json:"same_host,omitempty" xml:"same_host"`
	...
	BuildNearHostIp *string `json:"build_near_host_ip,omitempty" xml:"build_near_host_ip"`
