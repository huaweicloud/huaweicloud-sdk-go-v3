...
type NovaCreateServersOption struct {
	...
	BlockDeviceMappingV2 *[]NovaServerBlockDeviceMapping `json:"block_device_mapping_v2,omitempty" xml:"block_device_mapping_v2"`
	...
	SecurityGroups *[]NovaServerSecurityGroup `json:"security_groups,omitempty" xml:"security_groups"`

	// 扩展属性，指定弹性云服务器的网卡信息。有多个租户网络时必须指定。
	Networks []NovaServerNetwork `json:"networks" xml:"networks"`
	...
	ReturnReservationId *bool `json:"return_reservation_id,omitempty" xml:"return_reservation_id"`

	// 扩展属性，表示创建弹性云服务器最小数量。  默认值为1。  > 说明： >  > 指定镜像创建弹性云服务器时，支持使用该字段。
	MinCount *int32 `json:"min_count,omitempty" xml:"min_count"`
	...
	MaxCount *int32 `json:"max_count,omitempty" xml:"max_count"`

	// diskConfig的方式，取值为AUTO、MANUAL。  - MANUAL，镜像空间不会扩展。 - AUTO，系统盘镜像空间会自动扩展为与flavor大小一致。  当前不支持该功能。
	OSDCFdiskConfig *NovaCreateServersOptionOSDCFdiskConfig `json:"OS-DCF:diskConfig,omitempty" xml:"OS-DCF:diskConfig"`
