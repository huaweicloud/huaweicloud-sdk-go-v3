...
type CreatePrePaidPublicipRequestBody struct {
	Publicip *CreatePrePaidPublicipOption `json:"publicip" xml:"publicip"`

	Bandwidth *CreatePublicipBandwidthOption `json:"bandwidth" xml:"bandwidth"`

	ExtendParam *CreatePrePaidPublicipExtendParamOption `json:"extendParam,omitempty" xml:"extendParam"`
