...
type ListPublicipsByTagsRequestBody struct {
	...
	Tags *[]TagReq `json:"tags,omitempty" xml:"tags"`
	...
	Action ListPublicipsByTagsRequestBodyAction `json:"action" xml:"action"`

	// 搜索字段，key为要匹配的字段，当前仅支持resource_name。value为匹配的值。此字段为固定字典值。
	Matches *[]MatchReq `json:"matches,omitempty" xml:"matches"`
}
