...
type RemoveFromSharedBandwidthOption struct {
	...
	ChargeMode RemoveFromSharedBandwidthOptionChargeMode `json:"charge_mode" xml:"charge_mode"`

	// 功能说明：要从共享带宽中移除的弹性公网IP或者IPv6端口信息  约束：WHOLE类型的带宽支持多个弹性公网IP或者IPv6端口，跟租户的配额相关，默认一个共享带宽的配额为20
	PublicipInfo []RemovePublicipInfo `json:"publicip_info" xml:"publicip_info"`
