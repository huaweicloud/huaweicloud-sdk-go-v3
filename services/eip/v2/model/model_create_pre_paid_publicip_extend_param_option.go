...
type CreatePrePaidPublicipExtendParamOption struct {
	...
	ChargeMode *CreatePrePaidPublicipExtendParamOptionChargeMode `json:"charge_mode,omitempty" xml:"charge_mode"`
	...
	PeriodType *CreatePrePaidPublicipExtendParamOptionPeriodType `json:"period_type,omitempty" xml:"period_type"`
