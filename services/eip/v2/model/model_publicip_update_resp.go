...
type PublicipUpdateResp struct {
	...
	BandwidthShareType *PublicipUpdateRespBandwidthShareType `json:"bandwidth_share_type,omitempty" xml:"bandwidth_share_type"`
	...
	Status *PublicipUpdateRespStatus `json:"status,omitempty" xml:"status"`
	...
	IpVersion *PublicipUpdateRespIpVersion `json:"ip_version,omitempty" xml:"ip_version"`
