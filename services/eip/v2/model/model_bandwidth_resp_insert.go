...
type BandwidthRespInsert struct {
	...
	ChargeMode *BandwidthRespInsertChargeMode `json:"charge_mode,omitempty" xml:"charge_mode"`
	...
	ShareType *BandwidthRespInsertShareType `json:"share_type,omitempty" xml:"share_type"`
	...
	Status *BandwidthRespInsertStatus `json:"status,omitempty" xml:"status"`
}
