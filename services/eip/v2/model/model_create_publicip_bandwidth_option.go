...
type CreatePublicipBandwidthOption struct {
	...
	ChargeMode *CreatePublicipBandwidthOptionChargeMode `json:"charge_mode,omitempty" xml:"charge_mode"`
	...
	ShareType CreatePublicipBandwidthOptionShareType `json:"share_type" xml:"share_type"`
