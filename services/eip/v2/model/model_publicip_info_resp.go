...
type PublicipInfoResp struct {
	...
	Publicipv6Address *string `json:"publicipv6_address,omitempty" xml:"publicipv6_address"`

	// IP版本信息  取值范围：  4：IPv4  6：IPv6
	IpVersion *PublicipInfoRespIpVersion `json:"ip_version,omitempty" xml:"ip_version"`
}
