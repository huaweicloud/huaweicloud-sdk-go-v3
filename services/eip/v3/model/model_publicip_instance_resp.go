...
type PublicipInstanceResp struct {
	...
	IpVersion *PublicipInstanceRespIpVersion `json:"ip_version,omitempty" xml:"ip_version"`
	...
	Status *PublicipInstanceRespStatus `json:"status,omitempty" xml:"status"`
	...
	// 功能说明：弹性公网IP类型
	Type *PublicipInstanceRespType `json:"type,omitempty" xml:"type"`
	...
	AssociateInstanceType *PublicipInstanceRespAssociateInstanceType `json:"associate_instance_type,omitempty" xml:"associate_instance_type"`
