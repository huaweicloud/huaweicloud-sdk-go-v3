...
// CreateAlertPolicyResponse Response Object
...
func (o CreateAlertPolicyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateAlertPolicyResponse struct{}"
	}

	return strings.Join([]string{"CreateAlertPolicyResponse", string(data)}, " ")
}
