...
// ShowAlertPolicyResponse Response Object
type ShowAlertPolicyResponse struct {
...
func (o ShowAlertPolicyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowAlertPolicyResponse struct{}"
	}

	return strings.Join([]string{"ShowAlertPolicyResponse", string(data)}, " ")
}
