...
func (o UploadBasicPluginRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UploadBasicPluginRequestBody struct{}"
	}

	return strings.Join([]string{"UploadBasicPluginRequestBody", string(data)}, " ")
}
