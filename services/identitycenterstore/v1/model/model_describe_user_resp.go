...
// DescribeUserResp the response body of DescribeUser
...
func (o DescribeUserResp) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DescribeUserResp struct{}"
	}

	return strings.Join([]string{"DescribeUserResp", string(data)}, " ")
}
