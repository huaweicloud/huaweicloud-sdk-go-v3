...
// ShowAutopilotChartResponse Response Object
type ShowAutopilotChartResponse struct {
...
func (o ShowAutopilotChartResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowAutopilotChartResponse struct{}"
	}

	return strings.Join([]string{"ShowAutopilotChartResponse", string(data)}, " ")
}
