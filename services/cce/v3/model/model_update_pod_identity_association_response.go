...
// UpdatePodIdentityAssociationResponse Response Object
...
func (o UpdatePodIdentityAssociationResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdatePodIdentityAssociationResponse struct{}"
	}

	return strings.Join([]string{"UpdatePodIdentityAssociationResponse", string(data)}, " ")
}
