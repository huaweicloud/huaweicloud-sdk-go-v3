...
// CreatePodIdentityAssociationResponse Response Object
...
func (o CreatePodIdentityAssociationResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreatePodIdentityAssociationResponse struct{}"
	}

	return strings.Join([]string{"CreatePodIdentityAssociationResponse", string(data)}, " ")
}
