...
type PartitionReqBodySpecContainerNetwork struct {
...
func (o PartitionReqBodySpecContainerNetwork) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PartitionReqBodySpecContainerNetwork struct{}"
	}

	return strings.Join([]string{"PartitionReqBodySpecContainerNetwork", string(data)}, " ")
}
