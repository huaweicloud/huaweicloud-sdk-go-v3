...
type NodeExtendParam struct {
	...
	ProductID *string `json:"productID,omitempty" xml:"productID"`
	...
	DockerLVMConfigOverride *string `json:"DockerLVMConfigOverride,omitempty" xml:"DockerLVMConfigOverride"`
	...
	DockerBaseSize *int32 `json:"dockerBaseSize,omitempty" xml:"dockerBaseSize"`

	// 是否为CCE Turbo集群节点。
	OffloadNode *string `json:"offloadNode,omitempty" xml:"offloadNode"`

	// 节点的公钥。
	PublicKey *string `json:"publicKey,omitempty" xml:"publicKey"`

	// 安装前执行脚本 > 输入的值需要经过Base64编码，方法为echo -n \"待编码内容\" | base64
	AlphaCcePreInstall *string `json:"alpha.cce/preInstall,omitempty" xml:"alpha.cce/preInstall"`

	// 安装后执行脚本 > 输入的值需要经过Base64编码，方法为echo -n \"待编码内容\" | base64。
	AlphaCcePostInstall *string `json:"alpha.cce/postInstall,omitempty" xml:"alpha.cce/postInstall"`

	// 如果创建裸金属节点，需要使用自定义镜像时用此参数。
	AlphaCceNodeImageID *string `json:"alpha.cce/NodeImageID,omitempty" xml:"alpha.cce/NodeImageID"`
	...
	NicMultiqueue *string `json:"nicMultiqueue,omitempty" xml:"nicMultiqueue"`
	...
	NicThreshold *string `json:"nicThreshold,omitempty" xml:"nicThreshold"`

	// 节点所属的企业项目id。
	EnterpriseProjectId *string `json:"enterprise_project_id,omitempty" xml:"enterprise_project_id"`

	// 节点的计费模式。已废弃，请使用NodeSpec中的billingMode字段。
	ChargingMode *int32 `json:"chargingMode,omitempty" xml:"chargingMode"`
}
