...
type SecretConfigUpdate struct {
	...
	DisableDefaultAddonCredSecret *bool `json:"disableDefaultAddonCredSecret,omitempty"`
	...
	DisableNodeAgencyCredSecret *bool `json:"disableNodeAgencyCredSecret,omitempty"`
	...
	DisableDefaultImagePullSecret *bool `json:"disableDefaultImagePullSecret,omitempty"`
}

func (o SecretConfigUpdate) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SecretConfigUpdate struct{}"
	}

	return strings.Join([]string{"SecretConfigUpdate", string(data)}, " ")
}
