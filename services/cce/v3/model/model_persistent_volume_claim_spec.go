...
type PersistentVolumeClaimSpec struct {
	...
	AccessModes []PersistentVolumeClaimSpecAccessModes `json:"accessModes" xml:"accessModes"`

	// PVC的StorageClass名称
	StorageClassName *string `json:"storageClassName,omitempty" xml:"storageClassName"`

	// PVC绑定的PV名称
	VolumeName *string `json:"volumeName,omitempty" xml:"volumeName"`

	Resources *ResourceRequirements `json:"resources,omitempty" xml:"resources"`

	// PVC指定的PV类型
	VolumeMode *string `json:"volumeMode,omitempty" xml:"volumeMode"`
}
