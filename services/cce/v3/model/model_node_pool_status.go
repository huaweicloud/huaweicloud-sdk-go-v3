...
type NodePoolStatus struct {
	...
	CurrentNode *int32 `json:"currentNode,omitempty" xml:"currentNode"`

	// 当前节点池中处于创建流程中的节点数量。
	CreatingNode *int32 `json:"creatingNode,omitempty" xml:"creatingNode"`

	// 当前节点池中删除中的节点数量。
	DeletingNode *int32 `json:"deletingNode,omitempty" xml:"deletingNode"`
	...
	Phase *NodePoolStatusPhase `json:"phase,omitempty" xml:"phase"`

	// 对节点池执行操作时的 JobID。
	JobId *string `json:"jobId,omitempty" xml:"jobId"`

	// 节点池当前详细状态列表，详情参见Condition类型定义。
	Conditions *[]NodePoolCondition `json:"conditions,omitempty" xml:"conditions"`
}
