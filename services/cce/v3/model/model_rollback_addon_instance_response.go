...
func (o RollbackAddonInstanceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RollbackAddonInstanceResponse struct{}"
	}

	return strings.Join([]string{"RollbackAddonInstanceResponse", string(data)}, " ")
}
