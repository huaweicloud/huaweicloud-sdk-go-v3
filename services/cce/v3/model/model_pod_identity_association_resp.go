...
// PodIdentityAssociationResp pod-identity关联详情
type PodIdentityAssociationResp struct {
...
func (o PodIdentityAssociationResp) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PodIdentityAssociationResp struct{}"
	}

	return strings.Join([]string{"PodIdentityAssociationResp", string(data)}, " ")
}
