...
type ClusterExtendParam struct {
	...
	ClusterAZ *string `json:"clusterAZ,omitempty" xml:"clusterAZ"`
	...
	DssMasterVolumes *string `json:"dssMasterVolumes,omitempty" xml:"dssMasterVolumes"`
	...
	KubeProxyMode *string `json:"kubeProxyMode,omitempty" xml:"kubeProxyMode"`

	// master 弹性公网IP
	ClusterExternalIP *string `json:"clusterExternalIP,omitempty" xml:"clusterExternalIP"`
	...
	AlphaCceFixPoolMask *string `json:"alpha.cce/fixPoolMask,omitempty" xml:"alpha.cce/fixPoolMask"`

	// 专属CCE集群指定可控制节点的规格。
	DecMasterFlavor *string `json:"decMasterFlavor,omitempty" xml:"decMasterFlavor"`

	// 集群默认Docker的UmaskMode配置，可取值为secure或normal，不指定时默认为normal。
	DockerUmaskMode *string `json:"dockerUmaskMode,omitempty" xml:"dockerUmaskMode"`
	...
	KubernetesIoCpuManagerPolicy *string `json:"kubernetes.io/cpuManagerPolicy,omitempty" xml:"kubernetes.io/cpuManagerPolicy"`
	...
	// 记录集群通过何种升级方式升级到当前版本。
	Upgradefrom *string `json:"upgradefrom,omitempty" xml:"upgradefrom"`
}
