...
type DeleteCloudPersistentVolumeClaimsRequest struct {
	...
	DeleteVolume *string `json:"deleteVolume,omitempty" xml:"deleteVolume"`
	...
	StorageType *string `json:"storageType,omitempty" xml:"storageType"`

	// 集群ID，使用**https://Endpoint/uri**这种URL格式时必须指定此参数。获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。
	XClusterID *string `json:"X-Cluster-ID,omitempty" xml:"X-Cluster-ID"`
}
