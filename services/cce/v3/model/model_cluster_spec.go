...
type ClusterSpec struct {
	...
	Category *ClusterSpecCategory `json:"category,omitempty" xml:"category"`

	// 集群Master节点架构：  - VirtualMachine：Master节点为x86架构服务器 [- ARM64: Master节点为鲲鹏（ARM架构）服务器](tag:hws,hws_hk)
	Type *ClusterSpecType `json:"type,omitempty" xml:"type"`
	...
	PlatformVersion *string `json:"platformVersion,omitempty" xml:"platformVersion"`
	...
	CustomSan *[]string `json:"customSan,omitempty" xml:"customSan"`

	// 集群是否使用IPv6模式，1.15版本及以上支持。
	Ipv6enable *bool `json:"ipv6enable,omitempty" xml:"ipv6enable"`

	// CCE Turbo集群
	OffloadCluster *bool `json:"offloadCluster,omitempty" xml:"offloadCluster"`

	HostNetwork *HostNetwork `json:"hostNetwork" xml:"hostNetwork"`

	ContainerNetwork *ContainerNetwork `json:"containerNetwork" xml:"containerNetwork"`

	EniNetwork *EniNetwork `json:"eniNetwork,omitempty" xml:"eniNetwork"`
	...
	// 控制节点的高级配置
	Masters *[]MasterSpec `json:"masters,omitempty" xml:"masters"`

	// 服务网段参数，kubernetes clusterIp取值范围，1.11.7版本及以上支持。
	KubernetesSvcIpRange *string `json:"kubernetesSvcIpRange,omitempty" xml:"kubernetesSvcIpRange"`

	// 集群资源标签
	ClusterTags *[]ResourceTag `json:"clusterTags,omitempty" xml:"clusterTags"`
	...
	KubeProxyMode *ClusterSpecKubeProxyMode `json:"kubeProxyMode,omitempty" xml:"kubeProxyMode"`
	...
	ExtendParam *ClusterExtendParam `json:"extendParam,omitempty" xml:"extendParam"`

	// 支持Istio
	SupportIstio *bool `json:"supportIstio,omitempty" xml:"supportIstio"`
}
