...
// ListInstanceFlavorsRequest Request Object
type ListInstanceFlavorsRequest struct {
...
func (o ListInstanceFlavorsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListInstanceFlavorsRequest struct{}"
	}

	return strings.Join([]string{"ListInstanceFlavorsRequest", string(data)}, " ")
}
