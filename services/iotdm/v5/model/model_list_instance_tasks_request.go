...
// ListInstanceTasksRequest Request Object
...
func (o ListInstanceTasksRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListInstanceTasksRequest struct{}"
	}

	return strings.Join([]string{"ListInstanceTasksRequest", string(data)}, " ")
}
