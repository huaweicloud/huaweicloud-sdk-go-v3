...
var provider = region.DefaultProviderChain("IOTDM")
...
func ValueOf(regionId string) *region.Region {
	...
	panic(fmt.Sprintf("region id '%s' is not in the following supported regions of service 'IoTDM': [%s]", regionId, strings.Join(getRegionIds(), ", ")))
}
