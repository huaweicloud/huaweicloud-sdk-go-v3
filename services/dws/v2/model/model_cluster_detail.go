...
type ClusterDetail struct {
	...
	ParameterGroup *ParameterGroup `json:"parameter_group,omitempty" xml:"parameter_group"`

	// 节点类型ID
	NodeTypeId string `json:"node_type_id" xml:"node_type_id"`
	...
	MaintainWindow *MaintainWindow `json:"maintain_window" xml:"maintain_window"`

	ResizeInfo *ResizeInfo `json:"resize_info,omitempty" xml:"resize_info"`
