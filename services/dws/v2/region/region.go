...
var (
	...
	AP_SOUTHEAST_5 = region.NewRegion("ap-southeast-5",
		"https://dws.ap-southeast-5.myhuaweicloud.com")
	ME_EAST_1 = region.NewRegion("me-east-1",
		"https://dws.me-east-1.myhuaweicloud.com")
)
...
func ValueOf(regionId string) *region.Region {
	...
	panic(fmt.Sprintf("region id '%s' is not in the following supported regions of service 'DWS': [%s]", regionId, strings.Join(getRegionIds(), ", ")))
}
