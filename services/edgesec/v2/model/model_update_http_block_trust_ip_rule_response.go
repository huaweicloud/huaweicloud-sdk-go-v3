...
func (o UpdateHttpBlockTrustIpRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateHttpBlockTrustIpRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateHttpBlockTrustIpRuleResponse", string(data)}, " ")
}
