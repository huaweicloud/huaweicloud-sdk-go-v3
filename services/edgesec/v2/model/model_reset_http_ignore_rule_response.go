...
func (o ResetHttpIgnoreRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ResetHttpIgnoreRuleResponse struct{}"
	}

	return strings.Join([]string{"ResetHttpIgnoreRuleResponse", string(data)}, " ")
}
