...
func (o UpdateHttpGeoIpRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateHttpGeoIpRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateHttpGeoIpRuleResponse", string(data)}, " ")
}
