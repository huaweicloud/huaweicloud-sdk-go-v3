...
func (o CreateHttpBlockTrustIpRuleRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateHttpBlockTrustIpRuleRequestBody struct{}"
	}

	return strings.Join([]string{"CreateHttpBlockTrustIpRuleRequestBody", string(data)}, " ")
}
