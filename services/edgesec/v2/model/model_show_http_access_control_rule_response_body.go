...
func (o ShowHttpAccessControlRuleResponseBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowHttpAccessControlRuleResponseBody struct{}"
	}

	return strings.Join([]string{"ShowHttpAccessControlRuleResponseBody", string(data)}, " ")
}
