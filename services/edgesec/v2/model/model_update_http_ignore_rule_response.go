...
func (o UpdateHttpIgnoreRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateHttpIgnoreRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateHttpIgnoreRuleResponse", string(data)}, " ")
}
