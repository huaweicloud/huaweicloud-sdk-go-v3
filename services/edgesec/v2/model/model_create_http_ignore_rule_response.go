...
func (o CreateHttpIgnoreRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateHttpIgnoreRuleResponse struct{}"
	}

	return strings.Join([]string{"CreateHttpIgnoreRuleResponse", string(data)}, " ")
}
