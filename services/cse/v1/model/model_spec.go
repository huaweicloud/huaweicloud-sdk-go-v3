...
type Spec struct {
	...
	// 微服务引擎专享版CCE集群部署类型
	SpecType *SpecSpecType `json:"spec_type,omitempty" xml:"spec_type"`
	...
	ClusterNodes *SpecClusterNode `json:"cluster_nodes,omitempty" xml:"cluster_nodes"`
	...
	// 微服务引擎专享版CCE集群附加参数
	ExtendParam *string `json:"extend_param,omitempty" xml:"extend_param"`
}
