...
type CancelTasksResponse struct {
	...
	InfoCode *CancelTasksResponseInfoCode `json:"info_code,omitempty" xml:"info_code"`
	...
	TaskStatus     *CancelTasksResponseTaskStatus `json:"task_status,omitempty" xml:"task_status"`
