...
type ShowTasksResponse struct {
	...
	TaskType *ShowTasksResponseTaskType `json:"task_type,omitempty" xml:"task_type"`
	...
	TaskStatus *ShowTasksResponseTaskStatus `json:"task_status,omitempty" xml:"task_status"`

	// 监测任务状态:   * running - 正在运行   * waiting - 正在等待   * finished - 已完成
	ScheduleStatus *ShowTasksResponseScheduleStatus `json:"schedule_status,omitempty" xml:"schedule_status"`
	...
	SafeLevel *ShowTasksResponseSafeLevel `json:"safe_level,omitempty" xml:"safe_level"`
