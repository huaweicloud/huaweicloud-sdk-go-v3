...
type UpdateAutoRecordRequest struct {
	...
	Body *AutoRecordModeReq `json:"body,omitempty" xml:"body"`
}

func (o UpdateAutoRecordRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateAutoRecordRequest struct{}"
	}

	return strings.Join([]string{"UpdateAutoRecordRequest", string(data)}, " ")
}
