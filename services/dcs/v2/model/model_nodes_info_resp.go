...
type NodesInfoResp struct {
	...
	// 逻辑节点ID
	LogicalNodeId *string `json:"logical_node_id,omitempty" xml:"logical_node_id"`

	// 节点名称
	Name *string `json:"name,omitempty" xml:"name"`

	// 节点状态，所有值如下: - Creating：创建中。 - Active：运行中。 - Inactive：故障。 - Deleting：删除中。 - AddSharding：添加分片中。
	Status *NodesInfoRespStatus `json:"status,omitempty" xml:"status"`

	// 可用区code
	AzCode *string `json:"az_code,omitempty" xml:"az_code"`

	// 节点角色，所有值如下: - redis-server：Redis server节点。 - redis-proxy：proxy节点。
	NodeRole *NodesInfoRespNodeRole `json:"node_role,omitempty" xml:"node_role"`

	// 节点主从角色: - master：主 - slave：从 - proxy: proxy实例节点角色为\"proxy\"
	NodeType *NodesInfoRespNodeType `json:"node_type,omitempty" xml:"node_type"`

	// 节点的IP
	NodeIp *string `json:"node_ip,omitempty" xml:"node_ip"`

	// 节点的port
	NodePort *string `json:"node_port,omitempty" xml:"node_port"`

	// 节点ID
	NodeId *string `json:"node_id,omitempty" xml:"node_id"`

	// 节点权重
	PriorityWeight *int32 `json:"priority_weight,omitempty" xml:"priority_weight"`

	// 节点的IP是否可直接访问
	IsAccess *bool `json:"is_access,omitempty" xml:"is_access"`
	...
	// 是否从只读域名中摘除IP
	IsRemoveIp *bool `json:"is_remove_ip,omitempty" xml:"is_remove_ip"`

	// 副本id
	ReplicationId *string `json:"replication_id,omitempty" xml:"replication_id"`
	...
	Dimensions *[]InstanceReplicationDimensionsInfo `json:"dimensions,omitempty" xml:"dimensions"`
}
