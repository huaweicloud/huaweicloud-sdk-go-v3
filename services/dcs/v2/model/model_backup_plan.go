...
type BackupPlan struct {
	...
	TimezoneOffset *string `json:"timezone_offset,omitempty" xml:"timezone_offset"`

	// 每周的周几开始备份，取值1-7，1代表周一，7代表周日。
	BackupAt []int32 `json:"backup_at" xml:"backup_at"`

	// 备份周期类型，目前支持“weekly”。
	PeriodType string `json:"period_type" xml:"period_type"`

	// 备份执行时间，“00:00-01:00”代表0点开始执行备份。
	BeginAt string `json:"begin_at" xml:"begin_at"`
}
