...
type StopMigrationTaskResponse struct {
	...
	Status *StopMigrationTaskResponseStatus `json:"status,omitempty" xml:"status"`
	...
	MigrationMethod *StopMigrationTaskResponseMigrationMethod `json:"migration_method,omitempty" xml:"migration_method"`
	...
	// 网络类型，包括vpc和vpn两种类型。
	NetworkType *StopMigrationTaskResponseNetworkType `json:"network_type,omitempty" xml:"network_type"`
