...
type InstanceReplicationListInfo struct {
	...
	ReplicationRole *string `json:"replication_role,omitempty" xml:"replication_role"`

	// 副本IP。
	ReplicationIp *string `json:"replication_ip,omitempty" xml:"replication_ip"`

	// 是否是新加副本。
	IsReplication *bool `json:"is_replication,omitempty" xml:"is_replication"`
	...
	// 副本状态。
	Status *InstanceReplicationListInfoStatus `json:"status,omitempty" xml:"status"`
