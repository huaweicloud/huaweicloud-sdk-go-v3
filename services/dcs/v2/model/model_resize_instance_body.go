...
type ResizeInstanceBody struct {
	...
	NewCapacity int32 `json:"new_capacity" xml:"new_capacity"`

	BssParam *BssParamEntity `json:"bss_param,omitempty" xml:"bss_param"`

	// 需要保留的节点ip。cluster集群缩容时需要填写，不填写时系统将随机删除多余的分片
	ReservedIp *[]string `json:"reserved_ip,omitempty" xml:"reserved_ip"`

	// 变更类型，Redis 4.0或者5.0主备实例进行副本数变更时必选。 - createReplication: 添加副本 - deleteReplication: 删除副本
	ChangeType *ResizeInstanceBodyChangeType `json:"change_type,omitempty" xml:"change_type"`
	...
	NodeList *[]string `json:"node_list,omitempty" xml:"node_list"`

	// 是否立即变更。默认值为true。 - true: 立即变更 - false: 可维护时间窗内进行变更
	ExecuteImmediately *bool `json:"execute_immediately,omitempty" xml:"execute_immediately"`
}
