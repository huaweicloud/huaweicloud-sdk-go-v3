...
type ListInstancesRequest struct {
	...
	IncludeFailure *string `json:"include_failure,omitempty" xml:"include_failure"`

	// 是否返回已删除的实例数。 当参数值为“true”时，返回已删除的实例数。参数值为“false”或者其他值，不返回已删除的实例数。
	IncludeDelete *string `json:"include_delete,omitempty" xml:"include_delete"`
	...
	NameEqual *string `json:"name_equal,omitempty" xml:"name_equal"`
