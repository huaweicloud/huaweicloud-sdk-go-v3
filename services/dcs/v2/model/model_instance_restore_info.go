...
type InstanceRestoreInfo struct {
	...
	// 恢复备注信息。
	RestoreRemark *string `json:"restore_remark,omitempty" xml:"restore_remark"`
	...
	// 恢复记录名称。
	RestoreName *string `json:"restore_name,omitempty" xml:"restore_name"`

	// 备份备注信息。
	BackupRemark *string `json:"backup_remark,omitempty" xml:"backup_remark"`

	// 恢复状态。 - waiting：等待中 - restoring：恢复中 - succeed：恢复成功 - failed：恢复失败
	Status *InstanceRestoreInfoStatus `json:"status,omitempty" xml:"status"`
}
