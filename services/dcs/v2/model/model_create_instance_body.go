...
type CreateInstanceBody struct {
	...
	Capacity float32 `json:"capacity" xml:"capacity"`
	...
	AzCodes []string `json:"az_codes" xml:"az_codes"`
	...
	NoPasswordAccess *bool `json:"no_password_access,omitempty" xml:"no_password_access"`

	BssParam *BssParam `json:"bss_param,omitempty" xml:"bss_param"`

	InstanceBackupPolicy *BackupPolicy `json:"instance_backup_policy,omitempty" xml:"instance_backup_policy"`
	...
	RenameCommands *interface{} `json:"rename_commands,omitempty" xml:"rename_commands"`
}
