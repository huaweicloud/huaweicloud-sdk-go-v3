...
type CreateBigkeyScanTaskResponse struct {
	...
	// 分析任务状态
	Status *CreateBigkeyScanTaskResponseStatus `json:"status,omitempty" xml:"status"`

	// 分析方式
	ScanType *CreateBigkeyScanTaskResponseScanType `json:"scan_type,omitempty" xml:"scan_type"`
