...
func (o SupplementDataInfoSupplementDataRunTime) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SupplementDataInfoSupplementDataRunTime struct{}"
	}

	return strings.Join([]string{"SupplementDataInfoSupplementDataRunTime", string(data)}, " ")
}
