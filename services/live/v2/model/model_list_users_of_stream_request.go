...
type ListUsersOfStreamRequest struct {
	...
	// 播放域名。
	PlayDomain string `json:"play_domain" xml:"play_domain"`
	...
	// 请求协议
	Protocol *ListUsersOfStreamRequestProtocol `json:"protocol,omitempty" xml:"protocol"`

	// 查询数据的时间粒度，支持60（默认值）, 300秒。不传值时，使用默认值60秒。
	Interval *ListUsersOfStreamRequestInterval `json:"interval,omitempty" xml:"interval"`
