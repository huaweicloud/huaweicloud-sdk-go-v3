...
type ListBandwidthDetailRequest struct {
	...
	PlayDomains []string `json:"play_domains" xml:"play_domains"`
	...
	// 请求协议
	Protocol *ListBandwidthDetailRequestProtocol `json:"protocol,omitempty" xml:"protocol"`

	// 查询数据的时间粒度。支持300（默认值）, 3600和86400秒。不传值时，使用默认值300秒。
	Interval *ListBandwidthDetailRequestInterval `json:"interval,omitempty" xml:"interval"`
