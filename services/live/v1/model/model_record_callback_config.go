...
type RecordCallbackConfig struct {
	...
	NotifyEventSubscription *[]RecordCallbackConfigNotifyEventSubscription `json:"notify_event_subscription,omitempty" xml:"notify_event_subscription"`

	// 加密类型
	SignType *RecordCallbackConfigSignType `json:"sign_type,omitempty" xml:"sign_type"`
