...
type CreateRecordRuleResponse struct {
	...
	RecordType *CreateRecordRuleResponseRecordType `json:"record_type,omitempty" xml:"record_type"`

	DefaultRecordConfig *DefaultRecordConfig `json:"default_record_config,omitempty" xml:"default_record_config"`
