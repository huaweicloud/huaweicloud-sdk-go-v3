...
type RecordRuleRequest struct {
	...
	RecordType *RecordRuleRequestRecordType `json:"record_type,omitempty" xml:"record_type"`

	DefaultRecordConfig *DefaultRecordConfig `json:"default_record_config" xml:"default_record_config"`
}
