...
// UpdateWatermarkRuleResponse Response Object
type UpdateWatermarkRuleResponse struct {
...
func (o UpdateWatermarkRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateWatermarkRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateWatermarkRuleResponse", string(data)}, " ")
}
