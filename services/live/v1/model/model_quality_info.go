...
type QualityInfo struct {
	...
	Pvc *QualityInfoPvc `json:"PVC,omitempty" xml:"PVC"`

	// 是否启用高清低码，较PVC相比画质增强。 - on：启用。 - off：不启用。 默认为off。
	Hdlb *QualityInfoHdlb `json:"hdlb,omitempty" xml:"hdlb"`

	// 视频编码格式，模板组里不同模板的编码格式必须相同。 - H264：使用H.264。 - H265：使用H.265。 默认为H264。
	Codec *QualityInfoCodec `json:"codec,omitempty" xml:"codec"`
	...
	VideoFrameRate *int32 `json:"video_frame_rate,omitempty" xml:"video_frame_rate"`

	// 转码输出支持的协议类型。当前只支持RTMP和HLS，且模板组里不同模板的输出协议类型必须相同。 - RTMP - HLS - DASH  默认为RTMP。
	Protocol *QualityInfoProtocol `json:"protocol,omitempty" xml:"protocol"`

	// I帧间隔（单位：帧）。  取值范围：0-500。  默认为25。
	IFrameInterval *int32 `json:"iFrameInterval,omitempty" xml:"iFrameInterval"`

	// 按时间设置I帧间隔，与“iFrameInterval”选择一个设置即可。  取值范围：[0,10]  默认值：4
	Gop *int32 `json:"gop,omitempty" xml:"gop"`
}
