...
type UpdateWatermarkTemplateResponse struct {
	...
	Scene *UpdateWatermarkTemplateResponseScene `json:"scene,omitempty"`
...
type UpdateWatermarkTemplateResponseScene struct {
	value string
}

type UpdateWatermarkTemplateResponseSceneEnum struct {
	CLOUD_LIVE UpdateWatermarkTemplateResponseScene
	MEDIA_LIVE UpdateWatermarkTemplateResponseScene
}

func GetUpdateWatermarkTemplateResponseSceneEnum() UpdateWatermarkTemplateResponseSceneEnum {
	return UpdateWatermarkTemplateResponseSceneEnum{
		CLOUD_LIVE: UpdateWatermarkTemplateResponseScene{
			value: "cloud_live",
		},
		MEDIA_LIVE: UpdateWatermarkTemplateResponseScene{
...
func (c UpdateWatermarkTemplateResponseScene) Value() string {
	return c.value
}

func (c UpdateWatermarkTemplateResponseScene) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *UpdateWatermarkTemplateResponseScene) UnmarshalJSON(b []byte) error {
