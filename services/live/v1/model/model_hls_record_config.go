...
type HlsRecordConfig struct {
	...
	RecordCycle int32 `json:"record_cycle" xml:"record_cycle"`
	...
	RecordPrefix *string `json:"record_prefix,omitempty" xml:"record_prefix"`

	// 录制ts文件名的前缀， 默认{file_start_time_unix}_{file_end_time_unix}_{ts_sequence_number}
	RecordTsPrefix *string `json:"record_ts_prefix,omitempty" xml:"record_ts_prefix"`

	// 录制HLS时ts的切片时长，非必须，缺省为10，单位秒，最小2，最大60
	RecordSliceDuration *int32 `json:"record_slice_duration,omitempty" xml:"record_slice_duration"`

	// 录制HLS文件拼接时长，如果流中断超过该时间，则生成新文件。单位秒。如果为0表示流中断就生成新文件，如果为-1则表示相同的流中断恢复后继续在30天内的前一个文件保存。默认为0。
	RecordMaxDurationToMergeFile *int32 `json:"record_max_duration_to_merge_file,omitempty" xml:"record_max_duration_to_merge_file"`
}
