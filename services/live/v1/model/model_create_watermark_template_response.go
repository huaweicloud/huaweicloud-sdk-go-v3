...
type CreateWatermarkTemplateResponse struct {
	...
	Scene *CreateWatermarkTemplateResponseScene `json:"scene,omitempty"`
...
type CreateWatermarkTemplateResponseScene struct {
	value string
}

type CreateWatermarkTemplateResponseSceneEnum struct {
	CLOUD_LIVE CreateWatermarkTemplateResponseScene
	MEDIA_LIVE CreateWatermarkTemplateResponseScene
}

func GetCreateWatermarkTemplateResponseSceneEnum() CreateWatermarkTemplateResponseSceneEnum {
	return CreateWatermarkTemplateResponseSceneEnum{
		CLOUD_LIVE: CreateWatermarkTemplateResponseScene{
			value: "cloud_live",
		},
		MEDIA_LIVE: CreateWatermarkTemplateResponseScene{
...
func (c CreateWatermarkTemplateResponseScene) Value() string {
	return c.value
}

func (c CreateWatermarkTemplateResponseScene) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *CreateWatermarkTemplateResponseScene) UnmarshalJSON(b []byte) error {
