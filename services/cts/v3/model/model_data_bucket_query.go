...
type DataBucketQuery struct {
	...
	DataBucketName *string `json:"data_bucket_name,omitempty" xml:"data_bucket_name"`

	// 追踪桶日志是否支持搜索。
	SearchEnabled *bool `json:"search_enabled,omitempty" xml:"search_enabled"`

	// 数据类追踪器追踪对象的桶名。 - 当启用或者停用数据类追踪器时，该参数为必选。 - 管理类追踪器无此参数。 - 追踪器一旦创建追踪桶无法修改。
	DataEvent *[]DataBucketQueryDataEvent `json:"data_event,omitempty" xml:"data_event"`
}
