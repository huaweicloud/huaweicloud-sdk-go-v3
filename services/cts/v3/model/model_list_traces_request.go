...
type ListTracesRequest struct {
	...
	TraceType ListTracesRequestTraceType `json:"trace_type" xml:"trace_type"`
	...
	TraceRating *ListTracesRequestTraceRating `json:"trace_rating,omitempty" xml:"trace_rating"`
}
