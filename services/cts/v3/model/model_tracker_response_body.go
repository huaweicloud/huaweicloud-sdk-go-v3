...
type TrackerResponseBody struct {
	...
	TrackerType *TrackerResponseBodyTrackerType `json:"tracker_type,omitempty" xml:"tracker_type"`
	...
	Status *TrackerResponseBodyStatus `json:"status,omitempty" xml:"status"`
