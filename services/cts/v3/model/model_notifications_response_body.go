...
type NotificationsResponseBody struct {
	...
	OperationType *NotificationsResponseBodyOperationType `json:"operation_type,omitempty" xml:"operation_type"`
	...
	Status *NotificationsResponseBodyStatus `json:"status,omitempty" xml:"status"`
	...
	NotificationType *NotificationsResponseBodyNotificationType `json:"notification_type,omitempty" xml:"notification_type"`
