...
type Statement struct {
	...
	Principal *string `json:"Principal,omitempty" xml:"Principal"`
	...
	NotPrincipal *string `json:"NotPrincipal,omitempty" xml:"NotPrincipal"`
	...
	NotAction *string `json:"NotAction,omitempty" xml:"NotAction"`
	...
	NotResource *string `json:"NotResource,omitempty" xml:"NotResource"`
}
