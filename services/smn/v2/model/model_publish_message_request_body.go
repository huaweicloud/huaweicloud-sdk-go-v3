...
type PublishMessageRequestBody struct {
	...
	MessageStructure *string `json:"message_structure,omitempty" xml:"message_structure"`
	...
	MessageTemplateName *string `json:"message_template_name,omitempty" xml:"message_template_name"`
	...
	TimeToLive *string `json:"time_to_live,omitempty" xml:"time_to_live"`
}
