...
type InstanceDetail struct {
	...
	QuotaAddress *string `json:"quota_address,omitempty"`

	// **参数解释**： 最大消息TPS。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
	MaxMsgProcessTps *int32 `json:"max_msg_process_tps,omitempty"`
	...
	EnableElasticTps *bool `json:"enable_elastic_tps,omitempty"`
}
