...
// ShowConsumerConnectionsForRocketMqResponse Response Object
type ShowConsumerConnectionsForRocketMqResponse struct {
...
func (o ShowConsumerConnectionsForRocketMqResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowConsumerConnectionsForRocketMqResponse struct{}"
	}

	return strings.Join([]string{"ShowConsumerConnectionsForRocketMqResponse", string(data)}, " ")
}
