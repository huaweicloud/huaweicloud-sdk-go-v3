...
// CreateAlertNoticeConfigResponse Response Object
type CreateAlertNoticeConfigResponse struct {
...
func (o CreateAlertNoticeConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateAlertNoticeConfigResponse struct{}"
	}

	return strings.Join([]string{"CreateAlertNoticeConfigResponse", string(data)}, " ")
}
