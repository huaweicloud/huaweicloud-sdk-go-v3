...
type UpdatePolicyProtectHostResponse struct {
	...
	FullDetection *bool `json:"full_detection,omitempty" xml:"full_detection"`

	RobotAction *Action `json:"robot_action,omitempty" xml:"robot_action"`

	Action *PolicyAction `json:"action,omitempty" xml:"action"`

	Options *PolicyOption `json:"options,omitempty" xml:"options"`

	// 智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性
	ModulexOptions map[string]interface{} `json:"modulex_options,omitempty" xml:"modulex_options"`
...
func (o UpdatePolicyProtectHostResponse) String() string {
	...
	if err != nil {
		return "UpdatePolicyProtectHostResponse struct{}"
	}

	return strings.Join([]string{"UpdatePolicyProtectHostResponse", string(data)}, " ")
}
