...
type ShowHostResponse struct {
	...
	Tls *ShowHostResponseTls `json:"tls,omitempty" xml:"tls"`
	...
	Cipher *ShowHostResponseCipher `json:"cipher,omitempty" xml:"cipher"`
	...
	LbAlgorithm *ShowHostResponseLbAlgorithm `json:"lb_algorithm,omitempty" xml:"lb_algorithm"`
