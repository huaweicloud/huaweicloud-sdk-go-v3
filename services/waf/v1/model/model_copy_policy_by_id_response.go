...
// CopyPolicyByIdResponse Response Object
type CopyPolicyByIdResponse struct {
...
func (o CopyPolicyByIdResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CopyPolicyByIdResponse struct{}"
	}

	return strings.Join([]string{"CopyPolicyByIdResponse", string(data)}, " ")
}
