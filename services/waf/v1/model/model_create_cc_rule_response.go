...
func (o CreateCcRuleResponse) String() string {
	...
	if err != nil {
		return "CreateCcRuleResponse struct{}"
	}

	return strings.Join([]string{"CreateCcRuleResponse", string(data)}, " ")
}
...
type CreateCcRuleResponseTagTypeEnum struct {
	IP     CreateCcRuleResponseTagType
	COOKIE CreateCcRuleResponseTagType
	HEADER CreateCcRuleResponseTagType
	OTHER  CreateCcRuleResponseTagType
	POLICY CreateCcRuleResponseTagType
	DOMAIN CreateCcRuleResponseTagType
	URL    CreateCcRuleResponseTagType
}

func GetCreateCcRuleResponseTagTypeEnum() CreateCcRuleResponseTagTypeEnum {
	return CreateCcRuleResponseTagTypeEnum{
		IP: CreateCcRuleResponseTagType{
			value: "ip",
		},
		COOKIE: CreateCcRuleResponseTagType{
...
func (c CreateCcRuleResponseTagType) Value() string {
	return c.value
}
