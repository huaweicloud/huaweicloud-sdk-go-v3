...
// BatchCreateCcRuleResponse Response Object
type BatchCreateCcRuleResponse struct {
	...
	TagType *BatchCreateCcRuleResponseTagType `json:"tag_type,omitempty"`
...
func (o BatchCreateCcRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchCreateCcRuleResponse struct{}"
	}

	return strings.Join([]string{"BatchCreateCcRuleResponse", string(data)}, " ")
}

type BatchCreateCcRuleResponseTagType struct {
	value string
}

type BatchCreateCcRuleResponseTagTypeEnum struct {
	IP     BatchCreateCcRuleResponseTagType
	COOKIE BatchCreateCcRuleResponseTagType
	HEADER BatchCreateCcRuleResponseTagType
	OTHER  BatchCreateCcRuleResponseTagType
	POLICY BatchCreateCcRuleResponseTagType
	DOMAIN BatchCreateCcRuleResponseTagType
	URL    BatchCreateCcRuleResponseTagType
}

func GetBatchCreateCcRuleResponseTagTypeEnum() BatchCreateCcRuleResponseTagTypeEnum {
	return BatchCreateCcRuleResponseTagTypeEnum{
		IP: BatchCreateCcRuleResponseTagType{
			value: "ip",
		},
		COOKIE: BatchCreateCcRuleResponseTagType{
...
func (c BatchCreateCcRuleResponseTagType) Value() string {
	return c.value
}

func (c BatchCreateCcRuleResponseTagType) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *BatchCreateCcRuleResponseTagType) UnmarshalJSON(b []byte) error {
