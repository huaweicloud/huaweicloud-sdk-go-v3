...
type BatchUpdateCustomRuleResponseBody struct {
...
func (o BatchUpdateCustomRuleResponseBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchUpdateCustomRuleResponseBody struct{}"
	}

	return strings.Join([]string{"BatchUpdateCustomRuleResponseBody", string(data)}, " ")
}
