...
type UpdatePremiumHostRequestBody struct {
	...
	Tls *UpdatePremiumHostRequestBodyTls `json:"tls,omitempty" xml:"tls"`
	...
	Cipher *UpdatePremiumHostRequestBodyCipher `json:"cipher,omitempty" xml:"cipher"`
	...
	PoolIds *[]string `json:"pool_ids,omitempty" xml:"pool_ids"`
