...
type PremiumWafServer struct {
	...
	// 客户端请求访问防护域名源站服务器的协议
	FrontProtocol PremiumWafServerFrontProtocol `json:"front_protocol" xml:"front_protocol"`

	// WAF转发客户端请求到防护域名源站服务器的协议
	BackProtocol PremiumWafServerBackProtocol `json:"back_protocol" xml:"back_protocol"`
	...
	// 源站地址为ipv4或ipv6
	Type PremiumWafServerType `json:"type" xml:"type"`
