...
// DeleteAlertNoticeConfigResponse Response Object
type DeleteAlertNoticeConfigResponse struct {
...
func (o DeleteAlertNoticeConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteAlertNoticeConfigResponse struct{}"
	}

	return strings.Join([]string{"DeleteAlertNoticeConfigResponse", string(data)}, " ")
}
