...
// DeleteSecurityReportSubscriptionResponse Response Object
type DeleteSecurityReportSubscriptionResponse struct {
...
func (o DeleteSecurityReportSubscriptionResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteSecurityReportSubscriptionResponse struct{}"
	}

	return strings.Join([]string{"DeleteSecurityReportSubscriptionResponse", string(data)}, " ")
}
