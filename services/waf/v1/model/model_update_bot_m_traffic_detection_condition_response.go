...
// UpdateBotMTrafficDetectionConditionResponse Response Object
type UpdateBotMTrafficDetectionConditionResponse struct {
...
func (o UpdateBotMTrafficDetectionConditionResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateBotMTrafficDetectionConditionResponse struct{}"
	}

	return strings.Join([]string{"UpdateBotMTrafficDetectionConditionResponse", string(data)}, " ")
}
