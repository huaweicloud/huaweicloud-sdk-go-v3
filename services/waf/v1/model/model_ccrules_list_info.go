...
func (o CcrulesListInfo) String() string {
	...
	if err != nil {
		return "CcrulesListInfo struct{}"
	}

	return strings.Join([]string{"CcrulesListInfo", string(data)}, " ")
}
...
type CcrulesListInfoTagTypeEnum struct {
	IP     CcrulesListInfoTagType
	COOKIE CcrulesListInfoTagType
	HEADER CcrulesListInfoTagType
	OTHER  CcrulesListInfoTagType
	POLICY CcrulesListInfoTagType
	DOMAIN CcrulesListInfoTagType
	URL    CcrulesListInfoTagType
}

func GetCcrulesListInfoTagTypeEnum() CcrulesListInfoTagTypeEnum {
	return CcrulesListInfoTagTypeEnum{
		IP: CcrulesListInfoTagType{
			value: "ip",
		},
		COOKIE: CcrulesListInfoTagType{
