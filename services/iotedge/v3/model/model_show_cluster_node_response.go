...
// ShowClusterNodeResponse Response Object
type ShowClusterNodeResponse struct {
...
func (o ShowClusterNodeResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowClusterNodeResponse struct{}"
	}

	return strings.Join([]string{"ShowClusterNodeResponse", string(data)}, " ")
}
