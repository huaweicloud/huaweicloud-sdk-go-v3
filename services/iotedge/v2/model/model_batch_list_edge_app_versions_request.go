...
type BatchListEdgeAppVersionsRequest struct {
	...
	// ai加速卡类型
	AiCardType *BatchListEdgeAppVersionsRequestAiCardType `json:"ai_card_type,omitempty" xml:"ai_card_type"`

	// 支持架构
	Arch *BatchListEdgeAppVersionsRequestArch `json:"arch,omitempty" xml:"arch"`

	// 应用版本状态
	State *BatchListEdgeAppVersionsRequestState `json:"state,omitempty" xml:"state"`
}
