...
type EdgeModuleDto struct {
	...
	// 模块运行状态
	State *EdgeModuleDtoState `json:"state,omitempty" xml:"state"`
	...
	// 应用类型
	AppType *EdgeModuleDtoAppType `json:"app_type,omitempty" xml:"app_type"`

	// 功能类型
	FunctionType *EdgeModuleDtoFunctionType `json:"function_type,omitempty" xml:"function_type"`
}
