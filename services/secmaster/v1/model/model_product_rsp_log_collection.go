...
// ProductRspLogCollection 日志采集商品编码对象
type ProductRspLogCollection struct {
...
func (o ProductRspLogCollection) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProductRspLogCollection struct{}"
	}

	return strings.Join([]string{"ProductRspLogCollection", string(data)}, " ")
}
