...
// CreateMetricResponse Response Object
...
func (o CreateMetricResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateMetricResponse struct{}"
	}

	return strings.Join([]string{"CreateMetricResponse", string(data)}, " ")
}
