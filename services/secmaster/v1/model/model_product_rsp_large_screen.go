...
// ProductRspLargeScreen 安全大屏商品编码对象
type ProductRspLargeScreen struct {
...
func (o ProductRspLargeScreen) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProductRspLargeScreen struct{}"
	}

	return strings.Join([]string{"ProductRspLargeScreen", string(data)}, " ")
}
