...
// UpdateMetricsResponse Response Object
...
func (o UpdateMetricsResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateMetricsResponse struct{}"
	}

	return strings.Join([]string{"UpdateMetricsResponse", string(data)}, " ")
}
