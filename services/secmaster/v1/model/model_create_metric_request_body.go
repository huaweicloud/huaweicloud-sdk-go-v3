...
// CreateMetricRequestBody 创建指标请求体
type CreateMetricRequestBody struct {
...
func (o CreateMetricRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateMetricRequestBody struct{}"
	}

	return strings.Join([]string{"CreateMetricRequestBody", string(data)}, " ")
}
