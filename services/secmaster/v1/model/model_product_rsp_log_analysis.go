...
// ProductRspLogAnalysis 日志分析商品编码对象
type ProductRspLogAnalysis struct {
...
func (o ProductRspLogAnalysis) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProductRspLogAnalysis struct{}"
	}

	return strings.Join([]string{"ProductRspLogAnalysis", string(data)}, " ")
}
