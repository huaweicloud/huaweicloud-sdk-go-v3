...
// ProductRspSoar 安全编排商品编码对象
type ProductRspSoar struct {
...
func (o ProductRspSoar) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProductRspSoar struct{}"
	}

	return strings.Join([]string{"ProductRspSoar", string(data)}, " ")
}
