...
// ShowWorkspaceResponseBodyWorkspace 空间详情
type ShowWorkspaceResponseBodyWorkspace struct {
...
func (o ShowWorkspaceResponseBodyWorkspace) String() string {
	...
	if err != nil {
		return "ShowWorkspaceResponseBodyWorkspace struct{}"
	}

	return strings.Join([]string{"ShowWorkspaceResponseBodyWorkspace", string(data)}, " ")
}
