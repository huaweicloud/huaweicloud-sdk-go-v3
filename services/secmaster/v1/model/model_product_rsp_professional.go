...
// ProductRspProfessional 专业版商品编码对象
type ProductRspProfessional struct {
...
func (o ProductRspProfessional) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProductRspProfessional struct{}"
	}

	return strings.Join([]string{"ProductRspProfessional", string(data)}, " ")
}
