...
// ShowLayoutFieldInfoResponse Response Object
type ShowLayoutFieldInfoResponse struct {
...
func (o ShowLayoutFieldInfoResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowLayoutFieldInfoResponse struct{}"
	}

	return strings.Join([]string{"ShowLayoutFieldInfoResponse", string(data)}, " ")
}
