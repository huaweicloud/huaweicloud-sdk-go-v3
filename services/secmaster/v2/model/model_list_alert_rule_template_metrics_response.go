...
type ListAlertRuleTemplateMetricsResponse struct {
	Severity *ListAlertRuleTemplateMetricsResponseBodySeverity `json:"severity,omitempty"`

	Status         *ListAlertRuleTemplateMetricsResponseBodyStatus `json:"status,omitempty"`
