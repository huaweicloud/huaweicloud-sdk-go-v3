...
// CreateAnalysisScriptResponse Response Object
type CreateAnalysisScriptResponse struct {
...
func (o CreateAnalysisScriptResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateAnalysisScriptResponse struct{}"
	}

	return strings.Join([]string{"CreateAnalysisScriptResponse", string(data)}, " ")
}
