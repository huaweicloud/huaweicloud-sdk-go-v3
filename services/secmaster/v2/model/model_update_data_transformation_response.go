...
// UpdateDataTransformationResponse Response Object
type UpdateDataTransformationResponse struct {
...
func (o UpdateDataTransformationResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateDataTransformationResponse struct{}"
	}

	return strings.Join([]string{"UpdateDataTransformationResponse", string(data)}, " ")
}
