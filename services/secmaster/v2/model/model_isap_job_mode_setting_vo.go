...
// IsapJobModeSettingVo 作业模式设置
type IsapJobModeSettingVo struct {
...
func (o IsapJobModeSettingVo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "IsapJobModeSettingVo struct{}"
	}

	return strings.Join([]string{"IsapJobModeSettingVo", string(data)}, " ")
}
