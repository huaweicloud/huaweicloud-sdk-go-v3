...
func (o DeleteDataobjectRelationsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteDataobjectRelationsRequest struct{}"
	}

	return strings.Join([]string{"DeleteDataobjectRelationsRequest", string(data)}, " ")
}
