...
// ShowDataTransformationResponse Response Object
type ShowDataTransformationResponse struct {
...
func (o ShowDataTransformationResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowDataTransformationResponse struct{}"
	}

	return strings.Join([]string{"ShowDataTransformationResponse", string(data)}, " ")
}
