...
// UpdateLayoutFieldResponse Response Object
type UpdateLayoutFieldResponse struct {
...
func (o UpdateLayoutFieldResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateLayoutFieldResponse struct{}"
	}

	return strings.Join([]string{"UpdateLayoutFieldResponse", string(data)}, " ")
}
