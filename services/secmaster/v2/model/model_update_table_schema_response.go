...
// UpdateTableSchemaResponse Response Object
...
func (o UpdateTableSchemaResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateTableSchemaResponse struct{}"
	}

	return strings.Join([]string{"UpdateTableSchemaResponse", string(data)}, " ")
}
