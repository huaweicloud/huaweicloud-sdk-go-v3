...
// UpdateAnalysisScriptResponse Response Object
type UpdateAnalysisScriptResponse struct {
...
func (o UpdateAnalysisScriptResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateAnalysisScriptResponse struct{}"
	}

	return strings.Join([]string{"UpdateAnalysisScriptResponse", string(data)}, " ")
}
