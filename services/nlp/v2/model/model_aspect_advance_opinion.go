...
type AspectAdvanceOpinion struct {
	...
	AspectCategory string `json:"aspect_category" xml:"aspect_category"`
	...
	// 属性描述词，预留参数，暂不支持。
	AspectTerm string `json:"aspect_term" xml:"aspect_term"`

	// 观点描述词，预留参数，暂不支持。
	OpinionTerm string `json:"opinion_term" xml:"opinion_term"`
