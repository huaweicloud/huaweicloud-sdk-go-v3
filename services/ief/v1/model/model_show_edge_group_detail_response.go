...
func (o ShowEdgeGroupDetailResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowEdgeGroupDetailResponse struct{}"
	}

	return strings.Join([]string{"ShowEdgeGroupDetailResponse", string(data)}, " ")
}
