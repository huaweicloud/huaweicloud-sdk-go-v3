...
type Annotations struct {
	...
	RingController *string `json:"ring_controller,omitempty" xml:"ring_controller"`

	// 离线自愈功能配置字段，须填写调度的节点组id
	AutonomyEdgeSelector *string `json:"autonomy_edge_selector,omitempty" xml:"autonomy_edge_selector"`
}
