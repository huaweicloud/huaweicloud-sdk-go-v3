...
func (o AppVersionDetailLivenessProbe) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AppVersionDetailLivenessProbe struct{}"
	}

	return strings.Join([]string{"AppVersionDetailLivenessProbe", string(data)}, " ")
}
