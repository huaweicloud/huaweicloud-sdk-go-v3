...
func (o ShowEdgeGroupCertDetailResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowEdgeGroupCertDetailResponse struct{}"
	}

	return strings.Join([]string{"ShowEdgeGroupCertDetailResponse", string(data)}, " ")
}
