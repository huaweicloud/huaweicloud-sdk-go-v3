...
func (o ValueInPropertyVisitorsAccessMode) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ValueInPropertyVisitorsAccessMode struct{}"
	}

	return strings.Join([]string{"ValueInPropertyVisitorsAccessMode", string(data)}, " ")
}
