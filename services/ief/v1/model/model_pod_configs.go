...
type PodConfigs struct {
	...
	HostNetwork bool `json:"host_network" xml:"host_network"`

	// 应用实例是否与主机共PID命名空间，默认值false
	HostPid *bool `json:"host_pid,omitempty" xml:"host_pid"`

	// 应用实例故障是否迁移，指定节点组部署时必选，默认值false
	Migration *bool `json:"migration,omitempty" xml:"migration"`
	...
	TolerationSeconds *int32 `json:"toleration_seconds,omitempty" xml:"toleration_seconds"`
}
