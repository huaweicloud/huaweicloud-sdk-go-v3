...
type BuildInfoParameters struct {
	...
	BuildCmd *string `json:"build_cmd,omitempty" xml:"build_cmd"`

	// dockerfile地址。默认是根目录./。
	DockerfilePath *string `json:"dockerfile_path,omitempty" xml:"dockerfile_path"`

	// 构建归档组织，默认cas_{project_id}。
	ArtifactNamespace *string `json:"artifact_namespace,omitempty" xml:"artifact_namespace"`
}
