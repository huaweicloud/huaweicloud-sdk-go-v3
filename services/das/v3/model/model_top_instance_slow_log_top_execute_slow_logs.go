...
type TopInstanceSlowLogTopExecuteSlowLogs struct {
...
func (o TopInstanceSlowLogTopExecuteSlowLogs) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "TopInstanceSlowLogTopExecuteSlowLogs struct{}"
	}

	return strings.Join([]string{"TopInstanceSlowLogTopExecuteSlowLogs", string(data)}, " ")
}
