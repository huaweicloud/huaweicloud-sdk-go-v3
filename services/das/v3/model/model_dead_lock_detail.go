...
type DeadLockDetail struct {
	...
	// 死锁子明细列表
	SubDetailList *[]DeadLockSubDetail `json:"sub_detail_list,omitempty"`
}

func (o DeadLockDetail) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeadLockDetail struct{}"
	}

	return strings.Join([]string{"DeadLockDetail", string(data)}, " ")
}
