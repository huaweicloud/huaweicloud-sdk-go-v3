...
// ShowMetaLockSnapshotResponse Response Object
type ShowMetaLockSnapshotResponse struct {
...
func (o ShowMetaLockSnapshotResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowMetaLockSnapshotResponse struct{}"
	}

	return strings.Join([]string{"ShowMetaLockSnapshotResponse", string(data)}, " ")
}
