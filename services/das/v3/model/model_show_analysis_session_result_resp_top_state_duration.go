...
type ShowAnalysisSessionResultRespTopStateDuration struct {
...
func (o ShowAnalysisSessionResultRespTopStateDuration) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowAnalysisSessionResultRespTopStateDuration struct{}"
	}

	return strings.Join([]string{"ShowAnalysisSessionResultRespTopStateDuration", string(data)}, " ")
}
