...
// ShowExecutionPlanResponse Response Object
type ShowExecutionPlanResponse struct {
...
func (o ShowExecutionPlanResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowExecutionPlanResponse struct{}"
	}

	return strings.Join([]string{"ShowExecutionPlanResponse", string(data)}, " ")
}
