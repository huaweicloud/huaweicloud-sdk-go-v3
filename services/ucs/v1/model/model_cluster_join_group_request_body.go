...
func (o ClusterJoinGroupRequestBody) String() string {
	...
	if err != nil {
		return "ClusterJoinGroupRequestBody struct{}"
	}

	return strings.Join([]string{"ClusterJoinGroupRequestBody", string(data)}, " ")
}

func (o *ClusterJoinGroupRequestBody) UnmarshalJSON(b []byte) error {
