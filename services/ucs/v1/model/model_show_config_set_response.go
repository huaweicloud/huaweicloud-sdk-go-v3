...
// ShowConfigSetResponse Response Object
type ShowConfigSetResponse struct {
...
func (o ShowConfigSetResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowConfigSetResponse struct{}"
	}

	return strings.Join([]string{"ShowConfigSetResponse", string(data)}, " ")
}
