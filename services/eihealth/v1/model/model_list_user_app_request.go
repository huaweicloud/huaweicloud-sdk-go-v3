...
// ListUserAppRequest Request Object
type ListUserAppRequest struct {
...
func (o ListUserAppRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListUserAppRequest struct{}"
	}

	return strings.Join([]string{"ListUserAppRequest", string(data)}, " ")
}
