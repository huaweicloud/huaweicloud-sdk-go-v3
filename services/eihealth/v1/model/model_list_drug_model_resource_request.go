...
// ListDrugModelResourceRequest Request Object
type ListDrugModelResourceRequest struct {
...
func (o ListDrugModelResourceRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListDrugModelResourceRequest struct{}"
	}

	return strings.Join([]string{"ListDrugModelResourceRequest", string(data)}, " ")
}
