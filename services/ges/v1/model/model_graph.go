...
type Graph struct {
	...
	EnableMultiAz *bool `json:"enableMultiAz,omitempty" xml:"enableMultiAz"`

	Encryption *EncryptionReq `json:"encryption,omitempty" xml:"encryption"`

	LtsOperationTrace *LtsOperationTraceReq `json:"ltsOperationTrace,omitempty" xml:"ltsOperationTrace"`

	// 企业项目信息，如果未指定则不开启，默认不开启。
	SysTags *[]SysTagsRes `json:"sys_tags,omitempty" xml:"sys_tags"`
