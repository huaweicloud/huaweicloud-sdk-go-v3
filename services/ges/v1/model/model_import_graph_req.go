...
type ImportGraphReq struct {
	...
	// 边文件目录或边文件名。
	EdgesetPath *string `json:"edgesetPath,omitempty" xml:"edgesetPath"`
	...
	// 新增数据的元数据文件路径。
	SchemaPath *string `json:"schemaPath,omitempty" xml:"schemaPath"`

	// 导入图日志存放目录，用于存储导入失败的数据和详细错入原因。
	LogDir *string `json:"logDir,omitempty" xml:"logDir"`

	// 重复边处理
	ParallelEdge *interface{} `json:"parallelEdge,omitempty" xml:"parallelEdge"`
	...
	IgnoreLabel *bool `json:"ignoreLabel,omitempty" xml:"ignoreLabel"`
