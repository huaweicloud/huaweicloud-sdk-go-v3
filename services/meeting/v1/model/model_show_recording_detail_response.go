...
func (o ShowRecordingDetailResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowRecordingDetailResponse struct{}"
	}

	return strings.Join([]string{"ShowRecordingDetailResponse", string(data)}, " ")
}
