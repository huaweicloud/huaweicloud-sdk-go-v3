...
type RestCustomMultiPictureBody struct {
	...
	ManualSet int32 `json:"manualSet" xml:"manualSet"`
	...
	// 子画面列表
	SubscriberInPics *[]RestSubscriberInPic `json:"subscriberInPics,omitempty" xml:"subscriberInPics"`

	// 表示轮询间隔，单位：秒。 当同一个子画面中包含有多个视频源时，此参数有效
	SwitchTime *int32 `json:"switchTime,omitempty" xml:"switchTime"`

	// 多画面仅保存
	MultiPicSaveOnly *bool `json:"multiPicSaveOnly,omitempty" xml:"multiPicSaveOnly"`
}
