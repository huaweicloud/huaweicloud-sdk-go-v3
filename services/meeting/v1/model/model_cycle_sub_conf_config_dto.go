...
type CycleSubConfConfigDto struct {
	...
	AudienceCallInRestriction *int32 `json:"audienceCallInRestriction,omitempty" xml:"audienceCallInRestriction"`
	...
	ShowAudienceCountInfo *ShowAudienceCountInfo `json:"showAudienceCountInfo,omitempty" xml:"showAudienceCountInfo"`
}
