...
type PublicationResponseBase struct {
	...
	PublishStatus *PublicationResponseBasePublishStatus `json:"publishStatus,omitempty" xml:"publishStatus"`
}
...
func (c PublicationResponseBasePublishStatus) Value() string {
	return c.value
}
