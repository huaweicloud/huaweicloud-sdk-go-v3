...
type SearchStatisticResourceInfoRequest struct {
	...
	TimeUnit SearchStatisticResourceInfoRequestTimeUnit `json:"timeUnit" xml:"timeUnit"`
	...
	Category SearchStatisticResourceInfoRequestCategory `json:"category" xml:"category"`
}
