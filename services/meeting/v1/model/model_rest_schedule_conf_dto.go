...
type RestScheduleConfDto struct {
	...
	MediaTypes string `json:"mediaTypes" xml:"mediaTypes"`

	// 软终端创建即时会议时在当前字段带临时群组ID，由服务器在邀请其他与会者时在或者conference-info头域中携带。长度限制为31个字符。
	Groupuri *string `json:"groupuri,omitempty" xml:"groupuri"`

	// 与会者列表。该列表可以用于发送会议通知、会议提醒、会议开始时候进行自动邀请。
	Attendees *[]RestAttendeeDto `json:"attendees,omitempty" xml:"attendees"`
	...
	EncryptMode *int32 `json:"encryptMode,omitempty" xml:"encryptMode"`
