...
type ModDeptDto struct {
	...
	InPermission *ModDeptDtoInPermission `json:"inPermission,omitempty" xml:"inPermission"`
	...
	OutPermission *ModDeptDtoOutPermission `json:"outPermission,omitempty" xml:"outPermission"`
