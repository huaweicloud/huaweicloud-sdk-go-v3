...
type AddDeviceDto struct {
	...
	PrjCodeMode *AddDeviceDtoPrjCodeMode `json:"prjCodeMode,omitempty" xml:"prjCodeMode"`
	...
	Status *AddDeviceDtoStatus `json:"status,omitempty" xml:"status"`

	// 是否发送邮件和短信通知。 * 0：不发送 * 不填或者其他值就发送
	SendNotify *string `json:"sendNotify,omitempty" xml:"sendNotify"`
}
