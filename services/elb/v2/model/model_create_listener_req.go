...
type CreateListenerReq struct {
	...
	// 监听器的监听协议
	Protocol CreateListenerReqProtocol `json:"protocol" xml:"protocol"`
	...
	InsertHeaders *InsertHeader `json:"insert_headers,omitempty" xml:"insert_headers"`

	// 监听器使用的安全策略，仅对TERMINATED_HTTPS协议类型的监听器有效，且默认值为tls-1-0。  取值包括：tls-1-0, tls-1-1, tls-1-2, tls-1-2-strict多种安全策略。
	TlsCiphersPolicy *CreateListenerReqTlsCiphersPolicy `json:"tls_ciphers_policy,omitempty" xml:"tls_ciphers_policy"`
}
