...
type UpdateRedirectUrlConfig struct {
	...
	Protocol *UpdateRedirectUrlConfigProtocol `json:"protocol,omitempty" xml:"protocol"`
	...
	StatusCode *UpdateRedirectUrlConfigStatusCode `json:"status_code,omitempty" xml:"status_code"`
}
