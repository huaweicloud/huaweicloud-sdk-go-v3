...
type UpdateL7RuleOption struct {
	...
	CompareType *string `json:"compare_type,omitempty" xml:"compare_type"`

	// 是否反向匹配。取值：true、false。  不支持该字段，请勿使用。
	Invert *bool `json:"invert,omitempty" xml:"invert"`
	...
	Conditions *[]UpdateRuleCondition `json:"conditions,omitempty" xml:"conditions"`
}
