...
type UpdateLoadBalancerOption struct {
	...
	PrepaidOptions *PrepaidUpdateOption `json:"prepaid_options,omitempty" xml:"prepaid_options"`

	Autoscaling *UpdateLoadbalancerAutoscalingOption `json:"autoscaling,omitempty" xml:"autoscaling"`

	// WAF故障时的流量处理策略。discard:丢弃，forward: 转发到后端（默认）   使用说明：只有绑定了waf的LB实例，该字段才会生效。
	WafFailureAction *UpdateLoadBalancerOptionWafFailureAction `json:"waf_failure_action,omitempty" xml:"waf_failure_action"`
}
