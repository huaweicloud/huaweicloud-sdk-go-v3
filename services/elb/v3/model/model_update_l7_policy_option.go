...
type UpdateL7PolicyOption struct {
	...
	RedirectUrlConfig *UpdateRedirectUrlConfig `json:"redirect_url_config,omitempty" xml:"redirect_url_config"`

	FixedResponseConfig *UpdateFixtedResponseConfig `json:"fixed_response_config,omitempty" xml:"fixed_response_config"`
	...
	Rules *[]CreateRuleOption `json:"rules,omitempty" xml:"rules"`
