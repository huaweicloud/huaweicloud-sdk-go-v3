...
type CreateLoadBalancerOption struct {
	...
	Ipv6Bandwidth *BandwidthRef `json:"ipv6_bandwidth,omitempty" xml:"ipv6_bandwidth"`

	// 负载均衡器绑定的Global EIP的id。只支持绑定数组中的第一个Global EIP，其他将被忽略。
	GlobalEipIds *[]string `json:"global_eip_ids,omitempty" xml:"global_eip_ids"`

	// 负载均衡器绑定的公网IP ID。只支持绑定数组中的第一个EIP，其他将被忽略。
	PublicipIds *[]string `json:"publicip_ids,omitempty" xml:"publicip_ids"`

	Publicip *CreateLoadBalancerPublicIpOption `json:"publicip,omitempty" xml:"publicip"`
	...
	ElbVirsubnetIds *[]string `json:"elb_virsubnet_ids,omitempty" xml:"elb_virsubnet_ids"`
	...
	IpTargetEnable *bool `json:"ip_target_enable,omitempty" xml:"ip_target_enable"`
	...
	PrepaidOptions *PrepaidCreateOption `json:"prepaid_options,omitempty" xml:"prepaid_options"`

	Autoscaling *CreateLoadbalancerAutoscalingOption `json:"autoscaling,omitempty" xml:"autoscaling"`

	// WAF故障时的流量处理策略。discard:丢弃，forward: 转发到后端（默认）   使用说明：只有绑定了waf的LB实例，该字段才会生效。
	WafFailureAction *CreateLoadBalancerOptionWafFailureAction `json:"waf_failure_action,omitempty" xml:"waf_failure_action"`
}
