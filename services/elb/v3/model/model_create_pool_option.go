...
type CreatePoolOption struct {
	...
	SessionPersistence *CreatePoolSessionPersistenceOption `json:"session_persistence,omitempty" xml:"session_persistence"`

	SlowStart *CreatePoolSlowStartOption `json:"slow_start,omitempty" xml:"slow_start"`

	// 是否开启删除保护。取值：false不开启，true开启，默认false。 > 退场时需要先关闭所有资源的删除保护开关。
	MemberDeletionProtectionEnable *bool `json:"member_deletion_protection_enable,omitempty" xml:"member_deletion_protection_enable"`
