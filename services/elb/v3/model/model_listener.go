...
type Listener struct {
	...
	InsertHeaders *ListenerInsertHeaders `json:"insert_headers" xml:"insert_headers"`
	...
	SniMatchAlgo string `json:"sni_match_algo" xml:"sni_match_algo"`
	...
	EnableMemberRetry bool `json:"enable_member_retry" xml:"enable_member_retry"`
	...
	KeepaliveTimeout int32 `json:"keepalive_timeout" xml:"keepalive_timeout"`
	...
	ClientTimeout int32 `json:"client_timeout" xml:"client_timeout"`

	// 等待后端服务器响应超时时间。请求转发后端服务器后，在等待超时member_timeout时长没有响应，负载均衡将终止等待，并返回 HTTP504错误码。   取值：1-300s，默认为60s。   使用说明：仅支持协议为HTTP/HTTPS的监听器。
	MemberTimeout int32 `json:"member_timeout" xml:"member_timeout"`

	Ipgroup *ListenerIpGroup `json:"ipgroup" xml:"ipgroup"`
	...
	TransparentClientIpEnable bool `json:"transparent_client_ip_enable" xml:"transparent_client_ip_enable"`
	...
	EnhanceL7policyEnable bool `json:"enhance_l7policy_enable" xml:"enhance_l7policy_enable"`

	QuicConfig *ListenerQuicConfig `json:"quic_config,omitempty" xml:"quic_config"`
}
