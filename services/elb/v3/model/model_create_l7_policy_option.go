...
type CreateL7PolicyOption struct {
	...
	RedirectPoolsConfig *[]CreateRedirectPoolsConfig `json:"redirect_pools_config,omitempty" xml:"redirect_pools_config"`
	...
	RedirectUrlConfig *CreateRedirectUrlConfig `json:"redirect_url_config,omitempty" xml:"redirect_url_config"`

	FixedResponseConfig *CreateFixtedResponseConfig `json:"fixed_response_config,omitempty" xml:"fixed_response_config"`
	...
	Rules *[]CreateL7PolicyRuleOption `json:"rules,omitempty" xml:"rules"`
}
