...
type UpdateListenerIpGroupOption struct {
	...
	IpgroupId *string `json:"ipgroup_id,omitempty" xml:"ipgroup_id"`

	// 访问控制组的状态。 True:开启访问控制； Flase：关闭访问控制； 开启访问控制的监听器，允许直接删除。
	EnableIpgroup *bool `json:"enable_ipgroup,omitempty" xml:"enable_ipgroup"`

	// 访问控制组的类型。 white:白名单，只允许指定ip访问； black:黑名单，不允许指定ip访问；
	Type *UpdateListenerIpGroupOptionType `json:"type,omitempty" xml:"type"`
}
