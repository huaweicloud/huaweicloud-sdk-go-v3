...
type UpdatePoolOption struct {
	...
	SessionPersistence *UpdatePoolSessionPersistenceOption `json:"session_persistence,omitempty" xml:"session_persistence"`

	SlowStart *UpdatePoolSlowStartOption `json:"slow_start,omitempty" xml:"slow_start"`
