...
type UpdateHealthMonitorOption struct {
	...
	Delay *int32 `json:"delay,omitempty" xml:"delay"`
	...
	ExpectedCodes *string `json:"expected_codes,omitempty" xml:"expected_codes"`

	// HTTP请求方法，取值：GET、HEAD、POST、PUT、DELETE、TRACE、OPTIONS、CONNECT、PATCH，默认GET。   使用说明：当type为HTTP/HTTPS时生效。   不支持该字段，请勿使用。
	HttpMethod *UpdateHealthMonitorOptionHttpMethod `json:"http_method,omitempty" xml:"http_method"`

	// 健康检查连续成功多少次后，将后端服务器的健康检查状态由OFFLINE判定为ONLINE。取值范围：1-10。
	MaxRetries *int32 `json:"max_retries,omitempty" xml:"max_retries"`

	// 健康检查连续失败多少次后，将后端服务器的健康检查状态由ONLINE判定为OFFLINE。取值范围：1-10。
	MaxRetriesDown *int32 `json:"max_retries_down,omitempty" xml:"max_retries_down"`

	// 健康检查端口号。取值：1-65535，不可传入空，但可传入null，表示使用后端云服务器端口号。
	MonitorPort *int32 `json:"monitor_port,omitempty" xml:"monitor_port"`
	...
	UrlPath *string `json:"url_path,omitempty" xml:"url_path"`
