...
type CreateLoadBalancerBandwidthOption struct {
	...
	ChargeMode *CreateLoadBalancerBandwidthOptionChargeMode `json:"charge_mode,omitempty" xml:"charge_mode"`
	...
	ShareType *CreateLoadBalancerBandwidthOptionShareType `json:"share_type,omitempty" xml:"share_type"`
