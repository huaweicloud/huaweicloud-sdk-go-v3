...
type HealthMonitor struct {
	...
	ExpectedCodes string `json:"expected_codes" xml:"expected_codes"`
	...
	MaxRetriesDown int32 `json:"max_retries_down" xml:"max_retries_down"`

	// 健康检查端口号。取值：1-65535，默认为空，表示使用后端云服务器端口号。
	MonitorPort int32 `json:"monitor_port" xml:"monitor_port"`
	...
	UrlPath string `json:"url_path" xml:"url_path"`
