...
type PrepaidChangeChargeModeOption struct {
	...
	IncludePublicip *bool `json:"include_publicip,omitempty" xml:"include_publicip"`

	// 订购周期类型，当前支持包月和包年： month：月（默认）； year：年；
	PeriodType PrepaidChangeChargeModeOptionPeriodType `json:"period_type" xml:"period_type"`
