...
type CreateListenerOption struct {
	...
	Ipgroup *CreateListenerIpGroupOption `json:"ipgroup,omitempty" xml:"ipgroup"`
	...
	QuicConfig *CreateListenerQuicConfigOption `json:"quic_config,omitempty" xml:"quic_config"`
}
