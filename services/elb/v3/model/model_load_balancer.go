...
type LoadBalancer struct {
	...
	Pools []PoolRef `json:"pools" xml:"pools"`
	...
	// 负载均衡器所在子网的IPv4子网ID。
	VipSubnetCidrId string `json:"vip_subnet_cidr_id" xml:"vip_subnet_cidr_id"`

	// 负载均衡器的IPv4虚拟IP地址。
	VipAddress string `json:"vip_address" xml:"vip_address"`

	// 负载均衡器的IPv4对应的port ID。[创建弹性负载均衡时，会自动为负载均衡创建一个port并关联一个默认的安全组，这个安全组对所有流量不生效。](tag:dt,dt_test,hcso_dt)
	VipPortId string `json:"vip_port_id" xml:"vip_port_id"`
	...
	Guaranteed bool `json:"guaranteed" xml:"guaranteed"`

	// 负载均衡器所在VPC ID。
	VpcId string `json:"vpc_id" xml:"vpc_id"`

	// 负载均衡器绑定的EIP。只支持绑定一个EIP。  注：该字段与publicips一致。
	Eips []EipInfo `json:"eips" xml:"eips"`

	// 双栈类型负载均衡器的IPv6地址。 [ 不支持IPv6，请勿使用。](tag:dt,dt_test)
	Ipv6VipAddress string `json:"ipv6_vip_address" xml:"ipv6_vip_address"`

	// 双栈类型负载均衡器所在子网的IPv6网络ID。 [ 不支持IPv6，请勿使用。](tag:dt,dt_test)
	Ipv6VipVirsubnetId string `json:"ipv6_vip_virsubnet_id" xml:"ipv6_vip_virsubnet_id"`

	// 双栈类型负载均衡器的IPv6对应的port ID。 [ 不支持IPv6，请勿使用。](tag:dt,dt_test)
	Ipv6VipPortId string `json:"ipv6_vip_port_id" xml:"ipv6_vip_port_id"`

	// 负载均衡器所在的可用区列表。
	AvailabilityZoneList []string `json:"availability_zone_list" xml:"availability_zone_list"`
	...
	L4FlavorId string `json:"l4_flavor_id" xml:"l4_flavor_id"`

	// 四层弹性Flavor ID。  不支持该字段，请勿使用。
	L4ScaleFlavorId string `json:"l4_scale_flavor_id" xml:"l4_scale_flavor_id"`

	// 七层Flavor ID。 对于弹性扩缩容实例，表示上限规格ID。  [hsco场景下所有LB实例共享带宽，该字段无效，请勿使用。](tag:hcso)
	L7FlavorId string `json:"l7_flavor_id" xml:"l7_flavor_id"`

	// 七层弹性Flavor ID。  不支持该字段，请勿使用。
	L7ScaleFlavorId string `json:"l7_scale_flavor_id" xml:"l7_scale_flavor_id"`

	// 负载均衡器绑定的公网IP。只支持绑定一个公网IP。  注：该字段与eips一致。
	Publicips []PublicIpInfo `json:"publicips" xml:"publicips"`

	// 负载均衡器绑定的global eip。只支持绑定一个global eip。
	GlobalEips []GlobalEipInfo `json:"global_eips" xml:"global_eips"`

	// 下联面子网的网络ID列表。
	ElbVirsubnetIds []string `json:"elb_virsubnet_ids" xml:"elb_virsubnet_ids"`

	// 下联面子网类型 - ipv4：ipv4 - dualstack：双栈
	ElbVirsubnetType LoadBalancerElbVirsubnetType `json:"elb_virsubnet_type" xml:"elb_virsubnet_type"`
	...
	IpTargetEnable bool `json:"ip_target_enable" xml:"ip_target_enable"`
	...
	FrozenScene string `json:"frozen_scene" xml:"frozen_scene"`

	Ipv6Bandwidth *BandwidthRef `json:"ipv6_bandwidth" xml:"ipv6_bandwidth"`
	...
	Autoscaling *AutoscalingRef `json:"autoscaling,omitempty" xml:"autoscaling"`
	...
	WafFailureAction *string `json:"waf_failure_action,omitempty" xml:"waf_failure_action"`
}
