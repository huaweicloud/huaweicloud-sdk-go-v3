...
type TaskDetails struct {
	...
	ServiceTitle *TaskDetailsServiceTitle `json:"service_title" xml:"service_title"`
	...
	State TaskDetailsState `json:"state" xml:"state"`

	// 作业状态的详情信息，仅部分状态会有详情信息
	Status *string `json:"status,omitempty" xml:"status"`

	Error *TaskDetailsError `json:"error,omitempty" xml:"error"`

	// 计划任务的状态，分别为ACTIVATED（激活），INACTIVATED（未激活）
	TimingStatus *TaskDetailsTimingStatus `json:"timing_status,omitempty" xml:"timing_status"`

	Timing *TaskTiming `json:"timing,omitempty" xml:"timing"`

	Input *TaskInput `json:"input" xml:"input"`

	Output *TaskOutputForDisplay `json:"output" xml:"output"`
...
func GetTaskDetailsTimingStatusEnum() TaskDetailsTimingStatusEnum {
	return TaskDetailsTimingStatusEnum{
		ACTIVATED: TaskDetailsTimingStatus{
			value: "ACTIVATED",
		},
		INACTIVATED: TaskDetailsTimingStatus{
