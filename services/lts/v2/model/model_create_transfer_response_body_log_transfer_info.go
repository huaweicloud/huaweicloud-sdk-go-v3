...
type CreateTransferResponseBodyLogTransferInfo struct {
	LogAgencyTransfer *CreateTransferResponseBodyLogTransferInfoLogAgencyTransfer `json:"log_agency_transfer,omitempty" xml:"log_agency_transfer"`

	// 日志转储创建时间
	LogCreateTime int64 `json:"log_create_time" xml:"log_create_time"`

	// 日志转储格式。只支持\"RAW\", \"JSON\"。RAW是指原始日志格式，JSON是指JSON日志格式。OBS转储和DIS转储支持JSON和RAW，DMS转储仅支持RAW
	LogStorageFormat CreateTransferResponseBodyLogTransferInfoLogStorageFormat `json:"log_storage_format" xml:"log_storage_format"`
	...
	LogTransferMode CreateTransferResponseBodyLogTransferInfoLogTransferMode `json:"log_transfer_mode" xml:"log_transfer_mode"`

	// 日志转储状态，ENABLE是指日志转储开启状态，DISABLE是指日志转储关闭状态，EXCEPTION是指日志转储异常状态
	LogTransferStatus CreateTransferResponseBodyLogTransferInfoLogTransferStatus `json:"log_transfer_status" xml:"log_transfer_status"`

	// 日志转储类型。OBS指OBS日志转储，DIS指DIS日志转储，DMS指DMS日志转储
	LogTransferType CreateTransferResponseBodyLogTransferInfoLogTransferType `json:"log_transfer_type" xml:"log_transfer_type"`
}
