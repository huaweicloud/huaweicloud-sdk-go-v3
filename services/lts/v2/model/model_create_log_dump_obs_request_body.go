...
type CreateLogDumpObsRequestBody struct {
	...
	LogStreamIds []string `json:"log_stream_ids" xml:"log_stream_ids"`
	...
	StorageFormat string `json:"storage_format" xml:"storage_format"`

	// 是否开启转储 true/false, 默认为 true
	SwitchOn *bool `json:"switch_on,omitempty" xml:"switch_on"`

	// 转储至OBS桶中的日志文件前缀。
	PrefixName *string `json:"prefix_name,omitempty" xml:"prefix_name"`

	// 自定义文件夹路径。
	DirPrefixName *string `json:"dir_prefix_name,omitempty" xml:"dir_prefix_name"`
	...
	PeriodUnit string `json:"period_unit" xml:"period_unit"`
}
