...
type StructConfig struct {
	...
	TemplateType StructConfigTemplateType `json:"template_type" xml:"template_type"`

	// 示例字段数组，只需要填写与模板中is_analysis状态不同的字段
	DemoFields *[]FieldModel `json:"demo_fields,omitempty" xml:"demo_fields"`

	// Tag字段数组，只需要填写与模板中is_analysis状态不同的字段
	TagFields *[]FieldModel `json:"tag_fields,omitempty" xml:"tag_fields"`
	...
	QuickAnalysis *bool `json:"quick_analysis,omitempty" xml:"quick_analysis"`
}
