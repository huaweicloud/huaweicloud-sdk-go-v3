...
type AccessConfigDeatil struct {
	...
	Format *AccessConfigFormat `json:"format,omitempty" xml:"format"`

	WindowsLogInfo *AccessConfigWindowsLogInfo `json:"windows_log_info,omitempty" xml:"windows_log_info"`
}
