...
type UpdateSqlAlarmRuleRequestBody struct {
	...
	// 告警级别
	SqlAlarmLevel UpdateSqlAlarmRuleRequestBodySqlAlarmLevel `json:"sql_alarm_level" xml:"sql_alarm_level"`

	// 是否发送
	SqlAlarmSend bool `json:"sql_alarm_send" xml:"sql_alarm_send"`

	// 发送主题 0:不变 1:新增 2:修改 3:删除
	SqlAlarmSendCode UpdateSqlAlarmRuleRequestBodySqlAlarmSendCode `json:"sql_alarm_send_code" xml:"sql_alarm_send_code"`
