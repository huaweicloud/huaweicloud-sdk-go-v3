...
type CreateNotificationTemplateResBody struct {
...
func (o CreateNotificationTemplateResBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateNotificationTemplateResBody struct{}"
	}

	return strings.Join([]string{"CreateNotificationTemplateResBody", string(data)}, " ")
}
