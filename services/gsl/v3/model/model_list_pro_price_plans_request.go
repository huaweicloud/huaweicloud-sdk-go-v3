...
type ListProPricePlansRequest struct {
	...
	NetworkType *int64 `json:"network_type,omitempty" xml:"network_type"`

	// 覆盖区域:1.  中国 2.  欧洲 3.  大洋洲 4.  非洲 5.  亚太
	LocationType *int64 `json:"location_type,omitempty" xml:"location_type"`
	...
	CountryType *int64 `json:"country_type,omitempty" xml:"country_type"`
}
