...
type CreateSystemIssueRequestV4 struct {
	...
	// 用户自定义字段
	CustomFields *[]ScrumCustomField `json:"custom_fields,omitempty" xml:"custom_fields"`
}

func (o CreateSystemIssueRequestV4) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateSystemIssueRequestV4 struct{}"
	}

	return strings.Join([]string{"CreateSystemIssueRequestV4", string(data)}, " ")
}
