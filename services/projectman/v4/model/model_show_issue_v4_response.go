...
type ShowIssueV4Response struct {
	...
	// 自定义属性值
	NewCustomFields *[]IssueDetailCustomField `json:"new_custom_fields,omitempty" xml:"new_custom_fields"`
	...
	Order *IssueOrder `json:"order,omitempty" xml:"order"`

	// 附近列表
	Accessories    *[]IssueAccessory `json:"accessories,omitempty" xml:"accessories"`
