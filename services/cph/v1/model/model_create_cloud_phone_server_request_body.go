...
type CreateCloudPhoneServerRequestBody struct {
	...
	Ports *[]CreateCloudPhoneServerRequestBodyPorts `json:"ports,omitempty" xml:"ports"`

	BandWidth *CreateCloudPhoneServerRequestBodyBandWidth `json:"band_width" xml:"band_width"`

	ExtendParam *CreateCloudPhoneServerRequestBodyExtendParam `json:"extend_param" xml:"extend_param"`

	// (已废弃)是否开启VNC方式登录云手机。 - 为\"true\"时开启（忽略大小写）。 - 为其他，则不开启
	VncEnable *string `json:"vnc_enable,omitempty" xml:"vnc_enable"`
