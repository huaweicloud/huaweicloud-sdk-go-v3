...
// PatchUserResponse Response Object
...
func (o PatchUserResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PatchUserResponse struct{}"
	}

	return strings.Join([]string{"PatchUserResponse", string(data)}, " ")
}
