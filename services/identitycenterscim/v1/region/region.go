...
var provider = region.DefaultProviderChain("IDENTITYCENTERSCIM")
...
func ValueOf(regionId string) *region.Region {
	...
	panic(fmt.Sprintf("region id '%s' is not in the following supported regions of service 'IdentityCenterSCIM': [%s]", regionId, strings.Join(getRegionIds(), ", ")))
}
