...
func (o ServerProductInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ServerProductInfo struct{}"
	}

	return strings.Join([]string{"ServerProductInfo", string(data)}, " ")
}
