...
// UploadAppIconRawResponse Response Object
type UploadAppIconRawResponse struct {
	...
	IsPreBoot *bool `json:"is_pre_boot,omitempty"`

	AppExtendedInfo *AppExtendedInfo `json:"app_extended_info,omitempty"`
	HttpStatusCode  int              `json:"-"`
}

func (o UploadAppIconRawResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UploadAppIconRawResponse struct{}"
	}

	return strings.Join([]string{"UploadAppIconRawResponse", string(data)}, " ")
}
