...
func (o SubJobDetailInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SubJobDetailInfo struct{}"
	}

	return strings.Join([]string{"SubJobDetailInfo", string(data)}, " ")
}
