...
func GenReqDefForBindAppWarehouseBucket() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/app-warehouse/bucket").
		WithResponse(new(model.BindAppWarehouseBucketResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowAppWarehouseBucket() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/app-warehouse/bucket").
		WithResponse(new(model.ShowAppWarehouseBucketResponse)).
		WithContentType("application/json")
...
func GenReqDefForCheckPublishApp() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/app-groups/{app_group_id}/apps/actions/check").
		WithResponse(new(model.CheckPublishAppResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdatePreBootPolicy() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/app-groups/{app_group_id}/apps/pre-boot-policy").
		WithResponse(new(model.UpdatePreBootPolicyResponse)).
		WithContentType("application/json")
...
func GenReqDefForUploadAppIconRaw() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v1/{project_id}/app-groups/{app_group_id}/apps/{app_id}/raw-icon").
		WithResponse(new(model.UploadAppIconRawResponse)).
		WithContentType("application/json")
...
func GenReqDefForCheckAppGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/app-groups/rules/validate").
		WithResponse(new(model.CheckAppGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchDeleteCloudStorage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/actions/batch-delete-cloud-storages").
		WithResponse(new(model.BatchDeleteCloudStorageResponse)).
		WithContentType("application/json")
...
func GenReqDefForChangeCluster() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/{storage_id}/actions/change-cluster").
		WithResponse(new(model.ChangeClusterResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateCloudStorage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages").
		WithResponse(new(model.CreateCloudStorageResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateUserFolderAssignment() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/{storage_id}/actions/create-folder").
		WithResponse(new(model.CreateUserFolderAssignmentResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteCloudStorage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v1/{project_id}/cloud-storages/{storage_id}").
		WithResponse(new(model.DeleteCloudStorageResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteCloudStorageAttachment() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/{storage_id}/actions/delete-folder").
		WithResponse(new(model.DeleteCloudStorageAttachmentResponse)).
		WithContentType("application/json")
...
func GenReqDefForListCloudStorage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/cloud-storages").
		WithResponse(new(model.ListCloudStorageResponse)).
		WithContentType("application/json")
...
func GenReqDefForListCloudStorageAssignment() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/cloud-storages/actions/list-folders").
		WithResponse(new(model.ListCloudStorageAssignmentResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("AttachNames").
		WithJsonTag("attach_names").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("CapacityFilter").
		WithJsonTag("capacity_filter").
		WithLocationType(def.Query))
...
func GenReqDefForListFoldersAndFiles() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/cloud-storages/actions/list-folder-files").
		WithResponse(new(model.ListFoldersAndFilesResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("CloudStorageAssignmentId").
		WithJsonTag("cloud_storage_assignment_id").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("FolderUrl").
		WithJsonTag("folder_url").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Marker").
		WithJsonTag("marker").
...
func GenReqDefForListProjectConfigs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/cloud-storages/actions/list-project-configs").
...
func GenReqDefForResetUserProfile() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/actions/reset-userprofile").
		WithResponse(new(model.ResetUserProfileResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowProjectConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/cloud-storages/actions/project-config/{cloud_storage_id}").
		WithResponse(new(model.ShowProjectConfigResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("CloudStorageId").
		WithJsonTag("cloud_storage_id").
		WithLocationType(def.Path))
...
func GenReqDefForTransferFile() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/actions/transfer-file").
		WithResponse(new(model.TransferFileResponse)).
		WithContentType("application/json")
...
func GenReqDefForTransferFilePre() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/cloud-storages/actions/pre-transfer-file").
		WithResponse(new(model.TransferFilePreResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateCloudUserFolderAssignment() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPatch).
		WithPath("/v1/{project_id}/cloud-storages/{storage_id}/actions/update-folder/{cloud_assignment_id}").
		WithResponse(new(model.UpdateCloudUserFolderAssignmentResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Path))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("CloudAssignmentId").
		WithJsonTag("cloud_assignment_id").
		WithLocationType(def.Path))
...
func GenReqDefForCreateHotspotSessionConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/hotspot-session-config").
		WithResponse(new(model.CreateHotspotSessionConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForListHotspotSessionConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/hotspot-session-config").
		WithResponse(new(model.ListHotspotSessionConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForListNonMigrationUsers() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users").
		WithResponse(new(model.ListNonMigrationUsersResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateHotspotSessionConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPatch).
		WithPath("/v1/{project_id}/hotspot-session-config/{config_id}").
		WithResponse(new(model.UpdateHotspotSessionConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateNonMigrationUsers() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPatch).
		WithPath("/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users").
		WithResponse(new(model.UpdateNonMigrationUsersResponse)).
		WithContentType("application/json")
...
func GenReqDefForCountImageSubJobs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/image-server-sub-jobs/actions/count").
		WithResponse(new(model.CountImageSubJobsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowHdaUpgradeFlag() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/app-servers/access-agent/upgrade-flag").
		WithResponse(new(model.ShowHdaUpgradeFlagResponse)).
		WithContentType("application/json")
...
func GenReqDefForValidateServerGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/app-server-groups/rules/validate").
		WithResponse(new(model.ValidateServerGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportAppConnection() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/session/app-connection/export").
		WithResponse(new(model.ExportAppConnectionResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportSessions() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/session/list-sessions/export").
		WithResponse(new(model.ExportSessionsResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportUserConnection() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/session/user-connection/export").
		WithResponse(new(model.ExportUserConnectionResponse)).
		WithContentType("application/json")
