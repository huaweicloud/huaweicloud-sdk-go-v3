...
// FlinkJobConfigDetail 作业配置，当“show_detail”为“true”时才有该参数配置。
type FlinkJobConfigDetail struct {
...
func (o FlinkJobConfigDetail) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "FlinkJobConfigDetail struct{}"
	}

	return strings.Join([]string{"FlinkJobConfigDetail", string(data)}, " ")
}
