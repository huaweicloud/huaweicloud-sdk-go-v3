...
// SparkJobSession 创建批处理作业的响应参数。
type SparkJobSession struct {
...
func (o SparkJobSession) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SparkJobSession struct{}"
	}

	return strings.Join([]string{"SparkJobSession", string(data)}, " ")
}
