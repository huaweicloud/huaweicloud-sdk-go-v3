...
func (o ShowStreamJobListJobConfig) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowStreamJobListJobConfig struct{}"
	}

	return strings.Join([]string{"ShowStreamJobListJobConfig", string(data)}, " ")
}
