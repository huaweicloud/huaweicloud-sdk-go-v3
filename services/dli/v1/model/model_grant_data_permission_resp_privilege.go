...
func (o GrantDataPermissionRespPrivilege) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "GrantDataPermissionRespPrivilege struct{}"
	}

	return strings.Join([]string{"GrantDataPermissionRespPrivilege", string(data)}, " ")
}
