...
func (o ListEnhancedConnectionsDetail) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListEnhancedConnectionsDetail struct{}"
	}

	return strings.Join([]string{"ListEnhancedConnectionsDetail", string(data)}, " ")
}
