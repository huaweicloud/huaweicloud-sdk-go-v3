...
func (o CreateDatasourceConnectionReq) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateDatasourceConnectionReq struct{}"
	}

	return strings.Join([]string{"CreateDatasourceConnectionReq", string(data)}, " ")
}
