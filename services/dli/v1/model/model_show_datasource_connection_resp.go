...
func (o ShowDatasourceConnectionResp) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowDatasourceConnectionResp struct{}"
	}

	return strings.Join([]string{"ShowDatasourceConnectionResp", string(data)}, " ")
}
