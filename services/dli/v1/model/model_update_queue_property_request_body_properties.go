...
// UpdateQueuePropertyRequestBodyProperties 待更新属性
type UpdateQueuePropertyRequestBodyProperties struct {
...
func (o UpdateQueuePropertyRequestBodyProperties) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateQueuePropertyRequestBodyProperties struct{}"
	}

	return strings.Join([]string{"UpdateQueuePropertyRequestBodyProperties", string(data)}, " ")
}
