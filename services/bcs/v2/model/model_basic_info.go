...
type BasicInfo struct {
	...
	PurchaseType *string `json:"purchase_type,omitempty" xml:"purchase_type"`
	...
	ChargingMode *int64 `json:"charging_mode,omitempty" xml:"charging_mode"`

	// BCS服务版本类型
	VersionType *int64 `json:"version_type,omitempty" xml:"version_type"`
	...
	ClusterAz *string `json:"cluster_az,omitempty" xml:"cluster_az"`
	...
	// BCS服务是否跨region
	IsCrossRegion *bool `json:"is_cross_region,omitempty" xml:"is_cross_region"`

	// BCS服务升级失败，是否支持回滚
	IsSupportRollback *bool `json:"is_support_rollback,omitempty" xml:"is_support_rollback"`

	// BCS服务是否添加RESTful APIs支持，分为支持（true），不支持（false）
	IsSupportRestful *bool `json:"is_support_restful,omitempty" xml:"is_support_restful"`

	// 区分BCS是否新服务，分为老服务（true），新服务（false）
	IsOldService *bool `json:"is_old_service,omitempty" xml:"is_old_service"`

	// BCS服务为老服务时，此字段为老服务版本号
	OldServiceVersion *string `json:"old_service_version,omitempty" xml:"old_service_version"`

	// BCS服务用户数据面agent地址端口列表
	AgentPortalAddrs *[]string `json:"agent_portal_addrs,omitempty" xml:"agent_portal_addrs"`
	...
	ProcessStatus *string `json:"process_status,omitempty" xml:"process_status"`

	// BCS服务为包周期模式时，返回值为0（订单未成功）,1（订单异常）,2（订单正常）
	OrderStatus *int64 `json:"order_status,omitempty" xml:"order_status"`
}
