...
type ListOpRecordRequest struct {
	...
	OperationStatus *ListOpRecordRequestOperationStatus `json:"operation_status,omitempty" xml:"operation_status"`
	...
	ResourceType *ListOpRecordRequestResourceType `json:"resource_type,omitempty" xml:"resource_type"`
	...
	OperationType *ListOpRecordRequestOperationType `json:"operation_type,omitempty" xml:"operation_type"`
