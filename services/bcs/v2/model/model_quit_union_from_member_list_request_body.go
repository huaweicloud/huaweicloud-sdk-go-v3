...
type QuitUnionFromMemberListRequestBody struct {
	...
	InviterBcsid string `json:"inviter_bcsid" xml:"inviter_bcsid"`

	// 邀请方项目ID。控制台->邀请方账号->我的凭证->API凭证->项目列表，选择对应的项目ID
	InviterProjectid string `json:"inviter_projectid" xml:"inviter_projectid"`

	// 邀请方租户ID。控制台->邀请方账号->我的凭证->API凭证->账号ID
	InviterDomainid string `json:"inviter_domainid" xml:"inviter_domainid"`

	// 邀请方租户名称。控制台->邀请方账号->我的凭证->API凭证->账号名
	InviterUsername string `json:"inviter_username" xml:"inviter_username"`
	...
	InviteeBcsid string `json:"invitee_bcsid" xml:"invitee_bcsid"`

	// 被邀请方项目ID。控制台->被邀请方账号->我的凭证->API凭证->项目列表，选择对应的项目ID
	InviteeProjectid string `json:"invitee_projectid" xml:"invitee_projectid"`

	// 被邀请方租户ID。控制台->被邀请方账号->我的凭证->API凭证->账号ID
	InviteeDomainid string `json:"invitee_domainid" xml:"invitee_domainid"`
}
