...
type EventQueryParam2 struct {
	...
	TimeRange string `json:"time_range" xml:"time_range"`
	...
	Sort *EventQueryParam2Sort `json:"sort,omitempty" xml:"sort"`

	// 查询条件组合，可以为空。
	MetadataRelation *[]RelationModel `json:"metadata_relation,omitempty" xml:"metadata_relation"`
}
