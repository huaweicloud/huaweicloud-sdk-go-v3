...
type EventModel struct {
	...
	StartsAt *int64 `json:"starts_at,omitempty" xml:"starts_at"`

	// 事件或者告警清除的时间，CST毫秒级时间戳，为0时表示未删除。
	EndsAt *int64 `json:"ends_at,omitempty" xml:"ends_at"`

	// 告警自动清除时间。毫秒数，例如一分钟则填写为60000。默认清除时间为3天,对应数字为 4320 * 1000（即：3天 * 24小时 * 60分钟 * 1000毫秒）。
	Timeout *int64 `json:"timeout,omitempty" xml:"timeout"`
	...
	// 事件或者告警预留字段，为空。
	AttachRule *interface{} `json:"attach_rule,omitempty" xml:"attach_rule"`
