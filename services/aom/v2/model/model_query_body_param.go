...
type QueryBodyParam struct {
	...
	HideSyslog *int32 `json:"hideSyslog,omitempty" xml:"hideSyslog"`
	...
	LineNum *string `json:"lineNum,omitempty" xml:"lineNum"`

	// 表示每次查询的日志条数不填时默认为5000，建议您设置为100。 第一次查询时使用pageSize 后续分页查询时使用size。
	PageSizeSize *string `json:"pageSize/size,omitempty" xml:"pageSize/size"`

	SearchKey *SearchKey `json:"searchKey" xml:"searchKey"`
	...
	IsDesc *bool `json:"isDesc,omitempty" xml:"isDesc"`
}
