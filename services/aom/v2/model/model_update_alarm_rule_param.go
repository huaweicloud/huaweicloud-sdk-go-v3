...
type UpdateAlarmRuleParam struct {
	...
	AlarmLevel *UpdateAlarmRuleParamAlarmLevel `json:"alarm_level,omitempty" xml:"alarm_level"`
	...
	// 统计方式。
	Statistic *UpdateAlarmRuleParamStatistic `json:"statistic,omitempty" xml:"statistic"`
