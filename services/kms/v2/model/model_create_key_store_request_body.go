...
type CreateKeyStoreRequestBody struct {
	...
	KeystoreAlias string `json:"keystore_alias" xml:"keystore_alias"`

	// DHSM集群Id，要求集群当前未创建专属密钥库。
	HsmClusterId string `json:"hsm_cluster_id" xml:"hsm_cluster_id"`

	// DHSM集群的CA证书
	HsmCaCert string `json:"hsm_ca_cert" xml:"hsm_ca_cert"`
}
