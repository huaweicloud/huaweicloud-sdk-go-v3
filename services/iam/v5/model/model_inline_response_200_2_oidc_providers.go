...
type InlineResponse2002OidcProviders struct {
...
func (o InlineResponse2002OidcProviders) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "InlineResponse2002OidcProviders struct{}"
	}

	return strings.Join([]string{"InlineResponse2002OidcProviders", string(data)}, " ")
}
