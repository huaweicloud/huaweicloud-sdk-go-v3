...
// InlineResponse2011OidcProvider **参数解释**： OIDC 提供商。  **取值范围**： 不涉及。
type InlineResponse2011OidcProvider struct {
...
func (o InlineResponse2011OidcProvider) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "InlineResponse2011OidcProvider struct{}"
	}

	return strings.Join([]string{"InlineResponse2011OidcProvider", string(data)}, " ")
}
