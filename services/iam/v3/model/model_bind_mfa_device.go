...
type BindMfaDevice struct {
	...
	// 第一组验证码。
	AuthenticationCodeFirst string `json:"authentication_code_first" xml:"authentication_code_first"`

	// 第二组验证码。
	AuthenticationCodeSecond string `json:"authentication_code_second" xml:"authentication_code_second"`
}
