...
type ShowDomainRoleAssignmentsRequest struct {
	...
	// 策略ID。
	RoleId *string `json:"role_id,omitempty" xml:"role_id"`
	...
	// 授权的IAM用户ID。
	SubjectUserId *string `json:"subject.user_id,omitempty" xml:"subject.user_id"`

	// 授权的用户组ID。
	SubjectGroupId *string `json:"subject.group_id,omitempty" xml:"subject.group_id"`

	// 授权的委托ID。
	SubjectAgencyId *string `json:"subject.agency_id,omitempty" xml:"subject.agency_id"`
	...
	// 授权的项目ID。
	ScopeProjectId *string `json:"scope.project_id,omitempty" xml:"scope.project_id"`

	// 待查询账号ID。
	ScopeDomainId *string `json:"scope.domain_id,omitempty" xml:"scope.domain_id"`

	// 授权的企业项目ID。
	ScopeEnterpriseProjectsId *string `json:"scope.enterprise_projects_id,omitempty" xml:"scope.enterprise_projects_id"`
	...
	IncludeGroup *bool `json:"include_group,omitempty" xml:"include_group"`

	// 分页查询时数据的页数，查询值最小为1。需要与per_page同时存在。
	Page *string `json:"page,omitempty" xml:"page"`

	// 分页查询时每页的数据个数，取值范围为[1,50]。需要与page同时存在。
	PerPage *string `json:"per_page,omitempty" xml:"per_page"`
}
