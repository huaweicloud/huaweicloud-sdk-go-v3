...
type LoginToken struct {
	...
	// 自定义代理用户ID。
	SessionUserId *string `json:"session_user_id,omitempty" xml:"session_user_id"`
	...
	SessionName *string `json:"session_name,omitempty" xml:"session_name"`

	AssumedBy *LoginTokenAssumedBy `json:"assumed_by,omitempty" xml:"assumed_by"`
}
