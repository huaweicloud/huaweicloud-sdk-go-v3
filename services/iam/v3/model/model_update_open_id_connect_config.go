...
type UpdateOpenIdConnectConfig struct {
	...
	AccessMode *string `json:"access_mode,omitempty" xml:"access_mode"`

	// OpenID Connect身份提供商标识，对应ID token 中 iss
	IdpUrl *string `json:"idp_url,omitempty" xml:"idp_url"`
	...
	ResponseType *UpdateOpenIdConnectConfigResponseType `json:"response_type,omitempty" xml:"response_type"`

	// 授权请求返回方式，可选值 form_post 或 fragment ；编程访问和管理控制台访问方式值为可选值，编程访问方式值可为空
	ResponseMode *UpdateOpenIdConnectConfigResponseMode `json:"response_mode,omitempty" xml:"response_mode"`

	// OpenID Connect身份提供商ID Token签名的公钥
	SigningKey *string `json:"signing_key,omitempty" xml:"signing_key"`
}
