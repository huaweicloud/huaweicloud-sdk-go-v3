...
func (o AgencyShowResult) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AgencyShowResult struct{}"
	}

	return strings.Join([]string{"AgencyShowResult", string(data)}, " ")
}
