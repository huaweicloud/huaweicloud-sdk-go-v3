...
type CreateUserResult struct {
	...
	// IAM用户是否为账号管理员。
	IsDomainOwner *bool `json:"is_domain_owner,omitempty" xml:"is_domain_owner"`
	...
	// 运营主体的客户编码。
	XdomainId *string `json:"xdomain_id,omitempty" xml:"xdomain_id"`

	// 运营主体。
	XdomainType *string `json:"xdomain_type,omitempty" xml:"xdomain_type"`
