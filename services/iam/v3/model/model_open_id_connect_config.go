...
type OpenIdConnectConfig struct {
	...
	ResponseType OpenIdConnectConfigResponseType `json:"response_type" xml:"response_type"`

	// 授权请求返回方式， form_post 或 fragment ；编程访问和管理控制台访问方式值不为空，编程访问方式值可为空
	ResponseMode OpenIdConnectConfigResponseMode `json:"response_mode" xml:"response_mode"`
