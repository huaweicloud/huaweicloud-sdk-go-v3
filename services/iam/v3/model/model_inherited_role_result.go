...
// InheritedRoleResult
type InheritedRoleResult struct {
...
func (o InheritedRoleResult) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "InheritedRoleResult struct{}"
	}

	return strings.Join([]string{"InheritedRoleResult", string(data)}, " ")
}
