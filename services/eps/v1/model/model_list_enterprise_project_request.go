...
type ListEnterpriseProjectRequest struct {
	...
	SortDir *ListEnterpriseProjectRequestSortDir `json:"sort_dir,omitempty" xml:"sort_dir"`

	// 返回结果按该关键字排序（支持updated_at等关键字，默认为“created_at”）
	SortKey *ListEnterpriseProjectRequestSortKey `json:"sort_key,omitempty" xml:"sort_key"`
