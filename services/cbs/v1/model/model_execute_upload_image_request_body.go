...
func (o ExecuteUploadImageRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExecuteUploadImageRequestBody struct{}"
	}

	return strings.Join([]string{"ExecuteUploadImageRequestBody", string(data)}, " ")
}
