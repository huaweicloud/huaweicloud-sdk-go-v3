...
func GenReqDefForListByoipPools() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/byoip-pools").
		WithResponse(new(model.ListByoipPoolsResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteLogtank() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v1/logtanks/{logtank_id}").
...
func GenReqDefForListAllPops() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/pops").
		WithResponse(new(model.ListAllPopsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListTenantQuotas() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{domain_id}/ga/quotas").
		WithResponse(new(model.ListTenantQuotasResponse)).
		WithContentType("application/json")
