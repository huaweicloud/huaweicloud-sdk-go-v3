...
func (o ServerResourceSpec) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ServerResourceSpec struct{}"
	}

	return strings.Join([]string{"ServerResourceSpec", string(data)}, " ")
}
