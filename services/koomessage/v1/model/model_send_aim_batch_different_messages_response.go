...
func (o SendAimBatchDifferentMessagesResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SendAimBatchDifferentMessagesResponse struct{}"
	}

	return strings.Join([]string{"SendAimBatchDifferentMessagesResponse", string(data)}, " ")
}
