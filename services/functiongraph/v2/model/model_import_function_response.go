...
type ImportFunctionResponse struct {
	...
	Runtime *ImportFunctionResponseRuntime `json:"runtime,omitempty" xml:"runtime"`
	...
	CodeType *ImportFunctionResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
