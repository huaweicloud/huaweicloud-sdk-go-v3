...
type ShowFunctionCodeResponse struct {
	...
	Runtime *ShowFunctionCodeResponseRuntime `json:"runtime,omitempty" xml:"runtime"`

	// 函数代码类型，取值有4种。 inline: UI在线编辑代码。 zip: 函数代码为zip包。 obs: 函数代码来源于obs存储。 jar: 函数代码为jar包，主要针对Java函数。
	CodeType *ShowFunctionCodeResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
