...
type UpdateFunctionConfigResponse struct {
	...
	Runtime *UpdateFunctionConfigResponseRuntime `json:"runtime,omitempty" xml:"runtime"`
	...
	CodeType *UpdateFunctionConfigResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
	...
	// v2表示为公测版本,v1为原来版本。
	Type *UpdateFunctionConfigResponseType `json:"type,omitempty" xml:"type"`
