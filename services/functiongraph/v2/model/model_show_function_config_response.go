...
type ShowFunctionConfigResponse struct {
	...
	// 函数名称。
	FuncName *string `json:"func_name,omitempty" xml:"func_name"`
	...
	Runtime *ShowFunctionConfigResponseRuntime `json:"runtime,omitempty" xml:"runtime"`
	...
	MemorySize *int32 `json:"memory_size,omitempty" xml:"memory_size"`
	...
	CodeType *ShowFunctionConfigResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
	...
	// 函数大小，单位：字节。
	CodeSize *int64 `json:"code_size,omitempty" xml:"code_size"`
	...
	// 依赖id列表
	DependList *[]string `json:"depend_list,omitempty" xml:"depend_list"`

	StrategyConfig *StrategyConfig `json:"strategy_config,omitempty" xml:"strategy_config"`

	// 函数依赖代码包列表。
	Dependencies *[]Dependency `json:"dependencies,omitempty" xml:"dependencies"`
	...
	// v2表示为公测版本,v1为原来版本。
	Type *ShowFunctionConfigResponseType `json:"type,omitempty" xml:"type"`
