...
type CreateFunctionVersionResponse struct {
	...
	Runtime *CreateFunctionVersionResponseRuntime `json:"runtime,omitempty" xml:"runtime"`
	...
	CodeType *CreateFunctionVersionResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
	...
	// 函数版本描述。
	VersionDescription *string `json:"version_description,omitempty" xml:"version_description"`
	...
	// v2表示为公测版本,v1为原来版本。
	Type *CreateFunctionVersionResponseType `json:"type,omitempty" xml:"type"`
