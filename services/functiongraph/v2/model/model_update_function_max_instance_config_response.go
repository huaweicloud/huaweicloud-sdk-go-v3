...
type UpdateFunctionMaxInstanceConfigResponse struct {
	...
	Runtime *UpdateFunctionMaxInstanceConfigResponseRuntime `json:"runtime,omitempty" xml:"runtime"`
	...
	CodeType *UpdateFunctionMaxInstanceConfigResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
	...
	// v2表示为公测版本,v1为原来版本。
	Type *UpdateFunctionMaxInstanceConfigResponseType `json:"type,omitempty" xml:"type"`
