...
type ListFunctionResult struct {
	...
	Runtime ListFunctionResultRuntime `json:"runtime" xml:"runtime"`
	...
	CodeType ListFunctionResultCodeType `json:"code_type" xml:"code_type"`
	...
	// v2表示为公测版本,v1为原来版本。
	Type *ListFunctionResultType `json:"type,omitempty" xml:"type"`
