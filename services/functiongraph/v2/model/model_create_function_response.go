...
type CreateFunctionResponse struct {
	...
	Runtime *CreateFunctionResponseRuntime `json:"runtime,omitempty" xml:"runtime"`
	...
	CodeType *CreateFunctionResponseCodeType `json:"code_type,omitempty" xml:"code_type"`
