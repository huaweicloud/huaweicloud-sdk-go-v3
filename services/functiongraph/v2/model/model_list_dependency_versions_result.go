...
type ListDependencyVersionsResult struct {
...
func (o ListDependencyVersionsResult) String() string {
	...
	if err != nil {
		return "ListDependencyVersionsResult struct{}"
	}

	return strings.Join([]string{"ListDependencyVersionsResult", string(data)}, " ")
}
...
type ListDependencyVersionsResultRuntimeEnum struct {
	...
	PHP8_3          ListDependencyVersionsResultRuntime
...
func GetListDependencyVersionsResultRuntimeEnum() ListDependencyVersionsResultRuntimeEnum {
	return ListDependencyVersionsResultRuntimeEnum{
		JAVA8: ListDependencyVersionsResultRuntime{
			value: "Java8",
		},
		JAVA11: ListDependencyVersionsResultRuntime{
