...
// ListGroupAliResourceRelationsRequest Request Object
type ListGroupAliResourceRelationsRequest struct {
...
func (o ListGroupAliResourceRelationsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListGroupAliResourceRelationsRequest struct{}"
	}

	return strings.Join([]string{"ListGroupAliResourceRelationsRequest", string(data)}, " ")
}
