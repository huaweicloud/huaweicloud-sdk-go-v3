...
func (o ExecutePublicScriptRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExecutePublicScriptRequest struct{}"
	}

	return strings.Join([]string{"ExecutePublicScriptRequest", string(data)}, " ")
}
