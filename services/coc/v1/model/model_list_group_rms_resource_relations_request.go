...
// ListGroupRmsResourceRelationsRequest Request Object
type ListGroupRmsResourceRelationsRequest struct {
...
func (o ListGroupRmsResourceRelationsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListGroupRmsResourceRelationsRequest struct{}"
	}

	return strings.Join([]string{"ListGroupRmsResourceRelationsRequest", string(data)}, " ")
}
