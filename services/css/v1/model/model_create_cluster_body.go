...
type CreateClusterBody struct {
	Instance *CreateClusterInstanceBody `json:"instance" xml:"instance"`
	...
	// 集群实例个数，取值范围为1~32。
	InstanceNum int32 `json:"instanceNum" xml:"instanceNum"`
	...
	PayInfo *PayInfoBody `json:"payInfo,omitempty" xml:"payInfo"`
}
