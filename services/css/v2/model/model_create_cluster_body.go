...
type CreateClusterBody struct {
	...
	BackupStrategy *CreateClusterBackupStrategyBody `json:"backupStrategy,omitempty" xml:"backupStrategy"`

	Roles []CreateClusterRolesBody `json:"roles" xml:"roles"`

	Nics *CreateClusterInstanceNicsBody `json:"nics" xml:"nics"`
	...
	Tags *[]CreateClusterTagsBody `json:"tags,omitempty" xml:"tags"`

	// 可用区。
	AvailabilityZone *string `json:"availability_zone,omitempty" xml:"availability_zone"`

	Datastore *CreateClusterDatastoreBody `json:"datastore" xml:"datastore"`
	...
	AdminPwd *string `json:"adminPwd,omitempty" xml:"adminPwd"`

	PublicIPReq *CreateClusterPublicIpReq `json:"publicIPReq,omitempty" xml:"publicIPReq"`

	LoadBalance *CreateClusterLoadBalance `json:"loadBalance,omitempty" xml:"loadBalance"`

	PublicKibanaReq *CreateClusterPublicKibanaReq `json:"publicKibanaReq,omitempty" xml:"publicKibanaReq"`
}
