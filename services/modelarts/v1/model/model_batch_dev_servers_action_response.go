...
// BatchDevServersActionResponse Response Object
type BatchDevServersActionResponse struct {
...
func (o BatchDevServersActionResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchDevServersActionResponse struct{}"
	}

	return strings.Join([]string{"BatchDevServersActionResponse", string(data)}, " ")
}
