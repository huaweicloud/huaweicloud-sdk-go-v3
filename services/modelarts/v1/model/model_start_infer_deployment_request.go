...
// StartInferDeploymentRequest Request Object
type StartInferDeploymentRequest struct {
...
func (o StartInferDeploymentRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "StartInferDeploymentRequest struct{}"
	}

	return strings.Join([]string{"StartInferDeploymentRequest", string(data)}, " ")
}
