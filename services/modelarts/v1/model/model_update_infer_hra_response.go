...
// UpdateInferHraResponse Response Object
type UpdateInferHraResponse struct {
...
func (o UpdateInferHraResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferHraResponse struct{}"
	}

	return strings.Join([]string{"UpdateInferHraResponse", string(data)}, " ")
}
