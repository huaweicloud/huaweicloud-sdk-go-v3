...
// UnbindInferApiKeyResponse Response Object
type UnbindInferApiKeyResponse struct {
...
func (o UnbindInferApiKeyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UnbindInferApiKeyResponse struct{}"
	}

	return strings.Join([]string{"UnbindInferApiKeyResponse", string(data)}, " ")
}
