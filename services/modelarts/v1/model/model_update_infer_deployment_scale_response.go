...
// UpdateInferDeploymentScaleResponse Response Object
type UpdateInferDeploymentScaleResponse struct {
...
func (o UpdateInferDeploymentScaleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferDeploymentScaleResponse struct{}"
	}

	return strings.Join([]string{"UpdateInferDeploymentScaleResponse", string(data)}, " ")
}
