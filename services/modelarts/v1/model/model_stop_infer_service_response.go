...
// StopInferServiceResponse Response Object
type StopInferServiceResponse struct {
...
func (o StopInferServiceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "StopInferServiceResponse struct{}"
	}

	return strings.Join([]string{"StopInferServiceResponse", string(data)}, " ")
}
