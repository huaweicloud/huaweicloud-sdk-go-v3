...
// CreateSaveImageJobResponse Response Object
type CreateSaveImageJobResponse struct {
...
func (o CreateSaveImageJobResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateSaveImageJobResponse struct{}"
	}

	return strings.Join([]string{"CreateSaveImageJobResponse", string(data)}, " ")
}
