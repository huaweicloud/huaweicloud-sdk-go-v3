...
// ShowTrainingJobDetailsResponse Response Object
type ShowTrainingJobDetailsResponse struct {
...
func (o ShowTrainingJobDetailsResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowTrainingJobDetailsResponse struct{}"
	}

	return strings.Join([]string{"ShowTrainingJobDetailsResponse", string(data)}, " ")
}
