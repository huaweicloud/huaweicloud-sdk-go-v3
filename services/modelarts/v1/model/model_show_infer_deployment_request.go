...
// ShowInferDeploymentRequest Request Object
type ShowInferDeploymentRequest struct {
...
func (o ShowInferDeploymentRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowInferDeploymentRequest struct{}"
	}

	return strings.Join([]string{"ShowInferDeploymentRequest", string(data)}, " ")
}
