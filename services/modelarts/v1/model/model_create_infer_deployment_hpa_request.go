...
// CreateInferDeploymentHpaRequest Request Object
type CreateInferDeploymentHpaRequest struct {
	...
	Body *CreateHpaRequestBody `json:"body,omitempty"`
}

func (o CreateInferDeploymentHpaRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateInferDeploymentHpaRequest struct{}"
	}

	return strings.Join([]string{"CreateInferDeploymentHpaRequest", string(data)}, " ")
}
