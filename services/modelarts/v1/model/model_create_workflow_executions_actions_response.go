...
// CreateWorkflowExecutionsActionsResponse Response Object
type CreateWorkflowExecutionsActionsResponse struct {
...
func (o CreateWorkflowExecutionsActionsResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateWorkflowExecutionsActionsResponse struct{}"
	}

	return strings.Join([]string{"CreateWorkflowExecutionsActionsResponse", string(data)}, " ")
}
