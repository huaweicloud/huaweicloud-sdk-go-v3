...
// UpdateInferDeploymentHpaRequest Request Object
type UpdateInferDeploymentHpaRequest struct {
	...
	Body *UpdateHpaRequestBody `json:"body,omitempty"`
}

func (o UpdateInferDeploymentHpaRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferDeploymentHpaRequest struct{}"
	}

	return strings.Join([]string{"UpdateInferDeploymentHpaRequest", string(data)}, " ")
}
