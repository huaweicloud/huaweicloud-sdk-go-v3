...
// ShowInferHraRequest Request Object
type ShowInferHraRequest struct {
...
func (o ShowInferHraRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowInferHraRequest struct{}"
	}

	return strings.Join([]string{"ShowInferHraRequest", string(data)}, " ")
}
