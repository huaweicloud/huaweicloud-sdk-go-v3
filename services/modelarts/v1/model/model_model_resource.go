...
// ModelResource **参数解释：** 模型&权重文件存储挂载配置。 **约束限制：** 不涉及。
...
func (o ModelResource) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ModelResource struct{}"
	}

	return strings.Join([]string{"ModelResource", string(data)}, " ")
}
