...
// UnbindInferApiKeyRequest Request Object
type UnbindInferApiKeyRequest struct {
...
func (o UnbindInferApiKeyRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UnbindInferApiKeyRequest struct{}"
	}

	return strings.Join([]string{"UnbindInferApiKeyRequest", string(data)}, " ")
}
