...
// DeleteInferDeploymentPodRequest Request Object
type DeleteInferDeploymentPodRequest struct {
...
func (o DeleteInferDeploymentPodRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteInferDeploymentPodRequest struct{}"
	}

	return strings.Join([]string{"DeleteInferDeploymentPodRequest", string(data)}, " ")
}
