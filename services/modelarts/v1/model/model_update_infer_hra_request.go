...
// UpdateInferHraRequest Request Object
type UpdateInferHraRequest struct {
	...
	Body *UpdateHraRequestBody `json:"body,omitempty"`
}

func (o UpdateInferHraRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferHraRequest struct{}"
	}

	return strings.Join([]string{"UpdateInferHraRequest", string(data)}, " ")
}
