...
// UpdateInferDeploymentRequest Request Object
type UpdateInferDeploymentRequest struct {
	...
	Body *GroupConfigUpdateRequest `json:"body,omitempty"`
}

func (o UpdateInferDeploymentRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferDeploymentRequest struct{}"
	}

	return strings.Join([]string{"UpdateInferDeploymentRequest", string(data)}, " ")
}
