...
// UpdateInferServiceResponse Response Object
type UpdateInferServiceResponse struct {
...
func (o UpdateInferServiceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferServiceResponse struct{}"
	}

	return strings.Join([]string{"UpdateInferServiceResponse", string(data)}, " ")
}
