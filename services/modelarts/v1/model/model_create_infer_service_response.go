...
// CreateInferServiceResponse Response Object
type CreateInferServiceResponse struct {
...
func (o CreateInferServiceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateInferServiceResponse struct{}"
	}

	return strings.Join([]string{"CreateInferServiceResponse", string(data)}, " ")
}
