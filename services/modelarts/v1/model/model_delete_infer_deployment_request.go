...
// DeleteInferDeploymentRequest Request Object
type DeleteInferDeploymentRequest struct {
...
func (o DeleteInferDeploymentRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteInferDeploymentRequest struct{}"
	}

	return strings.Join([]string{"DeleteInferDeploymentRequest", string(data)}, " ")
}
