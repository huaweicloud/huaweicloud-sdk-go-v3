...
// DeleteInferDeploymentHpaRequest Request Object
type DeleteInferDeploymentHpaRequest struct {
...
func (o DeleteInferDeploymentHpaRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteInferDeploymentHpaRequest struct{}"
	}

	return strings.Join([]string{"DeleteInferDeploymentHpaRequest", string(data)}, " ")
}
