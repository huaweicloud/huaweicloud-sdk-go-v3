...
// ListAllDevServersResponse Response Object
type ListAllDevServersResponse struct {
...
func (o ListAllDevServersResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListAllDevServersResponse struct{}"
	}

	return strings.Join([]string{"ListAllDevServersResponse", string(data)}, " ")
}
