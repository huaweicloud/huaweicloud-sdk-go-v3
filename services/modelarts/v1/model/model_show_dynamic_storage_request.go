...
// ShowDynamicStorageRequest Request Object
type ShowDynamicStorageRequest struct {
...
func (o ShowDynamicStorageRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowDynamicStorageRequest struct{}"
	}

	return strings.Join([]string{"ShowDynamicStorageRequest", string(data)}, " ")
}
