...
// DeleteInferDeploymentResponse Response Object
type DeleteInferDeploymentResponse struct {
...
func (o DeleteInferDeploymentResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteInferDeploymentResponse struct{}"
	}

	return strings.Join([]string{"DeleteInferDeploymentResponse", string(data)}, " ")
}
