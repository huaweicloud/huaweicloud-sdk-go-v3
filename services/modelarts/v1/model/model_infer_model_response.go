...
// InferModelResponse **参数解释：** 模型&权重文件存储挂载配置。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
...
func (o InferModelResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "InferModelResponse struct{}"
	}

	return strings.Join([]string{"InferModelResponse", string(data)}, " ")
}
