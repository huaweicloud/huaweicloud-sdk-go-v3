...
// PatchPoolResponse Response Object
...
func (o PatchPoolResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PatchPoolResponse struct{}"
	}

	return strings.Join([]string{"PatchPoolResponse", string(data)}, " ")
}
