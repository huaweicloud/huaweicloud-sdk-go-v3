...
// StartInferDeploymentResponse Response Object
type StartInferDeploymentResponse struct {
...
func (o StartInferDeploymentResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "StartInferDeploymentResponse struct{}"
	}

	return strings.Join([]string{"StartInferDeploymentResponse", string(data)}, " ")
}
