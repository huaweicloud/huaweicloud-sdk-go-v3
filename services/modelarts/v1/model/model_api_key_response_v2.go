...
// ApiKeyResponseV2 apikey响应信息
type ApiKeyResponseV2 struct {
	...
	Services []ServiceIdName `json:"services"`

	// **参数解释：** 工作空间ID。 **取值范围：** 工作空间ID。
	WorkspaceId string `json:"workspace_id"`
}

func (o ApiKeyResponseV2) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ApiKeyResponseV2 struct{}"
	}

	return strings.Join([]string{"ApiKeyResponseV2", string(data)}, " ")
}
