...
// RequiredAffinity 训练作业亲和要求
type RequiredAffinity struct {
	...
	NodeAffinity *NodeSelector `json:"node_affinity,omitempty"`
}

func (o RequiredAffinity) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RequiredAffinity struct{}"
	}

	return strings.Join([]string{"RequiredAffinity", string(data)}, " ")
}
