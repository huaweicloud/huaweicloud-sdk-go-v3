...
// UpdateInferDeploymentHpaResponse Response Object
type UpdateInferDeploymentHpaResponse struct {
...
func (o UpdateInferDeploymentHpaResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferDeploymentHpaResponse struct{}"
	}

	return strings.Join([]string{"UpdateInferDeploymentHpaResponse", string(data)}, " ")
}
