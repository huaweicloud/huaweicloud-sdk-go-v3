...
// IntranetConnectionInfo 内网接入信息
type IntranetConnectionInfo struct {
	...
	Type *IntranetConnectionInfoType `json:"type,omitempty"`
...
func (o IntranetConnectionInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "IntranetConnectionInfo struct{}"
	}

	return strings.Join([]string{"IntranetConnectionInfo", string(data)}, " ")
}

type IntranetConnectionInfoType struct {
	value string
}

type IntranetConnectionInfoTypeEnum struct {
	SERVICE IntranetConnectionInfoType
	GLOBAL  IntranetConnectionInfoType
}

func GetIntranetConnectionInfoTypeEnum() IntranetConnectionInfoTypeEnum {
	return IntranetConnectionInfoTypeEnum{
		SERVICE: IntranetConnectionInfoType{
			value: "SERVICE",
		},
		GLOBAL: IntranetConnectionInfoType{
...
func (c IntranetConnectionInfoType) Value() string {
	return c.value
}

func (c IntranetConnectionInfoType) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *IntranetConnectionInfoType) UnmarshalJSON(b []byte) error {
