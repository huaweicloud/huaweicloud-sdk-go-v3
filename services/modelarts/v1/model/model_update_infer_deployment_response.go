...
// UpdateInferDeploymentResponse Response Object
type UpdateInferDeploymentResponse struct {
...
func (o UpdateInferDeploymentResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInferDeploymentResponse struct{}"
	}

	return strings.Join([]string{"UpdateInferDeploymentResponse", string(data)}, " ")
}
