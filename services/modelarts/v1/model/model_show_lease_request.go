...
// ShowLeaseRequest Request Object
type ShowLeaseRequest struct {
...
func (o ShowLeaseRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowLeaseRequest struct{}"
	}

	return strings.Join([]string{"ShowLeaseRequest", string(data)}, " ")
}
