...
// StopTrainingJobResponse Response Object
...
func (o StopTrainingJobResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "StopTrainingJobResponse struct{}"
	}

	return strings.Join([]string{"StopTrainingJobResponse", string(data)}, " ")
}
