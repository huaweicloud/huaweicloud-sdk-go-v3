...
// ShowInferDeploymentResponse Response Object
type ShowInferDeploymentResponse struct {
...
func (o ShowInferDeploymentResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowInferDeploymentResponse struct{}"
	}

	return strings.Join([]string{"ShowInferDeploymentResponse", string(data)}, " ")
}
