...
// UpdateWorkflowExecutionResponse Response Object
...
func (o UpdateWorkflowExecutionResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateWorkflowExecutionResponse struct{}"
	}

	return strings.Join([]string{"UpdateWorkflowExecutionResponse", string(data)}, " ")
}
