...
// CreateDevServerJobResponse Response Object
type CreateDevServerJobResponse struct {
...
func (o CreateDevServerJobResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateDevServerJobResponse struct{}"
	}

	return strings.Join([]string{"CreateDevServerJobResponse", string(data)}, " ")
}
