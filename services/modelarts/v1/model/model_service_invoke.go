...
// ServiceInvoke **参数解释：** 服务调用时的相关配置。 **约束限制：** 不涉及。
...
func (o ServiceInvoke) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ServiceInvoke struct{}"
	}

	return strings.Join([]string{"ServiceInvoke", string(data)}, " ")
}
