...
// BindInferApiKeyResponse Response Object
type BindInferApiKeyResponse struct {
...
func (o BindInferApiKeyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BindInferApiKeyResponse struct{}"
	}

	return strings.Join([]string{"BindInferApiKeyResponse", string(data)}, " ")
}
