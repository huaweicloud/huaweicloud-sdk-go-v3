...
// StartInferServiceResponse Response Object
type StartInferServiceResponse struct {
...
func (o StartInferServiceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "StartInferServiceResponse struct{}"
	}

	return strings.Join([]string{"StartInferServiceResponse", string(data)}, " ")
}
