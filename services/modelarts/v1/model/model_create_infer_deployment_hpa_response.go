...
// CreateInferDeploymentHpaResponse Response Object
type CreateInferDeploymentHpaResponse struct {
...
func (o CreateInferDeploymentHpaResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateInferDeploymentHpaResponse struct{}"
	}

	return strings.Join([]string{"CreateInferDeploymentHpaResponse", string(data)}, " ")
}
