...
// DeleteInferDeploymentHpaResponse Response Object
type DeleteInferDeploymentHpaResponse struct {
...
func (o DeleteInferDeploymentHpaResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteInferDeploymentHpaResponse struct{}"
	}

	return strings.Join([]string{"DeleteInferDeploymentHpaResponse", string(data)}, " ")
}
