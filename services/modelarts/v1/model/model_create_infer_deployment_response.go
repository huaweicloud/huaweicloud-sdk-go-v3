...
// CreateInferDeploymentResponse Response Object
type CreateInferDeploymentResponse struct {
...
func (o CreateInferDeploymentResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateInferDeploymentResponse struct{}"
	}

	return strings.Join([]string{"CreateInferDeploymentResponse", string(data)}, " ")
}
