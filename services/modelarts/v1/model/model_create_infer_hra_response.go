...
// CreateInferHraResponse Response Object
type CreateInferHraResponse struct {
...
func (o CreateInferHraResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateInferHraResponse struct{}"
	}

	return strings.Join([]string{"CreateInferHraResponse", string(data)}, " ")
}
