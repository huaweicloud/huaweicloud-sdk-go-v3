...
// HealthResponse **参数解释：** 健康检查配置。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
...
func (o HealthResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "HealthResponse struct{}"
	}

	return strings.Join([]string{"HealthResponse", string(data)}, " ")
}
