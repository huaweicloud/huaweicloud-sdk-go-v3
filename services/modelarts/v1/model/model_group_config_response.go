...
// GroupConfigResponse **参数解释：** 服务部署配置。
...
func (o GroupConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "GroupConfigResponse struct{}"
	}

	return strings.Join([]string{"GroupConfigResponse", string(data)}, " ")
}
