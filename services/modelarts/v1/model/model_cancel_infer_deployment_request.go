...
// CancelInferDeploymentRequest Request Object
type CancelInferDeploymentRequest struct {
...
func (o CancelInferDeploymentRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CancelInferDeploymentRequest struct{}"
	}

	return strings.Join([]string{"CancelInferDeploymentRequest", string(data)}, " ")
}
