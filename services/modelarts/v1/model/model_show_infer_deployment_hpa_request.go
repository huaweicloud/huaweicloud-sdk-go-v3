...
// ShowInferDeploymentHpaRequest Request Object
type ShowInferDeploymentHpaRequest struct {
...
func (o ShowInferDeploymentHpaRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowInferDeploymentHpaRequest struct{}"
	}

	return strings.Join([]string{"ShowInferDeploymentHpaRequest", string(data)}, " ")
}
