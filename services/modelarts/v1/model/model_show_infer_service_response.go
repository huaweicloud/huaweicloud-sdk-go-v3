...
// ShowInferServiceResponse Response Object
type ShowInferServiceResponse struct {
...
func (o ShowInferServiceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowInferServiceResponse struct{}"
	}

	return strings.Join([]string{"ShowInferServiceResponse", string(data)}, " ")
}
