...
var provider = region.DefaultProviderChain("DLF")
...
func ValueOf(regionId string) *region.Region {
	...
	panic(fmt.Sprintf("region id '%s' is not in the following supported regions of service 'DLF': [%s]", regionId, strings.Join(getRegionIds(), ", ")))
}
