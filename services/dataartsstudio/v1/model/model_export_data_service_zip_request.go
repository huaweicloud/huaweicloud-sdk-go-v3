...
func (o ExportDataServiceZipRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExportDataServiceZipRequest struct{}"
	}

	return strings.Join([]string{"ExportDataServiceZipRequest", string(data)}, " ")
}
...
func GetExportDataServiceZipRequestDlmTypeEnum() ExportDataServiceZipRequestDlmTypeEnum {
	return ExportDataServiceZipRequestDlmTypeEnum{
		SHARED: ExportDataServiceZipRequestDlmType{
			value: "SHARED",
		},
		EXCLUSIVE: ExportDataServiceZipRequestDlmType{
...
func (c ExportDataServiceZipRequestDlmType) Value() string {
	return c.value
}
