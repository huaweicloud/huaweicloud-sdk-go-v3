...
func (o DynamicMaskingPolicyUpdateDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DynamicMaskingPolicyUpdateDto struct{}"
	}

	return strings.Join([]string{"DynamicMaskingPolicyUpdateDto", string(data)}, " ")
}
...
type DynamicMaskingPolicyUpdateDtoDatasourceTypeEnum struct {
	HIVE DynamicMaskingPolicyUpdateDtoDatasourceType
	DWS  DynamicMaskingPolicyUpdateDtoDatasourceType
	DLI  DynamicMaskingPolicyUpdateDtoDatasourceType
}

func GetDynamicMaskingPolicyUpdateDtoDatasourceTypeEnum() DynamicMaskingPolicyUpdateDtoDatasourceTypeEnum {
	return DynamicMaskingPolicyUpdateDtoDatasourceTypeEnum{
		HIVE: DynamicMaskingPolicyUpdateDtoDatasourceType{
			value: "HIVE",
		},
		DWS: DynamicMaskingPolicyUpdateDtoDatasourceType{
...
func (c DynamicMaskingPolicyUpdateDtoDatasourceType) Value() string {
	return c.value
}

func (c DynamicMaskingPolicyUpdateDtoDatasourceType) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *DynamicMaskingPolicyUpdateDtoDatasourceType) UnmarshalJSON(b []byte) error {
