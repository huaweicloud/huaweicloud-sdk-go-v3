...
type Event struct {
	...
	DataSource *DataSource `json:"data_source" xml:"data_source"`

	// 首次发现时间，格式ISO8601：YYYY-MM-DDTHH:mm:ss.ms+timezone。时区信息为事件发生时区，无法解析时区的时间，默认时区填东八区。
	FirstObservedTime string `json:"first_observed_time" xml:"first_observed_time"`

	// 最新发现时间，格式ISO8601：YYYY-MM-DDTHH:mm:ss.ms+timezone。时区信息为事件发生时区，无法解析时区的时间，默认时区填东八区。
	LastObservedTime *string `json:"last_observed_time,omitempty" xml:"last_observed_time"`
	...
	ArriveTime *string `json:"arrive_time,omitempty" xml:"arrive_time"`
	...
	SourceUrl *string `json:"source_url,omitempty" xml:"source_url"`
	...
	Criticality *int32 `json:"criticality,omitempty" xml:"criticality"`

	Type *Type `json:"type" xml:"type"`

	Compliance *Compliance `json:"compliance,omitempty" xml:"compliance"`

	Network *Network `json:"network,omitempty" xml:"network"`

	VulnerabilityPatch *VulnerabilityPatch `json:"vulnerability_patch,omitempty" xml:"vulnerability_patch"`

	Malware *Malware `json:"malware,omitempty" xml:"malware"`

	ThreatIntel *ThreatIntel `json:"threat_intel,omitempty" xml:"threat_intel"`

	Resource *Resource `json:"resource" xml:"resource"`

	Remediation *Remediation `json:"remediation,omitempty" xml:"remediation"`
	...
	DataSourceFields *interface{} `json:"data_source_fields,omitempty" xml:"data_source_fields"`

	// 事件验证状态，标识事件的准确性。 Unknown – 未知，默认 True_positive – 确认 False_positive – 误报。
	VerificationState *string `json:"verification_state,omitempty" xml:"verification_state"`

	// 事件处理状态，New/Ignored/Resolved；默认New。
	HandleStatus string `json:"handle_status" xml:"handle_status"`
	...
	// 约束闭环时间：单位：天。
	Sla *int32 `json:"sla,omitempty" xml:"sla"`
}
