...
type CreateQueueReq struct {
	...
	QueueMode *CreateQueueReqQueueMode `json:"queue_mode,omitempty" xml:"queue_mode"`
	...
	RedrivePolicy *CreateQueueReqRedrivePolicy `json:"redrive_policy,omitempty" xml:"redrive_policy"`
	...
	RetentionHours *int32 `json:"retention_hours,omitempty" xml:"retention_hours"`
}
