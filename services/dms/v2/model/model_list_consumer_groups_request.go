...
type ListConsumerGroupsRequest struct {
	...
	// 是否包含死信信息。默认值为：false
	IncludeDeadletter *bool `json:"include_deadletter,omitempty" xml:"include_deadletter"`

	// 是否查询消费组的详情，默认值为true。  配置为false时，查询的消费组列表不包含消费详情，接口响应速度快。
	IncludeMessagesNum *bool `json:"include_messages_num,omitempty" xml:"include_messages_num"`
	...
	CurrentPage *int32 `json:"current_page,omitempty" xml:"current_page"`
}
