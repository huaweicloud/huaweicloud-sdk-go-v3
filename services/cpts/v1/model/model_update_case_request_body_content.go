...
func (o UpdateCaseRequestBodyContent) String() string {
	data, err := json.Marshal(o)
	if err != nil {
		return "UpdateCaseRequestBodyContent struct{}"
	}

	return strings.Join([]string{"UpdateCaseRequestBodyContent", string(data)}, " ")
}
