...
type ReportdetailsInfoDetailDatas struct {
	// averageRespTime
...
func (o ReportdetailsInfoDetailDatas) String() string {
	data, err := json.Marshal(o)
	if err != nil {
		return "ReportdetailsInfoDetailDatas struct{}"
	}

	return strings.Join([]string{"ReportdetailsInfoDetailDatas", string(data)}, " ")
}
