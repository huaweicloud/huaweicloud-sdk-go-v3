...
type CreateFaceSetReq struct {
	...
	ExternalFields map[string]TypeInfo `json:"external_fields,omitempty" xml:"external_fields"`
	...
	FaceSetCapacity *int32 `json:"face_set_capacity,omitempty" xml:"face_set_capacity"`
}
