...
type FaceSetInfo struct {
	...
	// 人脸库当中的人脸数量。
	FaceNumber int32 `json:"face_number" xml:"face_number"`

	// 用户的自定义字段。
	ExternalFields *interface{} `json:"external_fields" xml:"external_fields"`

	// 人脸库ID，随机生成的包含八个字符的字符串。
	FaceSetId string `json:"face_set_id" xml:"face_set_id"`
	...
	// 人脸库最大的容量。
	FaceSetCapacity int32 `json:"face_set_capacity" xml:"face_set_capacity"`
}
