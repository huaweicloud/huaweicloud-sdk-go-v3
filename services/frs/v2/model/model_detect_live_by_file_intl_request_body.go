...
type DetectLiveByFileIntlRequestBody struct {
...
func (o DetectLiveByFileIntlRequestBody) String() string {
	...
	if err != nil {
		return "DetectLiveByFileIntlRequestBody struct{}"
	}

	return strings.Join([]string{"DetectLiveByFileIntlRequestBody", string(data)}, " ")
}
