...
type ListDomainsRequest struct {
	...
	BusinessType *ListDomainsRequestBusinessType `json:"business_type,omitempty" xml:"business_type"`

	// 加速域名状态。取值意义： - online表示“已开启” - offline表示“已停用” - configuring表示“配置中” - configure_failed表示“配置失败” - checking表示“审核中” - check_failed表示“审核未通过” - deleting表示“删除中”。
	DomainStatus *ListDomainsRequestDomainStatus `json:"domain_status,omitempty" xml:"domain_status"`

	// 华为云CDN提供的加速服务范围，包含： - mainland_china 中国大陆 - outside_mainland_china 中国大陆境外 - global 全球。
	ServiceArea *ListDomainsRequestServiceArea `json:"service_area,omitempty" xml:"service_area"`
