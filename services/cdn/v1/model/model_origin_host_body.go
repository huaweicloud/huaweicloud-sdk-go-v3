...
type OriginHostBody struct {
	...
	OriginHostType OriginHostBodyOriginHostType `json:"origin_host_type" xml:"origin_host_type"`

	// 自定义回源域名，origin_host_type为 customize时传入该参数。
	CustomizeDomain *string `json:"customize_domain,omitempty" xml:"customize_domain"`
}
