...
// ListCdnDomainTopIpsRequest Request Object
type ListCdnDomainTopIpsRequest struct {
...
func (o ListCdnDomainTopIpsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListCdnDomainTopIpsRequest struct{}"
	}

	return strings.Join([]string{"ListCdnDomainTopIpsRequest", string(data)}, " ")
}
