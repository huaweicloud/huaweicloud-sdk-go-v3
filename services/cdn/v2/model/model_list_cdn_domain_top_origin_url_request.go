...
// ListCdnDomainTopOriginUrlRequest Request Object
type ListCdnDomainTopOriginUrlRequest struct {
...
func (o ListCdnDomainTopOriginUrlRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListCdnDomainTopOriginUrlRequest struct{}"
	}

	return strings.Join([]string{"ListCdnDomainTopOriginUrlRequest", string(data)}, " ")
}
