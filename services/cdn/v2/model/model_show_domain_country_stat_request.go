...
// ShowDomainCountryStatRequest Request Object
type ShowDomainCountryStatRequest struct {
...
func (o ShowDomainCountryStatRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowDomainCountryStatRequest struct{}"
	}

	return strings.Join([]string{"ShowDomainCountryStatRequest", string(data)}, " ")
}
