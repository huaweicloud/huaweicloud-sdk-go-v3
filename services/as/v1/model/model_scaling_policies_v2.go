...
type ScalingPoliciesV2 struct {
	...
	ScalingResourceType *ScalingPoliciesV2ScalingResourceType `json:"scaling_resource_type,omitempty" xml:"scaling_resource_type"`

	// 伸缩策略状态。INSERVICE：使用中。PAUSED：停止。EXECUTING：执行中。
	PolicyStatus *ScalingPoliciesV2PolicyStatus `json:"policy_status,omitempty" xml:"policy_status"`
	...
	ScalingPolicyType *ScalingPoliciesV2ScalingPolicyType `json:"scaling_policy_type,omitempty" xml:"scaling_policy_type"`
