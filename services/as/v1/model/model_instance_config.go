...
type InstanceConfig struct {
	...
	// 磁盘组信息，系统盘必选，数据盘可选。
	Disk *[]DiskInfo `json:"disk,omitempty" xml:"disk"`
	...
	Personality *[]PersonalityInfo `json:"personality,omitempty" xml:"personality"`
	...
	Tenancy *InstanceConfigTenancy `json:"tenancy,omitempty" xml:"tenancy"`
	...
	MultiFlavorPriorityPolicy *InstanceConfigMultiFlavorPriorityPolicy `json:"multi_flavor_priority_policy,omitempty" xml:"multi_flavor_priority_policy"`

	// 云服务器的计费模式，可以选择竞价计费或按需计费，取值如下：按需计费：不指定该字段。竞价计费：spot
	MarketType *InstanceConfigMarketType `json:"market_type,omitempty" xml:"market_type"`
}
