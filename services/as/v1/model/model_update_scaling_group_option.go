...
type UpdateScalingGroupOption struct {
	...
	Networks *[]Networks `json:"networks,omitempty" xml:"networks"`
	...
	LbaasListeners *[]LbaasListeners `json:"lbaas_listeners,omitempty" xml:"lbaas_listeners"`
	...
	HealthPeriodicAuditMethod *UpdateScalingGroupOptionHealthPeriodicAuditMethod `json:"health_periodic_audit_method,omitempty" xml:"health_periodic_audit_method"`
	...
	InstanceTerminatePolicy *UpdateScalingGroupOptionInstanceTerminatePolicy `json:"instance_terminate_policy,omitempty" xml:"instance_terminate_policy"`
