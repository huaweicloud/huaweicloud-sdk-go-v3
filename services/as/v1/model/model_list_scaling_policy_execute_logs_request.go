...
type ListScalingPolicyExecuteLogsRequest struct {
	...
	ScalingResourceType *ListScalingPolicyExecuteLogsRequestScalingResourceType `json:"scaling_resource_type,omitempty" xml:"scaling_resource_type"`
	...
	ExecuteType *ListScalingPolicyExecuteLogsRequestExecuteType `json:"execute_type,omitempty" xml:"execute_type"`
