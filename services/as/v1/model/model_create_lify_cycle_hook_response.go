...
type CreateLifyCycleHookResponse struct {
	...
	LifecycleHookType *CreateLifyCycleHookResponseLifecycleHookType `json:"lifecycle_hook_type,omitempty" xml:"lifecycle_hook_type"`

	// 生命周期挂钩默认回调操作。ABANDON;CONTINUE
	DefaultResult *CreateLifyCycleHookResponseDefaultResult `json:"default_result,omitempty" xml:"default_result"`
