...
type CreateScalingConfigOption struct {
	...
	ScalingConfigurationName string `json:"scaling_configuration_name" xml:"scaling_configuration_name"`

	InstanceConfig *InstanceConfig `json:"instance_config" xml:"instance_config"`
}
