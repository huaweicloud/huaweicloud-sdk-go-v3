...
type ScalingPolicyActionV2 struct {
	...
	Operation *ScalingPolicyActionV2Operation `json:"operation,omitempty" xml:"operation"`
	...
	Percentage *int32 `json:"percentage,omitempty" xml:"percentage"`
	...
	Limits *int32 `json:"limits,omitempty" xml:"limits"`
}
