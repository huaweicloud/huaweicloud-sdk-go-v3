...
type UpdateLifeCycleHookOption struct {
	...
	LifecycleHookType *UpdateLifeCycleHookOptionLifecycleHookType `json:"lifecycle_hook_type,omitempty" xml:"lifecycle_hook_type"`
	...
	DefaultResult *UpdateLifeCycleHookOptionDefaultResult `json:"default_result,omitempty" xml:"default_result"`
