...
type ScalingV2PolicyDetail struct {
	...
	ScalingResourceType *ScalingV2PolicyDetailScalingResourceType `json:"scaling_resource_type,omitempty" xml:"scaling_resource_type"`

	// 伸缩策略状态。INSERVICE：使用中。PAUSED：停止。EXECUTING：执行中。
	PolicyStatus *ScalingV2PolicyDetailPolicyStatus `json:"policy_status,omitempty" xml:"policy_status"`
	...
	ScalingPolicyType *ScalingV2PolicyDetailScalingPolicyType `json:"scaling_policy_type,omitempty" xml:"scaling_policy_type"`
