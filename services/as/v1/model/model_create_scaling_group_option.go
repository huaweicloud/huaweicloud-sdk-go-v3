...
type CreateScalingGroupOption struct {
	...
	ScalingGroupName string `json:"scaling_group_name" xml:"scaling_group_name"`
	...
	HealthPeriodicAuditMethod *CreateScalingGroupOptionHealthPeriodicAuditMethod `json:"health_periodic_audit_method,omitempty" xml:"health_periodic_audit_method"`
	...
	InstanceTerminatePolicy *CreateScalingGroupOptionInstanceTerminatePolicy `json:"instance_terminate_policy,omitempty" xml:"instance_terminate_policy"`
	...
	MultiAzPriorityPolicy *CreateScalingGroupOptionMultiAzPriorityPolicy `json:"multi_az_priority_policy,omitempty" xml:"multi_az_priority_policy"`
