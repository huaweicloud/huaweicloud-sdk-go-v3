...
type ListAllScalingV2PoliciesRequest struct {
	...
	ScalingResourceType *ListAllScalingV2PoliciesRequestScalingResourceType `json:"scaling_resource_type,omitempty" xml:"scaling_resource_type"`
	...
	ScalingPolicyType *ListAllScalingV2PoliciesRequestScalingPolicyType `json:"scaling_policy_type,omitempty" xml:"scaling_policy_type"`
	...
	SortBy *ListAllScalingV2PoliciesRequestSortBy `json:"sort_by,omitempty" xml:"sort_by"`

	// 排序顺序ASC：升序；DESC：降序
	Order *ListAllScalingV2PoliciesRequestOrder `json:"order,omitempty" xml:"order"`
