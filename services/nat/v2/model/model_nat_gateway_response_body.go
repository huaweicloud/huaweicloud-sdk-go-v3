...
type NatGatewayResponseBody struct {
	...
	Spec NatGatewayResponseBodySpec `json:"spec" xml:"spec"`

	// 公网NAT网关实例的状态。
	Status NatGatewayResponseBodyStatus `json:"status" xml:"status"`
	...
	InternalNetworkId string `json:"internal_network_id" xml:"internal_network_id"`
