...
type ShowInstanceBeanResponse struct {
	...
	// 可用区名称
	AvailableZone string `json:"available_zone" xml:"available_zone"`
	...
	// 节点数量。
	NodeCount int32 `json:"node_count" xml:"node_count"`

	// DDM实例访问地址。
	AccessIp string `json:"access_ip" xml:"access_ip"`

	// DDM实例访问端口。
	AccessPort string `json:"access_port" xml:"access_port"`

	// cpu个数。
	CoreCount string `json:"core_count" xml:"core_count"`

	// 内存大小，单位为G。
	RamCapacity string `json:"ram_capacity" xml:"ram_capacity"`
