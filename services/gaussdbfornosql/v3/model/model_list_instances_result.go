...
type ListInstancesResult struct {
	...
	Datastore *ListInstancesDatastoreResult `json:"datastore" xml:"datastore"`
	...
	BackupStrategy *ListInstancesBackupStrategyResult `json:"backup_strategy" xml:"backup_strategy"`

	// 计费方式。 - 取值为“0”，表示按需计费。 - 取值为“1”，表示包年/包月计费。
	PayMode string `json:"pay_mode" xml:"pay_mode"`

	// 系统可维护时间窗。
	MaintenanceWindow string `json:"maintenance_window" xml:"maintenance_window"`

	// 组信息。
	Groups []ListInstancesGroupResult `json:"groups" xml:"groups"`
	...
	LbIpAddress *string `json:"lb_ip_address,omitempty" xml:"lb_ip_address"`

	// 负载均衡端口，只有存在负载均衡ip，才会返回该参数。
	LbPort *string `json:"lb_port,omitempty" xml:"lb_port"`
}
