...
// ListNosqlTaskListRequest Request Object
type ListNosqlTaskListRequest struct {
...
func (o ListNosqlTaskListRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListNosqlTaskListRequest struct{}"
	}

	return strings.Join([]string{"ListNosqlTaskListRequest", string(data)}, " ")
}
