...
type ShowPrivateHookMetadataResponse struct {
...
func (o ShowPrivateHookMetadataResponse) String() string {
	...
	if err != nil {
		return "ShowPrivateHookMetadataResponse struct{}"
	}

	return strings.Join([]string{"ShowPrivateHookMetadataResponse", string(data)}, " ")
}
