...
type DeleteStackSetRequest struct {
	...
	CallIdentity *DeleteStackSetRequestCallIdentity `json:"call_identity,omitempty"`
}

func (o DeleteStackSetRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteStackSetRequest struct{}"
	}

	return strings.Join([]string{"DeleteStackSetRequest", string(data)}, " ")
}
...
type DeleteStackSetRequestCallIdentityEnum struct {
	SELF            DeleteStackSetRequestCallIdentity
	DELEGATED_ADMIN DeleteStackSetRequestCallIdentity
}

func GetDeleteStackSetRequestCallIdentityEnum() DeleteStackSetRequestCallIdentityEnum {
	return DeleteStackSetRequestCallIdentityEnum{
		SELF: DeleteStackSetRequestCallIdentity{
			value: "SELF",
		},
		DELEGATED_ADMIN: DeleteStackSetRequestCallIdentity{
