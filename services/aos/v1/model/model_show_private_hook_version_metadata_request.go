...
type ShowPrivateHookVersionMetadataRequest struct {
...
func (o ShowPrivateHookVersionMetadataRequest) String() string {
	...
	if err != nil {
		return "ShowPrivateHookVersionMetadataRequest struct{}"
	}

	return strings.Join([]string{"ShowPrivateHookVersionMetadataRequest", string(data)}, " ")
}
