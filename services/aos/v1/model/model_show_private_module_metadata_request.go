...
// ShowPrivateModuleMetadataRequest Request Object
type ShowPrivateModuleMetadataRequest struct {
...
func (o ShowPrivateModuleMetadataRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowPrivateModuleMetadataRequest struct{}"
	}

	return strings.Join([]string{"ShowPrivateModuleMetadataRequest", string(data)}, " ")
}
