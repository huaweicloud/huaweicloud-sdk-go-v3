...
type ListStackInstancesRequest struct {
	...
	CallIdentity *ListStackInstancesRequestCallIdentity `json:"call_identity,omitempty"`
}

func (o ListStackInstancesRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListStackInstancesRequest struct{}"
	}

	return strings.Join([]string{"ListStackInstancesRequest", string(data)}, " ")
}
...
func GetListStackInstancesRequestSortKeyEnum() ListStackInstancesRequestSortKeyEnum {
	return ListStackInstancesRequestSortKeyEnum{
		CREATE_TIME: ListStackInstancesRequestSortKey{
			value: "create_time",
		},
	}
...
func GetListStackInstancesRequestSortDirEnum() ListStackInstancesRequestSortDirEnum {
	return ListStackInstancesRequestSortDirEnum{
		ASC: ListStackInstancesRequestSortDir{
			value: "asc",
		},
		DESC: ListStackInstancesRequestSortDir{
...
type ListStackInstancesRequestCallIdentityEnum struct {
	SELF            ListStackInstancesRequestCallIdentity
	DELEGATED_ADMIN ListStackInstancesRequestCallIdentity
}

func GetListStackInstancesRequestCallIdentityEnum() ListStackInstancesRequestCallIdentityEnum {
	return ListStackInstancesRequestCallIdentityEnum{
		SELF: ListStackInstancesRequestCallIdentity{
			value: "SELF",
		},
		DELEGATED_ADMIN: ListStackInstancesRequestCallIdentity{
