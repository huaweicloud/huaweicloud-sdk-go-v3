...
type ShowPrivateHookVersionMetadataResponse struct {
...
func (o ShowPrivateHookVersionMetadataResponse) String() string {
	...
	if err != nil {
		return "ShowPrivateHookVersionMetadataResponse struct{}"
	}

	return strings.Join([]string{"ShowPrivateHookVersionMetadataResponse", string(data)}, " ")
}
