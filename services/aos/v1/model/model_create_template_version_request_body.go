...
// CreateTemplateVersionRequestBody 创建模板版本请求体
...
func (o CreateTemplateVersionRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateTemplateVersionRequestBody struct{}"
	}

	return strings.Join([]string{"CreateTemplateVersionRequestBody", string(data)}, " ")
}
