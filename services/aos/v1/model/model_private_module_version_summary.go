...
type PrivateModuleVersionSummary struct {
...
func (o PrivateModuleVersionSummary) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PrivateModuleVersionSummary struct{}"
	}

	return strings.Join([]string{"PrivateModuleVersionSummary", string(data)}, " ")
}
