...
type CreateStackInstanceRequestBody struct {
	...
	CallIdentity *CreateStackInstanceRequestBodyCallIdentity `json:"call_identity,omitempty"`
}

func (o CreateStackInstanceRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateStackInstanceRequestBody struct{}"
	}

	return strings.Join([]string{"CreateStackInstanceRequestBody", string(data)}, " ")
}
...
type CreateStackInstanceRequestBodyCallIdentityEnum struct {
	SELF            CreateStackInstanceRequestBodyCallIdentity
	DELEGATED_ADMIN CreateStackInstanceRequestBodyCallIdentity
}

func GetCreateStackInstanceRequestBodyCallIdentityEnum() CreateStackInstanceRequestBodyCallIdentityEnum {
	return CreateStackInstanceRequestBodyCallIdentityEnum{
		SELF: CreateStackInstanceRequestBodyCallIdentity{
			value: "SELF",
		},
		DELEGATED_ADMIN: CreateStackInstanceRequestBodyCallIdentity{
