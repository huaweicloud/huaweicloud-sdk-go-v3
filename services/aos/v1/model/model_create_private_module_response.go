...
func (o CreatePrivateModuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreatePrivateModuleResponse struct{}"
	}

	return strings.Join([]string{"CreatePrivateModuleResponse", string(data)}, " ")
}
