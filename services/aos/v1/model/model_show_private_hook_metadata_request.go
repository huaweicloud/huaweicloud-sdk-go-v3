...
type ShowPrivateHookMetadataRequest struct {
...
func (o ShowPrivateHookMetadataRequest) String() string {
	...
	if err != nil {
		return "ShowPrivateHookMetadataRequest struct{}"
	}

	return strings.Join([]string{"ShowPrivateHookMetadataRequest", string(data)}, " ")
}
