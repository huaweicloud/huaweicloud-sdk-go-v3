...
// ShowPrivateModuleVersionMetadataResponse Response Object
type ShowPrivateModuleVersionMetadataResponse struct {
...
func (o ShowPrivateModuleVersionMetadataResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowPrivateModuleVersionMetadataResponse struct{}"
	}

	return strings.Join([]string{"ShowPrivateModuleVersionMetadataResponse", string(data)}, " ")
}
