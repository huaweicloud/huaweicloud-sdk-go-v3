...
type ShowStackInstanceRequest struct {
	...
	CallIdentity *ShowStackInstanceRequestCallIdentity `json:"call_identity,omitempty"`
}

func (o ShowStackInstanceRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowStackInstanceRequest struct{}"
	}

	return strings.Join([]string{"ShowStackInstanceRequest", string(data)}, " ")
}
...
type ShowStackInstanceRequestCallIdentityEnum struct {
	SELF            ShowStackInstanceRequestCallIdentity
	DELEGATED_ADMIN ShowStackInstanceRequestCallIdentity
}

func GetShowStackInstanceRequestCallIdentityEnum() ShowStackInstanceRequestCallIdentityEnum {
	return ShowStackInstanceRequestCallIdentityEnum{
		SELF: ShowStackInstanceRequestCallIdentity{
			value: "SELF",
		},
		DELEGATED_ADMIN: ShowStackInstanceRequestCallIdentity{
