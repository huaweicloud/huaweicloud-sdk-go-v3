...
type UpdatePrivateModuleMetadataRequestBody struct {
...
func (o UpdatePrivateModuleMetadataRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdatePrivateModuleMetadataRequestBody struct{}"
	}

	return strings.Join([]string{"UpdatePrivateModuleMetadataRequestBody", string(data)}, " ")
}
