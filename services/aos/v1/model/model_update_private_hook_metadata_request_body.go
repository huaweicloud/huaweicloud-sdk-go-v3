...
type UpdatePrivateHookMetadataRequestBody struct {
...
func (o UpdatePrivateHookMetadataRequestBody) String() string {
	...
	if err != nil {
		return "UpdatePrivateHookMetadataRequestBody struct{}"
	}

	return strings.Join([]string{"UpdatePrivateHookMetadataRequestBody", string(data)}, " ")
}
