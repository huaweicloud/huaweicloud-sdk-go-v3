...
// DeletePrivateProviderVersionRequest Request Object
type DeletePrivateProviderVersionRequest struct {
...
func (o DeletePrivateProviderVersionRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeletePrivateProviderVersionRequest struct{}"
	}

	return strings.Join([]string{"DeletePrivateProviderVersionRequest", string(data)}, " ")
}
