...
// ShowPrivateModuleVersionContentRequest Request Object
type ShowPrivateModuleVersionContentRequest struct {
...
func (o ShowPrivateModuleVersionContentRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowPrivateModuleVersionContentRequest struct{}"
	}

	return strings.Join([]string{"ShowPrivateModuleVersionContentRequest", string(data)}, " ")
}
