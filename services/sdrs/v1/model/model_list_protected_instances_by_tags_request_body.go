...
type ListProtectedInstancesByTagsRequestBody struct {
	...
	Tags *[]TagParams `json:"tags,omitempty" xml:"tags"`
	...
	TagsAny *[]TagParams `json:"tags_any,omitempty" xml:"tags_any"`
	...
	NotTags *[]TagParams `json:"not_tags,omitempty" xml:"not_tags"`
	...
	NotTagsAny *[]TagParams `json:"not_tags_any,omitempty" xml:"not_tags_any"`
	...
	Action ListProtectedInstancesByTagsRequestBodyAction `json:"action" xml:"action"`
	...
	Matches *[]MatchParams `json:"matches,omitempty" xml:"matches"`
}
