...
type ResizeProtectedInstanceRequestParams struct {
	...
	ProductionFlavorRef *string `json:"production_flavorRef,omitempty" xml:"production_flavorRef"`
	...
	DrFlavorRef *string `json:"dr_flavorRef,omitempty" xml:"dr_flavorRef"`

	// 新生产站点专属主机ID。 说明：生产站点云服务器在专属主机上时，变更规格需要指定此参数。可以指定为生产站点云服务器当前所在专属主机ID或其他专属主机ID。
	ProductionDedicatedHostId *string `json:"production_dedicated_host_id,omitempty" xml:"production_dedicated_host_id"`

	// 新容灾站点专属主机ID。 说明：容灾站点云服务器在专属主机上时，变更规格需要指定此参数。可以指定为容灾站点云服务器当前所在专属主机ID或其他专属主机ID。
	DrDedicatedHostId *string `json:"dr_dedicated_host_id,omitempty" xml:"dr_dedicated_host_id"`
}
