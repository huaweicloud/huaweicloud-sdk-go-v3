...
type CreateProtectedInstanceRequestParams struct {
	...
	PrimaryIpAddress *string `json:"primary_ip_address,omitempty" xml:"primary_ip_address"`
	...
	Tenancy *CreateProtectedInstanceRequestParamsTenancy `json:"tenancy,omitempty" xml:"tenancy"`
