...
// SimilarHandledEvent 相似告警历史处置列表
type SimilarHandledEvent struct {
	...
	SimiliarType *string `json:"similiar_type,omitempty"`
...
func (o SimilarHandledEvent) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SimilarHandledEvent struct{}"
	}

	return strings.Join([]string{"SimilarHandledEvent", string(data)}, " ")
}
