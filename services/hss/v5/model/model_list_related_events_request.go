...
// ListRelatedEventsRequest Request Object
...
func (o ListRelatedEventsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListRelatedEventsRequest struct{}"
	}

	return strings.Join([]string{"ListRelatedEventsRequest", string(data)}, " ")
}
