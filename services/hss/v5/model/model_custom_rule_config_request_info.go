...
type CustomRuleConfigRequestInfo struct {
...
func (o CustomRuleConfigRequestInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CustomRuleConfigRequestInfo struct{}"
	}

	return strings.Join([]string{"CustomRuleConfigRequestInfo", string(data)}, " ")
}
