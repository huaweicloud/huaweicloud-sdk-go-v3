...
// ShowVulReportDataResponseInfoSummary 统计信息
type ShowVulReportDataResponseInfoSummary struct {
...
func (o ShowVulReportDataResponseInfoSummary) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowVulReportDataResponseInfoSummary struct{}"
	}

	return strings.Join([]string{"ShowVulReportDataResponseInfoSummary", string(data)}, " ")
}
