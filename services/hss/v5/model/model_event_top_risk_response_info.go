...
// EventTopRiskResponseInfo 事件类型数量统计
type EventTopRiskResponseInfo struct {
...
func (o EventTopRiskResponseInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "EventTopRiskResponseInfo struct{}"
	}

	return strings.Join([]string{"EventTopRiskResponseInfo", string(data)}, " ")
}
