...
// ListImageWeakPwdUsersRequest Request Object
type ListImageWeakPwdUsersRequest struct {
...
func (o ListImageWeakPwdUsersRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListImageWeakPwdUsersRequest struct{}"
	}

	return strings.Join([]string{"ListImageWeakPwdUsersRequest", string(data)}, " ")
}
