...
// ExportEventRequestRequest Request Object
type ExportEventRequestRequest struct {
...
func (o ExportEventRequestRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExportEventRequestRequest struct{}"
	}

	return strings.Join([]string{"ExportEventRequestRequest", string(data)}, " ")
}
