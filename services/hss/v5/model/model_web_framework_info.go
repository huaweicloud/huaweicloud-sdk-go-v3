...
func (o WebFrameworkInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "WebFrameworkInfo struct{}"
	}

	return strings.Join([]string{"WebFrameworkInfo", string(data)}, " ")
}
