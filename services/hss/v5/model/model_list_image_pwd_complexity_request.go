...
// ListImagePwdComplexityRequest Request Object
type ListImagePwdComplexityRequest struct {
...
func (o ListImagePwdComplexityRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListImagePwdComplexityRequest struct{}"
	}

	return strings.Join([]string{"ListImagePwdComplexityRequest", string(data)}, " ")
}
