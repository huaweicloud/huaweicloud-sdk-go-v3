...
// BuildCommandRisksImageResponseInfo 镜像构建指令影响的镜像信息
type BuildCommandRisksImageResponseInfo struct {
	...
	RiskDetailInfo *BuildCommandRiskDetailListResponseInfo `json:"risk_detail_info,omitempty"`
}

func (o BuildCommandRisksImageResponseInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BuildCommandRisksImageResponseInfo struct{}"
	}

	return strings.Join([]string{"BuildCommandRisksImageResponseInfo", string(data)}, " ")
}
