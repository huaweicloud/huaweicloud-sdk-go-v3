...
type IsolateEventResponseInfo struct {
	...
	// 发生时间，毫秒
	RecentTime *int64 `json:"recent_time,omitempty"`
	...
	// 进程信息列表
	ProcessInfoList *interface{} `json:"process_info_list,omitempty"`

	// 用户信息列表
	UserInfoList *interface{} `json:"user_info_list,omitempty"`

	// 文件信息列表
	FileInfoList *interface{} `json:"file_info_list,omitempty"`

	// 注册表信息列表
	RegistryInfoList *interface{} `json:"registry_info_list,omitempty"`

	// 注册表信息列表
	ClusterInfo *interface{} `json:"cluster_info,omitempty"`
