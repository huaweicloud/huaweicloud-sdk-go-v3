...
// ListImageNonCompliantAppRequest Request Object
type ListImageNonCompliantAppRequest struct {
...
func (o ListImageNonCompliantAppRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListImageNonCompliantAppRequest struct{}"
	}

	return strings.Join([]string{"ListImageNonCompliantAppRequest", string(data)}, " ")
}
