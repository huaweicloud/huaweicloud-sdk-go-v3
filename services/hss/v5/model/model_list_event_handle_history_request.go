...
// ListEventHandleHistoryRequest Request Object
type ListEventHandleHistoryRequest struct {
...
func (o ListEventHandleHistoryRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListEventHandleHistoryRequest struct{}"
	}

	return strings.Join([]string{"ListEventHandleHistoryRequest", string(data)}, " ")
}
