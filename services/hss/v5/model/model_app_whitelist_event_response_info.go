...
// AppWhitelistEventResponseInfo 事件详情
type AppWhitelistEventResponseInfo struct {
	...
	// 操作详情信息列表（页面不展示）
	OperateDetailList *[]AppWhitelistEventDetailResInfo `json:"operate_detail_list,omitempty"`

	ResourceInfo *ProcessEventResourceResponseInfo `json:"resource_info,omitempty"`

	// **参数解释**: 处置建议 **约束限制**: 不涉及 **取值范围**: 不涉及 **默认取值**: 不涉及
	Recommendation *string `json:"recommendation,omitempty"`

	// **参数解释**: 偏移量：进程信息列表 **约束限制**: 不涉及
	ProcessInfo *[]EventProcessResInfo `json:"process_info,omitempty"`
...
func (o AppWhitelistEventResponseInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AppWhitelistEventResponseInfo struct{}"
	}

	return strings.Join([]string{"AppWhitelistEventResponseInfo", string(data)}, " ")
}
