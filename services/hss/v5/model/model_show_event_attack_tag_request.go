...
// ShowEventAttackTagRequest Request Object
type ShowEventAttackTagRequest struct {
...
func (o ShowEventAttackTagRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowEventAttackTagRequest struct{}"
	}

	return strings.Join([]string{"ShowEventAttackTagRequest", string(data)}, " ")
}
