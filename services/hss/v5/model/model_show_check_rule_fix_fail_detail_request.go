...
// ShowCheckRuleFixFailDetailRequest Request Object
type ShowCheckRuleFixFailDetailRequest struct {
...
func (o ShowCheckRuleFixFailDetailRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowCheckRuleFixFailDetailRequest struct{}"
	}

	return strings.Join([]string{"ShowCheckRuleFixFailDetailRequest", string(data)}, " ")
}
