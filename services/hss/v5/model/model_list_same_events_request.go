...
// ListSameEventsRequest Request Object
type ListSameEventsRequest struct {
...
func (o ListSameEventsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListSameEventsRequest struct{}"
	}

	return strings.Join([]string{"ListSameEventsRequest", string(data)}, " ")
}
