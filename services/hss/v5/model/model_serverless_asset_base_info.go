...
// ServerlessAssetBaseInfo Serverless资产基本信息
type ServerlessAssetBaseInfo struct {
...
func (o ServerlessAssetBaseInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ServerlessAssetBaseInfo struct{}"
	}

	return strings.Join([]string{"ServerlessAssetBaseInfo", string(data)}, " ")
}
