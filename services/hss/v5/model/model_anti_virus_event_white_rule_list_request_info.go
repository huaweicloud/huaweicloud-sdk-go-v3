...
// AntiVirusEventWhiteRuleListRequestInfo 用户自定义告警白名单规则
type AntiVirusEventWhiteRuleListRequestInfo struct {
...
func (o AntiVirusEventWhiteRuleListRequestInfo) String() string {
	...
	if err != nil {
		return "AntiVirusEventWhiteRuleListRequestInfo struct{}"
	}

	return strings.Join([]string{"AntiVirusEventWhiteRuleListRequestInfo", string(data)}, " ")
}
