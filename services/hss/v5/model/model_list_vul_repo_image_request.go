...
// ListVulRepoImageRequest Request Object
type ListVulRepoImageRequest struct {
...
func (o ListVulRepoImageRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListVulRepoImageRequest struct{}"
	}

	return strings.Join([]string{"ListVulRepoImageRequest", string(data)}, " ")
}
