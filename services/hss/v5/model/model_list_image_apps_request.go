...
// ListImageAppsRequest Request Object
type ListImageAppsRequest struct {
...
func (o ListImageAppsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListImageAppsRequest struct{}"
	}

	return strings.Join([]string{"ListImageAppsRequest", string(data)}, " ")
}
