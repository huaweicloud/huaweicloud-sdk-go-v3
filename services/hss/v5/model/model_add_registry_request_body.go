...
// AddRegistryRequestBody 三方镜像仓信息
type AddRegistryRequestBody struct {
	...
	ConnectClusterId string `json:"connect_cluster_id"`
	...
	GetScanImageChannel string `json:"get_scan_image_channel"`
}

func (o AddRegistryRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AddRegistryRequestBody struct{}"
	}

	return strings.Join([]string{"AddRegistryRequestBody", string(data)}, " ")
}
