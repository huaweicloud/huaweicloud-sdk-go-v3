...
// ListSecurityReportRequest Request Object
...
func (o ListSecurityReportRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListSecurityReportRequest struct{}"
	}

	return strings.Join([]string{"ListSecurityReportRequest", string(data)}, " ")
}
