...
// EventTypeResponseInfo 事件类型数量统计
type EventTypeResponseInfo struct {
...
func (o EventTypeResponseInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "EventTypeResponseInfo struct{}"
	}

	return strings.Join([]string{"EventTypeResponseInfo", string(data)}, " ")
}
