...
// ListWebTamperProtectionContainerRequest Request Object
type ListWebTamperProtectionContainerRequest struct {
...
func (o ListWebTamperProtectionContainerRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListWebTamperProtectionContainerRequest struct{}"
	}

	return strings.Join([]string{"ListWebTamperProtectionContainerRequest", string(data)}, " ")
}
