...
type VulWhiteListDetailResponseInfo struct {
...
func (o VulWhiteListDetailResponseInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "VulWhiteListDetailResponseInfo struct{}"
	}

	return strings.Join([]string{"VulWhiteListDetailResponseInfo", string(data)}, " ")
}
