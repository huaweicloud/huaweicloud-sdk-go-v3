...
// ListEventTopRiskRequest Request Object
type ListEventTopRiskRequest struct {
...
func (o ListEventTopRiskRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListEventTopRiskRequest struct{}"
	}

	return strings.Join([]string{"ListEventTopRiskRequest", string(data)}, " ")
}
