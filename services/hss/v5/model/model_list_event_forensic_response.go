...
// ListEventForensicResponse Response Object
type ListEventForensicResponse struct {
	...
	SupportDownloadFile *bool `json:"support_download_file,omitempty"`

	// **参数解释**： 恶意文件的hash,当前为sha256 **取值范围**： 不涉及
	MalwareFileHash *string `json:"malware_file_hash,omitempty"`

	EventForensicInfo *EventForensicInfo `json:"event_forensic_info,omitempty"`
	HttpStatusCode    int                `json:"-"`
}

func (o ListEventForensicResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListEventForensicResponse struct{}"
	}

	return strings.Join([]string{"ListEventForensicResponse", string(data)}, " ")
}
