...
// ListWebFrameworkHostInfoRequest Request Object
type ListWebFrameworkHostInfoRequest struct {
...
func (o ListWebFrameworkHostInfoRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListWebFrameworkHostInfoRequest struct{}"
	}

	return strings.Join([]string{"ListWebFrameworkHostInfoRequest", string(data)}, " ")
}
