...
type ImageDetectionReq struct {
	...
	ModerationRule *string `json:"moderation_rule,omitempty" xml:"moderation_rule"`
	...
	Categories *[]ImageDetectionReqCategories `json:"categories,omitempty" xml:"categories"`
	...
	AdCategories *[]string `json:"ad_categories,omitempty" xml:"ad_categories"`
	...
	Threshold *float32 `json:"threshold,omitempty" xml:"threshold"`

	// 是否返回ocr识别结果，默认为false。
	ShowOcrText *bool `json:"show_ocr_text,omitempty" xml:"show_ocr_text"`
}
