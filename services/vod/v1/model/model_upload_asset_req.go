...
type UploadAssetReq struct {
	...
	VideoType *UploadAssetReqVideoType `json:"video_type,omitempty" xml:"video_type"`

	// 封面ID。  取值范围：[0,7]。  当前只支持一张封面，只能设置为0。
	CoverId *int32 `json:"cover_id,omitempty" xml:"cover_id"`

	// 封面图片格式类型。  取值如下： - JPG - PNG
	CoverType *UploadAssetReqCoverType `json:"cover_type,omitempty" xml:"cover_type"`
