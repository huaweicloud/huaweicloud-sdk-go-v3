...
type PublishAssetFromObsReq struct {
	...
	VideoType PublishAssetFromObsReqVideoType `json:"video_type" xml:"video_type"`
	...
	AutoPublish *int32 `json:"auto_publish,omitempty" xml:"auto_publish"`
	...
	AutoPreheat *int32 `json:"auto_preheat,omitempty" xml:"auto_preheat"`
	...
	Input *FileAddr `json:"input" xml:"input"`

	// 存储模式。  取值如下： - 0：表示视频拷贝到点播桶。 - 1：表示视频存储在租户桶。  默认值：0
	StorageMode *int32 `json:"storage_mode,omitempty" xml:"storage_mode"`
