...
type ShowAssetMetaRequest struct {
	...
	Status *[]ShowAssetMetaRequestStatus `json:"status,omitempty" xml:"status"`

	// 转码状态  取值如下： - TRANSCODING：转码中 - TRANSCODE_FAILED：转码失败 - TRANSCODE_SUCCEED：转码成功 - UN_TRANSCODE：未转码 - WAITING_TRANSCODE：等待转码
	TranscodeStatus *[]ShowAssetMetaRequestTranscodeStatus `json:"transcodeStatus,omitempty" xml:"transcodeStatus"`

	// 媒资状态。  取值如下： - PUBLISHED：已发布 - CREATED：未发布
	AssetStatus *[]ShowAssetMetaRequestAssetStatus `json:"assetStatus,omitempty" xml:"assetStatus"`
