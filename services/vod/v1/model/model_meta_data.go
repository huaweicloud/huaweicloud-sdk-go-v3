...
type MetaData struct {
	...
	Codec *MetaDataCodec `json:"codec,omitempty" xml:"codec"`
	...
	Hight *int64 `json:"hight,omitempty" xml:"hight"`

	// 视频平均码率。
	BitRate *int64 `json:"bit_rate,omitempty" xml:"bit_rate"`
	...
	FrameRate *int64 `json:"frame_rate,omitempty" xml:"frame_rate"`

	// 清晰度。  取值如下： - FULL_HD：超高清 - HD：高清 - SD：标清 - FLUENT：流畅 - AD：自适应 - 2K - 4K
	Quality *string `json:"quality,omitempty" xml:"quality"`

	// 音频的声道数。
	AudioChannels *int32 `json:"audio_channels,omitempty" xml:"audio_channels"`
}
