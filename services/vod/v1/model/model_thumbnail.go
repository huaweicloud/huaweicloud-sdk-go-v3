...
type Thumbnail struct {
	...
	Type ThumbnailType `json:"type" xml:"type"`

	// **type**取值为time时必填。根据时间间隔采样时的时间间隔值。  取值范围：[1,12]之间的整数。  单位：秒。
	Time *int32 `json:"time,omitempty" xml:"time"`

	// **type**取值为dots时必填。指定时间截图时的时间点数组。
	Dots *[]int32 `json:"dots,omitempty" xml:"dots"`

	// 该值表示指定第几张截图作为封面。  默认值：1。
	CoverPosition *int32 `json:"cover_position,omitempty" xml:"cover_position"`

	// 截图文件格式。  取值如下： - 1：jpg。  默认值：1 。
	Format *int32 `json:"format,omitempty" xml:"format"`
