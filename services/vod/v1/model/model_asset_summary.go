...
type AssetSummary struct {
	...
	// 原始播放url。
	OriginalUrl *string `json:"original_url,omitempty" xml:"original_url"`

	// 媒资分类名称。
	Category *string `json:"category,omitempty" xml:"category"`

	// 封面信息。
	Covers *[]CoverInfo `json:"covers,omitempty" xml:"covers"`
	...
	AssetStatus AssetSummaryAssetStatus `json:"asset_status" xml:"asset_status"`

	// 转码状态。  取值如下： - UN_TRANSCODE：未转码。 - WAITING_TRANSCODE：待转码 - TRANSCODING：转码中。 - TRANSCODE_SUCCEED：转码成功。 - TRANSCODE_FAILED：转码失败。
	TranscodeStatus *AssetSummaryTranscodeStatus `json:"transcode_status,omitempty" xml:"transcode_status"`

	// 截图状态。  取值如下： - UN_THUMBNAIL：未截图。 - THUMBNAILING：截图中。 - THUMBNAIL_SUCCEED：截图成功。 - THUMBNAIL_FAILED：截图失败。
	ThumbnailStatus *AssetSummaryThumbnailStatus `json:"thumbnail_status,omitempty" xml:"thumbnail_status"`
	...
	ReviewStatus *AssetSummaryReviewStatus `json:"review_status,omitempty" xml:"review_status"`
	...
	MediaType *string `json:"media_type,omitempty" xml:"media_type"`
}
