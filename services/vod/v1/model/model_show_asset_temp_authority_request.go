...
type ShowAssetTempAuthorityRequest struct {
	...
	ContentType *string `json:"content_type,omitempty" xml:"content_type"`

	// 上传段时每段的MD5。
	ContentMd5 *string `json:"content_md5,omitempty" xml:"content_md5"`

	// 每一个上传任务的id，是OBS进行初始段后OBS返回的。
	UploadId *string `json:"upload_id,omitempty" xml:"upload_id"`

	// 上传段时每一段的id。  取值范围：[1,10000]。
	PartNumber *int32 `json:"part_number,omitempty" xml:"part_number"`
}
