...
type ObjectTypeInfo struct {
	...
	IsSelectAllObjectsType bool `json:"is_select_all_objects_type" xml:"is_select_all_objects_type"`

	// 需要评估的object类型列表。is_select_all_objects_type为false时必填。
	ObjectsTypeList *[]string `json:"objects_type_list,omitempty" xml:"objects_type_list"`
}
