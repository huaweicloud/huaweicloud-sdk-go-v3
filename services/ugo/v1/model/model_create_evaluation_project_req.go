...
type CreateEvaluationProjectReq struct {
	...
	SourceDbInfo *SourceDbInfo `json:"source_db_info" xml:"source_db_info"`

	SchemasInfo *SchemaInfo `json:"schemas_info" xml:"schemas_info"`

	ObjectsTypeInfo *ObjectTypeInfo `json:"objects_type_info" xml:"objects_type_info"`
}
