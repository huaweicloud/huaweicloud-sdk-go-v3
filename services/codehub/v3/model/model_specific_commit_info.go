...
type SpecificCommitInfo struct {
	...
	Stats *SpecificCommitInfoStats `json:"stats,omitempty" xml:"stats"`

	LastPipeline *SpecificCommitInfoLastPipeline `json:"last_pipeline,omitempty" xml:"last_pipeline"`
}

func (o SpecificCommitInfo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SpecificCommitInfo struct{}"
	}

	return strings.Join([]string{"SpecificCommitInfo", string(data)}, " ")
}
