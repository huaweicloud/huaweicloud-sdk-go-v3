...
// UpdateGroupWebhookResponse Response Object
type UpdateGroupWebhookResponse struct {
...
func (o UpdateGroupWebhookResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateGroupWebhookResponse struct{}"
	}

	return strings.Join([]string{"UpdateGroupWebhookResponse", string(data)}, " ")
}
