...
// ShowMergeRequestTemplateResponse Response Object
type ShowMergeRequestTemplateResponse struct {
...
func (o ShowMergeRequestTemplateResponse) String() string {
	...
	if err != nil {
		return "ShowMergeRequestTemplateResponse struct{}"
	}

	return strings.Join([]string{"ShowMergeRequestTemplateResponse", string(data)}, " ")
}
