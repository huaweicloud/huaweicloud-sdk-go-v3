...
// AddGroupWebhookResponse Response Object
type AddGroupWebhookResponse struct {
...
func (o AddGroupWebhookResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AddGroupWebhookResponse struct{}"
	}

	return strings.Join([]string{"AddGroupWebhookResponse", string(data)}, " ")
}
