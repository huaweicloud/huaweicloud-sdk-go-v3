...
// RepositoryMergeRequestTemplateDto 仓库合并请求模板返回体
type RepositoryMergeRequestTemplateDto struct {
...
func (o RepositoryMergeRequestTemplateDto) String() string {
	...
	if err != nil {
		return "RepositoryMergeRequestTemplateDto struct{}"
	}

	return strings.Join([]string{"RepositoryMergeRequestTemplateDto", string(data)}, " ")
}
