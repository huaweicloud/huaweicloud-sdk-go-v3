...
// ShowGroupWebhookResponse Response Object
type ShowGroupWebhookResponse struct {
...
func (o ShowGroupWebhookResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowGroupWebhookResponse struct{}"
	}

	return strings.Join([]string{"ShowGroupWebhookResponse", string(data)}, " ")
}
