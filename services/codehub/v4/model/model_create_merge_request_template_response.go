...
// CreateMergeRequestTemplateResponse Response Object
type CreateMergeRequestTemplateResponse struct {
...
func (o CreateMergeRequestTemplateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateMergeRequestTemplateResponse struct{}"
	}

	return strings.Join([]string{"CreateMergeRequestTemplateResponse", string(data)}, " ")
}
