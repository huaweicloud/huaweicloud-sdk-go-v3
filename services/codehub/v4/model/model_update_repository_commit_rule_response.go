...
// UpdateRepositoryCommitRuleResponse Response Object
type UpdateRepositoryCommitRuleResponse struct {
...
func (o UpdateRepositoryCommitRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateRepositoryCommitRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateRepositoryCommitRuleResponse", string(data)}, " ")
}
