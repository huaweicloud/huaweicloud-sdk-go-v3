...
// CreateRepositoryCommitRuleResponse Response Object
type CreateRepositoryCommitRuleResponse struct {
...
func (o CreateRepositoryCommitRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateRepositoryCommitRuleResponse struct{}"
	}

	return strings.Join([]string{"CreateRepositoryCommitRuleResponse", string(data)}, " ")
}
