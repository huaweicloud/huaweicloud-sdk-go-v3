...
type ValidateRepoNameDto struct {
...
func (o ValidateRepoNameDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ValidateRepoNameDto struct{}"
	}

	return strings.Join([]string{"ValidateRepoNameDto", string(data)}, " ")
}
