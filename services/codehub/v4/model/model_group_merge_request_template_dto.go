...
// GroupMergeRequestTemplateDto 仓库合并请求模板返回体
type GroupMergeRequestTemplateDto struct {
...
func (o GroupMergeRequestTemplateDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "GroupMergeRequestTemplateDto struct{}"
	}

	return strings.Join([]string{"GroupMergeRequestTemplateDto", string(data)}, " ")
}
