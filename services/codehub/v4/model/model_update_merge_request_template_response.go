...
// UpdateMergeRequestTemplateResponse Response Object
type UpdateMergeRequestTemplateResponse struct {
...
func (o UpdateMergeRequestTemplateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateMergeRequestTemplateResponse struct{}"
	}

	return strings.Join([]string{"UpdateMergeRequestTemplateResponse", string(data)}, " ")
}
