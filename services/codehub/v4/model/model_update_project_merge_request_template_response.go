...
// UpdateProjectMergeRequestTemplateResponse Response Object
type UpdateProjectMergeRequestTemplateResponse struct {
...
func (o UpdateProjectMergeRequestTemplateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProjectMergeRequestTemplateResponse struct{}"
	}

	return strings.Join([]string{"UpdateProjectMergeRequestTemplateResponse", string(data)}, " ")
}
