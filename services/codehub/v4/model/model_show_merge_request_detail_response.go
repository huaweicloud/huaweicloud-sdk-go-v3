...
// ShowMergeRequestDetailResponse Response Object
type ShowMergeRequestDetailResponse struct {
...
func (o ShowMergeRequestDetailResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowMergeRequestDetailResponse struct{}"
	}

	return strings.Join([]string{"ShowMergeRequestDetailResponse", string(data)}, " ")
}
