...
type ReqListDehByTags struct {
	...
	NotTags *[]Tag `json:"not_tags,omitempty" xml:"not_tags"`
	...
	Action ReqListDehByTagsAction `json:"action" xml:"action"`
	...
	TagsAny *[]Tag `json:"tags_any,omitempty" xml:"tags_any"`
	...
	NotTagsAny *[]Tag `json:"not_tags_any,omitempty" xml:"not_tags_any"`
