...
func (o CreateOrganizationConformancePackResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateOrganizationConformancePackResponse struct{}"
	}

	return strings.Join([]string{"CreateOrganizationConformancePackResponse", string(data)}, " ")
}
