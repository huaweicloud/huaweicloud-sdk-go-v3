...
func (o ShowCustomConnectorResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowCustomConnectorResponse struct{}"
	}

	return strings.Join([]string{"ShowCustomConnectorResponse", string(data)}, " ")
}
