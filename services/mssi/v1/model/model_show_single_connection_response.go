...
func (o ShowSingleConnectionResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowSingleConnectionResponse struct{}"
	}

	return strings.Join([]string{"ShowSingleConnectionResponse", string(data)}, " ")
}
