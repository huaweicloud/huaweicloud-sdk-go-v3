...
func (o DeleteConnectionInfoResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeleteConnectionInfoResponse struct{}"
	}

	return strings.Join([]string{"DeleteConnectionInfoResponse", string(data)}, " ")
}
