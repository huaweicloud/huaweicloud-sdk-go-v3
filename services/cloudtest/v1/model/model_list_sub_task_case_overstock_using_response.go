...
// ListSubTaskCaseOverstockUsingResponse Response Object
type ListSubTaskCaseOverstockUsingResponse struct {
	...
	// 返回结果
	List *[]SubtaskcaseOverstockDto `json:"list,omitempty"`
...
func (o ListSubTaskCaseOverstockUsingResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListSubTaskCaseOverstockUsingResponse struct{}"
	}

	return strings.Join([]string{"ListSubTaskCaseOverstockUsingResponse", string(data)}, " ")
}
