...
type ShowIssuesByPlanIdResponseBody struct {
...
func (o ShowIssuesByPlanIdResponseBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowIssuesByPlanIdResponseBody struct{}"
	}

	return strings.Join([]string{"ShowIssuesByPlanIdResponseBody", string(data)}, " ")
}
