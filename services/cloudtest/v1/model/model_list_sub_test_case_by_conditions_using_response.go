...
// ListSubTestCaseByConditionsUsingResponse Response Object
type ListSubTestCaseByConditionsUsingResponse struct {
...
func (o ListSubTestCaseByConditionsUsingResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListSubTestCaseByConditionsUsingResponse struct{}"
	}

	return strings.Join([]string{"ListSubTestCaseByConditionsUsingResponse", string(data)}, " ")
}
