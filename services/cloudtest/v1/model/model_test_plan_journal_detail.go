...
type TestPlanJournalDetail struct {
	...
	Updated *[]AttributeChange `json:"updated,omitempty" xml:"updated"`

	// 测试计划资源的添加记录（工作项或者测试用例）
	Added *[]NameAndId `json:"added,omitempty" xml:"added"`

	// 测试计划资源的移除记录（工作项或者测试用例）
	Deleted *[]NameAndId `json:"deleted,omitempty" xml:"deleted"`

	// 表明该条变更记录的具体变更类型，例如测试用例（testCase），需求（issue）
	JournalizedType *string `json:"journalized_type,omitempty" xml:"journalized_type"`
