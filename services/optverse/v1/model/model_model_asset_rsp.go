...
// ModelAssetRsp 模型资产详情。
type ModelAssetRsp struct {
	...
	SubAssetType string `json:"sub_asset_type"`
	...
	AssetActions string `json:"asset_actions"`
...
func (o ModelAssetRsp) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ModelAssetRsp struct{}"
	}

	return strings.Join([]string{"ModelAssetRsp", string(data)}, " ")
}
