...
// ShowModelServiceDetailResponse Response Object
type ShowModelServiceDetailResponse struct {
...
func (o ShowModelServiceDetailResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowModelServiceDetailResponse struct{}"
	}

	return strings.Join([]string{"ShowModelServiceDetailResponse", string(data)}, " ")
}
