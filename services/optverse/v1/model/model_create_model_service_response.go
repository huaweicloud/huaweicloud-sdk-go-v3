...
// CreateModelServiceResponse Response Object
...
func (o CreateModelServiceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateModelServiceResponse struct{}"
	}

	return strings.Join([]string{"CreateModelServiceResponse", string(data)}, " ")
}
