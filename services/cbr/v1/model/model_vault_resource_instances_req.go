...
type VaultResourceInstancesReq struct {
	...
	WithoutAnyTag *bool `json:"without_any_tag,omitempty" xml:"without_any_tag"`
	...
	Matches *[]Match `json:"matches,omitempty" xml:"matches"`

	// 云类型
	CloudType *VaultResourceInstancesReqCloudType `json:"cloud_type,omitempty" xml:"cloud_type"`

	// 资源类型
	ObjectType *VaultResourceInstancesReqObjectType `json:"object_type,omitempty" xml:"object_type"`
}
