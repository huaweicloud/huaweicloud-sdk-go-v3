...
type BulkCreateAndDeleteTags struct {
...
func (o BulkCreateAndDeleteTags) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BulkCreateAndDeleteTags struct{}"
	}

	return strings.Join([]string{"BulkCreateAndDeleteTags", string(data)}, " ")
}
