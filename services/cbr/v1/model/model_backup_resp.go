...
type BackupResp struct {
	...
	// 备份类型
	ImageType BackupRespImageType `json:"image_type" xml:"image_type"`
	...
	// 资源类型
	ResourceType BackupRespResourceType `json:"resource_type" xml:"resource_type"`

	// 备份状态
	Status BackupRespStatus `json:"status" xml:"status"`
