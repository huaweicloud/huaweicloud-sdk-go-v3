...
type OpExtendInfoReplication struct {
	...
	// 源副本ID
	SourceBackupId string `json:"source_backup_id" xml:"source_backup_id"`

	// 源还原点ID
	SourceCheckpointId *string `json:"source_checkpoint_id,omitempty" xml:"source_checkpoint_id"`

	// 源project_id
	SourceProjectId string `json:"source_project_id" xml:"source_project_id"`

	// 源区域
	SourceRegion string `json:"source_region" xml:"source_region"`

	// 源备份名称
	SourceBackupName *string `json:"source_backup_name,omitempty" xml:"source_backup_name"`

	// 目标备份名称
	DestinationBackupName *string `json:"destination_backup_name,omitempty" xml:"destination_backup_name"`
}
