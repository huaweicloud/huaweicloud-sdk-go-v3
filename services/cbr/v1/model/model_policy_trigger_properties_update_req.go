...
// PolicyTriggerPropertiesUpdateReq
type PolicyTriggerPropertiesUpdateReq struct {
...
func (o PolicyTriggerPropertiesUpdateReq) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "PolicyTriggerPropertiesUpdateReq struct{}"
	}

	return strings.Join([]string{"PolicyTriggerPropertiesUpdateReq", string(data)}, " ")
}
