...
func GenReqDefForChangeOrder() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/{project_id}/orders/change").
		WithResponse(new(model.ChangeOrderResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForListFeatures() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/cbr-features").
...
func GenReqDefForShowFeature() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/cbr-features/{feature_key}").
		WithResponse(new(model.ShowFeatureResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("FeatureKey").
		WithJsonTag("feature_key").
		WithLocationType(def.Path))
...
func GenReqDefForUpdateExpirationTime() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/{project_id}/vaults/{vault_id}/update-backup-expiration-time").
		WithResponse(new(model.UpdateExpirationTimeResponse)).
		WithContentType("application/json;charset=UTF-8")
