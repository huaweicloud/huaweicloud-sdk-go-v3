...
type CreateRepoDomainsRequest struct {
	...
	ContentType CreateRepoDomainsRequestContentType `json:"Content-Type" xml:"Content-Type"`
	...
	Body *CreateRepoDomainsRequestBody `json:"body,omitempty" xml:"body"`
}
...
func (c CreateRepoDomainsRequestContentType) Value() string {
	return c.value
}
