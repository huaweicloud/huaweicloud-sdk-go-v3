...
type CreateManualImageSyncRepoRequest struct {
	...
	ContentType CreateManualImageSyncRepoRequestContentType `json:"Content-Type" xml:"Content-Type"`
	...
	Body *CreateManualImageSyncRepoRequestBody `json:"body,omitempty" xml:"body"`
}
