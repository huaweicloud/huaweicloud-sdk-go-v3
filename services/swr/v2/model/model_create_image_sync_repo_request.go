...
type CreateImageSyncRepoRequest struct {
	...
	ContentType CreateImageSyncRepoRequestContentType `json:"Content-Type" xml:"Content-Type"`
	...
	Body *CreateImageSyncRepoRequestBody `json:"body,omitempty" xml:"body"`
}
...
func (c CreateImageSyncRepoRequestContentType) Value() string {
	return c.value
}
