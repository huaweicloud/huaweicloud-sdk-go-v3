...
type UpdateRepoDomainsRequest struct {
	...
	ContentType UpdateRepoDomainsRequestContentType `json:"Content-Type" xml:"Content-Type"`
	...
	Body *UpdateRepoDomainsRequestBody `json:"body,omitempty" xml:"body"`
}
...
func (c UpdateRepoDomainsRequestContentType) Value() string {
	return c.value
}
