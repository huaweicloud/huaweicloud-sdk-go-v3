...
var provider = region.DefaultProviderChain("RFS")
...
func ValueOf(regionId string) *region.Region {
	...
	panic(fmt.Sprintf("region id '%s' is not in the following supported regions of service 'RFS': [%s]", regionId, strings.Join(getRegionIds(), ", ")))
}
