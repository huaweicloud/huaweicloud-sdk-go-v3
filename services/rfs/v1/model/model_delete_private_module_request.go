...
// DeletePrivateModuleRequest Request Object
type DeletePrivateModuleRequest struct {
...
func (o DeletePrivateModuleRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeletePrivateModuleRequest struct{}"
	}

	return strings.Join([]string{"DeletePrivateModuleRequest", string(data)}, " ")
}
