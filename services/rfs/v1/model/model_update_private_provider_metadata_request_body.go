...
type UpdatePrivateProviderMetadataRequestBody struct {
...
func (o UpdatePrivateProviderMetadataRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdatePrivateProviderMetadataRequestBody struct{}"
	}

	return strings.Join([]string{"UpdatePrivateProviderMetadataRequestBody", string(data)}, " ")
}
