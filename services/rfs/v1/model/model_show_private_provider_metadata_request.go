...
// ShowPrivateProviderMetadataRequest Request Object
type ShowPrivateProviderMetadataRequest struct {
...
func (o ShowPrivateProviderMetadataRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowPrivateProviderMetadataRequest struct{}"
	}

	return strings.Join([]string{"ShowPrivateProviderMetadataRequest", string(data)}, " ")
}
