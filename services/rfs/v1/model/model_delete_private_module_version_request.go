...
// DeletePrivateModuleVersionRequest Request Object
type DeletePrivateModuleVersionRequest struct {
...
func (o DeletePrivateModuleVersionRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "DeletePrivateModuleVersionRequest struct{}"
	}

	return strings.Join([]string{"DeletePrivateModuleVersionRequest", string(data)}, " ")
}
