...
type ImageInfo struct {
	...
	// 镜像后端存储类型，目前只支持uds
	ImageSourceType ImageInfoImageSourceType `json:"__image_source_type" xml:"__image_source_type"`

	// 镜像类型，目前支持以下类型： 公共镜像：gold 私有镜像：private 共享镜像：shared
	Imagetype ImageInfoImagetype `json:"__imagetype" xml:"__imagetype"`

	// 是否是注册过的镜像，取值为“true”或者“false”
	Isregistered ImageInfoIsregistered `json:"__isregistered" xml:"__isregistered"`

	// 父镜像ID。公共镜像或通过文件创建的私有镜像，取值为空
	Originalimagename *string `json:"__originalimagename,omitempty" xml:"__originalimagename"`

	// 操作系统位数，一般取值为“32”或者“64”
	OsBit *ImageInfoOsBit `json:"__os_bit,omitempty" xml:"__os_bit"`

	// 操作系统类型，目前取值Linux， Windows，Other
	OsType ImageInfoOsType `json:"__os_type" xml:"__os_type"`

	// 操作系统具体版本
	OsVersion *string `json:"__os_version,omitempty" xml:"__os_version"`

	// 镜像平台分类
	Platform *ImageInfoPlatform `json:"__platform,omitempty" xml:"__platform"`
	...
	SystemSupportMarket *bool `json:"__system_support_market,omitempty" xml:"__system_support_market"`
	...
	DiskFormat *string `json:"disk_format,omitempty" xml:"disk_format"`
	...
	Status ImageInfoStatus `json:"status" xml:"status"`
	...
	VirtualEnvType ImageInfoVirtualEnvType `json:"virtual_env_type" xml:"virtual_env_type"`

	// 目前暂时不使用
	VirtualSize *int32 `json:"virtual_size,omitempty" xml:"virtual_size"`

	// 是否被其他租户可见，取值为private或public
	Visibility ImageInfoVisibility `json:"visibility" xml:"visibility"`

	// 表示当前镜像支持CloudInit密码/密钥注入方式，建议设置为\"true\"或者\"false\"。 如果取值为\"true\"，表示该镜像不支持CloudInit注入密码/密钥，其他取值时表示支持CloudInit注入密钥/密码。
	SupportFcInject *ImageInfoSupportFcInject `json:"__support_fc_inject,omitempty" xml:"__support_fc_inject"`

	// 云服务器的启动方式。目前支持： bios：表示bios引导启动。 uefi：表示uefi引导启动。
	HwFirmwareType *ImageInfoHwFirmwareType `json:"hw_firmware_type,omitempty" xml:"hw_firmware_type"`

	// 是否是ARM架构类型的镜像，取值为“true”或者“false”。
	SupportArm *ImageInfoSupportArm `json:"__support_arm,omitempty" xml:"__support_arm"`
	...
	IsOffshelved *string `json:"__is_offshelved,omitempty" xml:"__is_offshelved"`
	...
	// 镜像状态变为正常的时间。
	ActiveAt string `json:"active_at" xml:"active_at"`
