...
type QuickImportImageByFileRequestBody struct {
	...
	Type *QuickImportImageByFileRequestBodyType `json:"type,omitempty" xml:"type"`

	// 表示当前镜像所属的企业项目。 取值为0或无该值，表示属于default企业项目。 取值为UUID，表示属于该UUID对应的企业项目。 关于企业项目ID的获取及企业项目特性的详细信息，请参考《企业管理用户指南》。
	EnterpriseProjectId *string `json:"enterprise_project_id,omitempty" xml:"enterprise_project_id"`

	// 镜像的架构类型。取值包括： x86 arm 默认使用“x86”。
	Architecture *QuickImportImageByFileRequestBodyArchitecture `json:"architecture,omitempty" xml:"architecture"`

	// 操作系统版本。 创建数据盘镜像时该参数取值为Linux或Windows，默认Linux。
	OsType *QuickImportImageByFileRequestBodyOsType `json:"os_type,omitempty" xml:"os_type"`

	// 新规范的镜像标签列表。默认为空。 tags和image_tags只能使用一个。
	ImageTags *[]ResourceTag `json:"image_tags,omitempty" xml:"image_tags"`
}
