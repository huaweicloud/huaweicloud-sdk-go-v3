...
type GlanceShowImageResponseBody struct {
	...
	ImageSize string `json:"__image_size" xml:"__image_size"`

	// 镜像后端存储类型，目前只支持uds
	ImageSourceType GlanceShowImageResponseBodyImageSourceType `json:"__image_source_type" xml:"__image_source_type"`

	// 镜像类型，目前支持以下类型：公共镜像：gold私有镜像：private共享镜像：shared
	Imagetype GlanceShowImageResponseBodyImagetype `json:"__imagetype" xml:"__imagetype"`

	// 是否是注册过的镜像，取值为“true”或者“false”。
	Isregistered GlanceShowImageResponseBodyIsregistered `json:"__isregistered" xml:"__isregistered"`

	// 父镜像ID。公共镜像或通过文件创建的私有镜像，取值为空。
	Originalimagename *string `json:"__originalimagename,omitempty" xml:"__originalimagename"`

	// 操作系统位数，一般取值为“32”或者“64”。
	OsBit *GlanceShowImageResponseBodyOsBit `json:"__os_bit,omitempty" xml:"__os_bit"`

	// 操作系统类型，目前取值Linux， Windows，Other。
	OsType GlanceShowImageResponseBodyOsType `json:"__os_type" xml:"__os_type"`
	...
	Platform *GlanceShowImageResponseBodyPlatform `json:"__platform,omitempty" xml:"__platform"`
	...
	// 容器类型。
	ContainerFormat string `json:"container_format" xml:"container_format"`

	// 创建时间。格式为UTC时间。
	CreatedAt string `json:"created_at" xml:"created_at"`

	// 镜像的格式，目前支持vhd，zvhd、raw，qcow2,zvhd2。默认值是vhd。
	DiskFormat GlanceShowImageResponseBodyDiskFormat `json:"disk_format" xml:"disk_format"`
	...
	// 镜像运行最小内存，单位为MB。
	MinRam int32 `json:"min_ram" xml:"min_ram"`
	...
	Status GlanceShowImageResponseBodyStatus `json:"status" xml:"status"`
	...
	VirtualEnvType GlanceShowImageResponseBodyVirtualEnvType `json:"virtual_env_type" xml:"virtual_env_type"`

	// 目前暂时不使用。
	VirtualSize *int32 `json:"virtual_size,omitempty" xml:"virtual_size"`

	// 是否被其他租户可见，取值如下：private：私有镜像public：公共镜像shared：共享镜像
	Visibility GlanceShowImageResponseBodyVisibility `json:"visibility" xml:"visibility"`

	// 表示当前镜像支持CloudInit密码/密钥注入方式，建议设置为\"true\"或者\"false\"。如果取值为\"true\"，表示该镜像不支持CloudInit注入密码/密钥，其他取值时表示支持CloudInit注入密钥/密码。
	SupportFcInject *GlanceShowImageResponseBodySupportFcInject `json:"__support_fc_inject,omitempty" xml:"__support_fc_inject"`

	// 表示当前镜像所属的企业项目。 取值为0或无该值，表示属于default企业项目。 取值为UUID，表示属于该UUID对应的企业项目。 关于企业项目ID的获取及企业项目特性的详细信息，请参考《企业管理用户指南》。
	EnterpriseProjectId *string `json:"enterprise_project_id,omitempty" xml:"enterprise_project_id"`

	// 云主机云服务器的启动方式。目前支持： bios：表示bios引导启动。 uefi：表示uefi引导启动。
	HwFirmwareType *GlanceShowImageResponseBodyHwFirmwareType `json:"hw_firmware_type,omitempty" xml:"hw_firmware_type"`

	// 是否为ARM架构类型的镜像，取值为“true”或者“false”。
	SupportArm *GlanceShowImageResponseBodySupportArm `json:"__support_arm,omitempty" xml:"__support_arm"`

	// 表示当前市场镜像是否下架。 true：已下架 false：未下架
	IsOffshelved *GlanceShowImageResponseBodyIsOffshelved `json:"__is_offshelved,omitempty" xml:"__is_offshelved"`
