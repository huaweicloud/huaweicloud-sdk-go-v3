...
type CreateImageRequestBody struct {
	...
	DataImages *[]CreateDataImage `json:"data_images,omitempty" xml:"data_images"`
	...
	ImageTags *[]TagKeyValue `json:"image_tags,omitempty" xml:"image_tags"`
	...
	// 表示镜像支持的最大内存，单位为MB。
	MaxRam *int32 `json:"max_ram,omitempty" xml:"max_ram"`
	...
	IsConfig *bool `json:"is_config,omitempty" xml:"is_config"`
	...
	Type *CreateImageRequestBodyType `json:"type,omitempty" xml:"type"`

	// 是否使用镜像文件快速导入方式，导入系统盘镜像。 是，配置为true。 否，配置为false。 关于镜像文件快速导入的约束与限制请参见镜像文件快速导入。
	IsQuickImport *bool `json:"is_quick_import,omitempty" xml:"is_quick_import"`

	// 镜像的架构类型。取值包括： x86 arm 默认使用“x86”。 当架构类型为arm时，镜像引导方式将自动转为UEFI的引导方式。
	Architecture *CreateImageRequestBodyArchitecture `json:"architecture,omitempty" xml:"architecture"`
