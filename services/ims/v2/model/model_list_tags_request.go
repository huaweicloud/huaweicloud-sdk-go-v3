...
type ListTagsRequest struct {
	...
	Imagetype *ListTagsRequestImagetype `json:"__imagetype,omitempty" xml:"__imagetype"`

	// 镜像ID。
	Id *string `json:"id,omitempty" xml:"id"`

	// 镜像状态。取值如下： queued：表示镜像元数据已经创建成功，等待上传镜像文件。 saving：表示镜像正在上传文件到后端存储。 deleted：表示镜像已经删除。 killed：表示镜像上传错误。 active：表示镜像可以正常使用。
	Status *ListTagsRequestStatus `json:"status,omitempty" xml:"status"`
	...
	OsType *ListTagsRequestOsType `json:"__os_type,omitempty" xml:"__os_type"`

	// 成员状态。目前取值有accepted、rejected、pending。
	MemberStatus *ListTagsRequestMemberStatus `json:"member_status,omitempty" xml:"member_status"`

	// 镜像使用环境类型：FusionCompute、Ironic、DataImage。
	VirtualEnvType *ListTagsRequestVirtualEnvType `json:"virtual_env_type,omitempty" xml:"virtual_env_type"`

	// 表示查询某个企业项目下的镜像。
	EnterpriseProjectId *string `json:"enterprise_project_id,omitempty" xml:"enterprise_project_id"`

	// 镜像架构类型。取值包括：x86，arm
	Architecture *ListTagsRequestArchitecture `json:"architecture,omitempty" xml:"architecture"`
