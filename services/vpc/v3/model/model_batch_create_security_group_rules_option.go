...
func (o BatchCreateSecurityGroupRulesOption) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchCreateSecurityGroupRulesOption struct{}"
	}

	return strings.Join([]string{"BatchCreateSecurityGroupRulesOption", string(data)}, " ")
}
