...
type NeutronSecurityGroupRule struct {
	...
	Direction NeutronSecurityGroupRuleDirection `json:"direction" xml:"direction"`
	...
	PortRangeMax int32 `json:"port_range_max" xml:"port_range_max"`
	...
	PortRangeMin int32 `json:"port_range_min" xml:"port_range_min"`

	// 功能说明：tcp/udp/icmp/icmpv6或IP协议编号（0~255） 约束：协议为icmpv6时，网络类型应该为IPv6；协议为icmp时，网络类型应该为IPv4
	Protocol string `json:"protocol" xml:"protocol"`

	// 所属安全组的对端ID
	RemoteGroupId string `json:"remote_group_id" xml:"remote_group_id"`

	// 对端ip网段
	RemoteIpPrefix string `json:"remote_ip_prefix" xml:"remote_ip_prefix"`

	// 功能说明：远端IP地址组ID 约束：和remote_ip_prefix，remote_group_id互斥
	RemoteAddressGroupId *string `json:"remote_address_group_id,omitempty" xml:"remote_address_group_id"`
