...
type SignatureWithBindNum struct {
	...
	SignType *SignatureWithBindNumSignType `json:"sign_type,omitempty" xml:"sign_type"`
	...
	SignAlgorithm *SignatureWithBindNumSignAlgorithm `json:"sign_algorithm,omitempty" xml:"sign_algorithm"`
	...
	// 绑定的自定义后端数量  暂不支持
	LdapiBindNum *int32 `json:"ldapi_bind_num,omitempty" xml:"ldapi_bind_num"`
}
