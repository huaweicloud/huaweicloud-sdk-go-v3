...
type ListApiRuntimeDefinitionV2Response struct {
	...
	Type ListApiRuntimeDefinitionV2ResponseType `json:"type" xml:"type"`

	// API的版本
	Version *string `json:"version,omitempty" xml:"version"`

	// API的请求协议 - HTTP - HTTPS - BOTH：同时支持HTTP和HTTPS
	ReqProtocol ListApiRuntimeDefinitionV2ResponseReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// API的请求方式
	ReqMethod ListApiRuntimeDefinitionV2ResponseReqMethod `json:"req_method" xml:"req_method"`

	// 请求地址。可以包含请求参数，用{}标识，比如/getUserInfo/{userId}，支持 * % - _ . 等特殊字符，总长度不超过512，且满足URI规范。 > 需要服从URI规范。
	ReqUri string `json:"req_uri" xml:"req_uri"`

	// API的认证方式 - NONE：无认证 - APP：APP认证 - IAM：IAM认证 - AUTHORIZER：自定义认证
	AuthType ListApiRuntimeDefinitionV2ResponseAuthType `json:"auth_type" xml:"auth_type"`
	...
	MatchMode *ListApiRuntimeDefinitionV2ResponseMatchMode `json:"match_mode,omitempty" xml:"match_mode"`

	// 后端类型 - HTTP：web后端 - FUNCTION：函数工作流 - MOCK：模拟的后端
	BackendType ListApiRuntimeDefinitionV2ResponseBackendType `json:"backend_type" xml:"backend_type"`
	...
	ContentType *ListApiRuntimeDefinitionV2ResponseContentType `json:"content_type,omitempty" xml:"content_type"`
