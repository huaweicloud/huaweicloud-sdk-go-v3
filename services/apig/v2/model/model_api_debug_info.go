...
type ApiDebugInfo struct {
	...
	Header map[string]string `json:"header,omitempty" xml:"header"`

	// API的请求方法
	Method ApiDebugInfoMethod `json:"method" xml:"method"`
	...
	Query map[string]string `json:"query,omitempty" xml:"query"`
