...
type ShowDetailsOfRequestThrottlingPolicyV2Response struct {
	...
	// 流控的时间单位
	TimeUnit ShowDetailsOfRequestThrottlingPolicyV2ResponseTimeUnit `json:"time_unit" xml:"time_unit"`
	...
	Type *ShowDetailsOfRequestThrottlingPolicyV2ResponseType `json:"type,omitempty" xml:"type"`
	...
	IsIncluSpecialThrottle *ShowDetailsOfRequestThrottlingPolicyV2ResponseIsIncluSpecialThrottle `json:"is_inclu_special_throttle,omitempty" xml:"is_inclu_special_throttle"`
