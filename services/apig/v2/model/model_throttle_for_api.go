...
type ThrottleForApi struct {
	...
	// 流控的时间单位
	TimeUnit ThrottleForApiTimeUnit `json:"time_unit" xml:"time_unit"`
	...
	Type *ThrottleForApiType `json:"type,omitempty" xml:"type"`
	...
	IsIncluSpecialThrottle *ThrottleForApiIsIncluSpecialThrottle `json:"is_inclu_special_throttle,omitempty" xml:"is_inclu_special_throttle"`
