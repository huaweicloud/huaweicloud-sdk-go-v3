...
type InstanceCreateReq struct {
	...
	SpecId *InstanceCreateReqSpecId `json:"spec_id,omitempty" xml:"spec_id"`
	...
	LoadbalancerProvider *InstanceCreateReqLoadbalancerProvider `json:"loadbalancer_provider,omitempty" xml:"loadbalancer_provider"`
}
