...
type BackendApiCreate struct {
	...
	// 请求协议
	ReqProtocol BackendApiCreateReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// 描述。字符长度不超过255 > 中文字符必须为UTF-8或者unicode编码。
	Remark *string `json:"remark,omitempty" xml:"remark"`

	// 请求方式
	ReqMethod BackendApiCreateReqMethod `json:"req_method" xml:"req_method"`
	...
	VpcChannelStatus *BackendApiCreateVpcChannelStatus `json:"vpc_channel_status,omitempty" xml:"vpc_channel_status"`
}
