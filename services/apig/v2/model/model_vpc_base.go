...
type VpcBase struct {
	...
	BalanceStrategy *VpcBaseBalanceStrategy `json:"balance_strategy,omitempty" xml:"balance_strategy"`

	// VPC通道的成员类型。 - ip - ecs  VPC通道类型为2时必选。
	MemberType *VpcBaseMemberType `json:"member_type,omitempty" xml:"member_type"`
}
