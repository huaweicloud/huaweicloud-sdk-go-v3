...
type ApiBaseInfo struct {
	...
	SamplingStrategy *ApiBaseInfoSamplingStrategy `json:"sampling_strategy,omitempty"`
...
type ApiBaseInfoSamplingStrategy struct {
	value string
}

type ApiBaseInfoSamplingStrategyEnum struct {
	RATE ApiBaseInfoSamplingStrategy
}

func GetApiBaseInfoSamplingStrategyEnum() ApiBaseInfoSamplingStrategyEnum {
	return ApiBaseInfoSamplingStrategyEnum{
		RATE: ApiBaseInfoSamplingStrategy{
			value: "RATE",
		},
	}
...
func (c ApiBaseInfoSamplingStrategy) Value() string {
	return c.value
}

func (c ApiBaseInfoSamplingStrategy) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *ApiBaseInfoSamplingStrategy) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
