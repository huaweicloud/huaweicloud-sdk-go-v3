...
type ApiPolicyHttpCreate struct {
	...
	// 请求协议：HTTP、HTTPS
	ReqProtocol ApiPolicyHttpCreateReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// 请求方式：GET、POST、PUT、DELETE、HEAD、PATCH、OPTIONS、ANY
	ReqMethod ApiPolicyHttpCreateReqMethod `json:"req_method" xml:"req_method"`
	...
	EffectMode ApiPolicyHttpCreateEffectMode `json:"effect_mode" xml:"effect_mode"`
	...
	VpcChannelInfo *ApiBackendVpcReq `json:"vpc_channel_info,omitempty" xml:"vpc_channel_info"`

	// 是否使用VPC通道 - 1 : 使用VPC通道 - 2 : 不使用VPC通道
	VpcChannelStatus *ApiPolicyHttpCreateVpcChannelStatus `json:"vpc_channel_status,omitempty" xml:"vpc_channel_status"`
}
