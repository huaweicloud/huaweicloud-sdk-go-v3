...
type VpcHealthConfigInfo struct {
	...
	Protocol VpcHealthConfigInfoProtocol `json:"protocol" xml:"protocol"`

	// 健康检查时的目标路径。protocol = http时必选
	Path *string `json:"path,omitempty" xml:"path"`

	// 健康检查时的请求方法
	Method *VpcHealthConfigInfoMethod `json:"method,omitempty" xml:"method"`
	...
	// 健康检查状态   - 1：可用   - 2：不可用
	Status *VpcHealthConfigInfoStatus `json:"status,omitempty" xml:"status"`
