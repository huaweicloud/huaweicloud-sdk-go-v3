...
type ApiInfoPerPage struct {
	...
	SamplingStrategy *ApiInfoPerPageSamplingStrategy `json:"sampling_strategy,omitempty"`
...
type ApiInfoPerPageSamplingStrategy struct {
	value string
}

type ApiInfoPerPageSamplingStrategyEnum struct {
	RATE ApiInfoPerPageSamplingStrategy
}

func GetApiInfoPerPageSamplingStrategyEnum() ApiInfoPerPageSamplingStrategyEnum {
	return ApiInfoPerPageSamplingStrategyEnum{
		RATE: ApiInfoPerPageSamplingStrategy{
			value: "RATE",
		},
	}
...
func (c ApiInfoPerPageSamplingStrategy) Value() string {
	return c.value
}

func (c ApiInfoPerPageSamplingStrategy) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *ApiInfoPerPageSamplingStrategy) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
