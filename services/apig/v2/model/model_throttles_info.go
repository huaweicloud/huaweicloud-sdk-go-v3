...
type ThrottlesInfo struct {
	...
	// 流控的时间单位
	TimeUnit ThrottlesInfoTimeUnit `json:"time_unit" xml:"time_unit"`
	...
	Type *ThrottlesInfoType `json:"type,omitempty" xml:"type"`
	...
	IsIncluSpecialThrottle *ThrottlesInfoIsIncluSpecialThrottle `json:"is_inclu_special_throttle,omitempty" xml:"is_inclu_special_throttle"`
