...
type ApiCreateBase struct {
	...
	SamplingStrategy *ApiCreateBaseSamplingStrategy `json:"sampling_strategy,omitempty"`
...
type ApiCreateBaseSamplingStrategy struct {
	value string
}

type ApiCreateBaseSamplingStrategyEnum struct {
	RATE ApiCreateBaseSamplingStrategy
}

func GetApiCreateBaseSamplingStrategyEnum() ApiCreateBaseSamplingStrategyEnum {
	return ApiCreateBaseSamplingStrategyEnum{
		RATE: ApiCreateBaseSamplingStrategy{
			value: "RATE",
		},
	}
...
func (c ApiCreateBaseSamplingStrategy) Value() string {
	return c.value
}

func (c ApiCreateBaseSamplingStrategy) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *ApiCreateBaseSamplingStrategy) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
