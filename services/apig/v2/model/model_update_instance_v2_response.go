...
type UpdateInstanceV2Response struct {
	...
	Status *UpdateInstanceV2ResponseStatus `json:"status,omitempty" xml:"status"`
	...
	InstanceStatus *UpdateInstanceV2ResponseInstanceStatus `json:"instance_status,omitempty" xml:"instance_status"`
	...
	Spec *UpdateInstanceV2ResponseSpec `json:"spec,omitempty" xml:"spec"`
	...
	ChargingMode *UpdateInstanceV2ResponseChargingMode `json:"charging_mode,omitempty" xml:"charging_mode"`

	// 包周期计费订单编号
	CbcMetadata *string `json:"cbc_metadata,omitempty" xml:"cbc_metadata"`

	// 实例使用的负载均衡器类型 - lvs Linux虚拟服务器 - elb 弹性负载均衡，elb仅部分region支持
	LoadbalancerProvider *UpdateInstanceV2ResponseLoadbalancerProvider `json:"loadbalancer_provider,omitempty" xml:"loadbalancer_provider"`
