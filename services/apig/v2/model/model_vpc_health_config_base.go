...
type VpcHealthConfigBase struct {
	...
	Protocol VpcHealthConfigBaseProtocol `json:"protocol" xml:"protocol"`

	// 健康检查时的目标路径。protocol = http时必选
	Path *string `json:"path,omitempty" xml:"path"`

	// 健康检查时的请求方法
	Method *VpcHealthConfigBaseMethod `json:"method,omitempty" xml:"method"`
	...
	// 健康检查状态   - 1：可用   - 2：不可用
	Status *VpcHealthConfigBaseStatus `json:"status,omitempty" xml:"status"`
}
