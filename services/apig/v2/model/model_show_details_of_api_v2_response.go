...
type ShowDetailsOfApiV2Response struct {
	...
	SamplingStrategy *ShowDetailsOfApiV2ResponseSamplingStrategy `json:"sampling_strategy,omitempty"`
...
type ShowDetailsOfApiV2ResponseSamplingStrategy struct {
	value string
}

type ShowDetailsOfApiV2ResponseSamplingStrategyEnum struct {
	RATE ShowDetailsOfApiV2ResponseSamplingStrategy
}

func GetShowDetailsOfApiV2ResponseSamplingStrategyEnum() ShowDetailsOfApiV2ResponseSamplingStrategyEnum {
	return ShowDetailsOfApiV2ResponseSamplingStrategyEnum{
		RATE: ShowDetailsOfApiV2ResponseSamplingStrategy{
			value: "RATE",
		},
	}
...
func (c ShowDetailsOfApiV2ResponseSamplingStrategy) Value() string {
	return c.value
}

func (c ShowDetailsOfApiV2ResponseSamplingStrategy) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *ShowDetailsOfApiV2ResponseSamplingStrategy) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
