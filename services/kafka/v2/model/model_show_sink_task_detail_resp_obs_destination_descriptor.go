...
type ShowSinkTaskDetailRespObsDestinationDescriptor struct {
	...
	ConsumerStrategy *string `json:"consumer_strategy,omitempty" xml:"consumer_strategy"`

	// 转储文件格式。目前只支持text格式。
	DestinationFileType *string `json:"destination_file_type,omitempty" xml:"destination_file_type"`
	...
	DeliverTimeInterval *int32 `json:"deliver_time_interval,omitempty" xml:"deliver_time_interval"`

	// 每个传输文件多大后就开始上传，单位为byte。 默认值5242880。
	ObsPartSize *int64 `json:"obs_part_size,omitempty" xml:"obs_part_size"`
}
