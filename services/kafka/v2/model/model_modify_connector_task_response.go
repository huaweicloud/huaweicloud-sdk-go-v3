...
// ModifyConnectorTaskResponse Response Object
type ModifyConnectorTaskResponse struct {
...
func (o ModifyConnectorTaskResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ModifyConnectorTaskResponse struct{}"
	}

	return strings.Join([]string{"ModifyConnectorTaskResponse", string(data)}, " ")
}
