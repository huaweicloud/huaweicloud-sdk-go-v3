...
type Server struct {
	...
	OsType ServerOsType `json:"os_type" xml:"os_type"`

	// 操作系统版本，注册必选，更新非必选
	OsVersion *string `json:"os_version,omitempty" xml:"os_version"`

	// 源端服务器启动类型，如BIOS或者UEFI
	Firmware *ServerFirmware `json:"firmware,omitempty" xml:"firmware"`
	...
	// 源端服务器的磁盘信息
	Disks *[]Disk `json:"disks,omitempty" xml:"disks"`
	...
	BootLoader *ServerBootLoader `json:"boot_loader,omitempty" xml:"boot_loader"`
