...
type TaskGroupResp struct {
	...
	DstStoragePolicy *TaskGroupRespDstStoragePolicy `json:"dst_storage_policy,omitempty"`
...
func (o TaskGroupResp) String() string {
	...
	if err != nil {
		return "TaskGroupResp struct{}"
	}

	return strings.Join([]string{"TaskGroupResp", string(data)}, " ")
}
...
func GetTaskGroupRespTaskTypeEnum() TaskGroupRespTaskTypeEnum {
	return TaskGroupRespTaskTypeEnum{
		LIST: TaskGroupRespTaskType{
			value: "LIST",
		},
		URL_LIST: TaskGroupRespTaskType{
...
func GetTaskGroupRespObjectOverwriteModeEnum() TaskGroupRespObjectOverwriteModeEnum {
	return TaskGroupRespObjectOverwriteModeEnum{
		NO_OVERWRITE: TaskGroupRespObjectOverwriteMode{
			value: "NO_OVERWRITE",
		},
		SIZE_LAST_MODIFIED_COMPARISON_OVERWRITE: TaskGroupRespObjectOverwriteMode{
...
func (c TaskGroupRespObjectOverwriteMode) Value() string {
	return c.value
}
...
type TaskGroupRespDstStoragePolicy struct {
	value string
}

type TaskGroupRespDstStoragePolicyEnum struct {
	STANDARD            TaskGroupRespDstStoragePolicy
	IA                  TaskGroupRespDstStoragePolicy
	ARCHIVE             TaskGroupRespDstStoragePolicy
	DEEP_ARCHIVE        TaskGroupRespDstStoragePolicy
	SRC_STORAGE_MAPPING TaskGroupRespDstStoragePolicy
}

func GetTaskGroupRespDstStoragePolicyEnum() TaskGroupRespDstStoragePolicyEnum {
	return TaskGroupRespDstStoragePolicyEnum{
		STANDARD: TaskGroupRespDstStoragePolicy{
			value: "STANDARD",
		},
		IA: TaskGroupRespDstStoragePolicy{
...
func (c TaskGroupRespDstStoragePolicy) Value() string {
	return c.value
}

func (c TaskGroupRespDstStoragePolicy) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *TaskGroupRespDstStoragePolicy) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
...
func GetTaskGroupRespConsistencyCheckEnum() TaskGroupRespConsistencyCheckEnum {
	return TaskGroupRespConsistencyCheckEnum{
		SIZE_LAST_MODIFIED: TaskGroupRespConsistencyCheck{
...
func (c TaskGroupRespConsistencyCheck) Value() string {
	return c.value
}
