...
// ShowJobPermissionResult 结果
type ShowJobPermissionResult struct {
...
func (o ShowJobPermissionResult) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowJobPermissionResult struct{}"
	}

	return strings.Join([]string{"ShowJobPermissionResult", string(data)}, " ")
}
