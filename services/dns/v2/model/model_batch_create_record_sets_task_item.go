...
type BatchCreateRecordSetsTaskItem struct {
...
func (o BatchCreateRecordSetsTaskItem) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BatchCreateRecordSetsTaskItem struct{}"
	}

	return strings.Join([]string{"BatchCreateRecordSetsTaskItem", string(data)}, " ")
}
