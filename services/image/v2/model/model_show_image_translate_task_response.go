...
type ShowImageTranslateTaskResponse struct {
	...
	Input *ImageTranslateTaskInput `json:"input,omitempty"`
...
func (o ShowImageTranslateTaskResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowImageTranslateTaskResponse struct{}"
	}

	return strings.Join([]string{"ShowImageTranslateTaskResponse", string(data)}, " ")
}
