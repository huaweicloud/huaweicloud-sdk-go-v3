...
func (o ShowVideoCuttingTaskResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowVideoCuttingTaskResponse struct{}"
	}

	return strings.Join([]string{"ShowVideoCuttingTaskResponse", string(data)}, " ")
}
