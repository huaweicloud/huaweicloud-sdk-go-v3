...
func (o ShowVideoSynthesisTaskResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowVideoSynthesisTaskResponse struct{}"
	}

	return strings.Join([]string{"ShowVideoSynthesisTaskResponse", string(data)}, " ")
}
