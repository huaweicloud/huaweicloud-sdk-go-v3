...
type ListAssetsRequest struct {
	...
	SortDir *ListAssetsRequestSortDir `json:"sort_dir,omitempty"`
	...
	// 语言 多选使用英文逗号分隔
	Lanuage *string `json:"lanuage,omitempty"`
...
type ListAssetsRequestSortDir struct {
	value string
}

type ListAssetsRequestSortDirEnum struct {
	ASC  ListAssetsRequestSortDir
	DESC ListAssetsRequestSortDir
}

func GetListAssetsRequestSortDirEnum() ListAssetsRequestSortDirEnum {
	return ListAssetsRequestSortDirEnum{
		ASC: ListAssetsRequestSortDir{
			value: "asc",
		},
		DESC: ListAssetsRequestSortDir{
...
func (c ListAssetsRequestSortDir) Value() string {
	return c.value
}

func (c ListAssetsRequestSortDir) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *ListAssetsRequestSortDir) UnmarshalJSON(b []byte) error {
