...
// UpdateInteractionRuleResponse Response Object
type UpdateInteractionRuleResponse struct {
...
func (o UpdateInteractionRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateInteractionRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateInteractionRuleResponse", string(data)}, " ")
}
