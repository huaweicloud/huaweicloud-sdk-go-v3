...
// CreateInteractionRuleResponse Response Object
type CreateInteractionRuleResponse struct {
...
func (o CreateInteractionRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateInteractionRuleResponse struct{}"
	}

	return strings.Join([]string{"CreateInteractionRuleResponse", string(data)}, " ")
}
