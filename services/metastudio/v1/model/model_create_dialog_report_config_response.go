...
// CreateDialogReportConfigResponse Response Object
type CreateDialogReportConfigResponse struct {
...
func (o CreateDialogReportConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateDialogReportConfigResponse struct{}"
	}

	return strings.Join([]string{"CreateDialogReportConfigResponse", string(data)}, " ")
}
