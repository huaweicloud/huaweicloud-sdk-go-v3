...
type ShowSmartChatRoomResponse struct {
	...
	BillingMode *ShowSmartChatRoomResponseBillingMode `json:"billing_mode,omitempty"`
...
type ShowSmartChatRoomResponseBillingMode struct {
	value string
}

type ShowSmartChatRoomResponseBillingModeEnum struct {
	CONCURRENCY   ShowSmartChatRoomResponseBillingMode
	CLIENT        ShowSmartChatRoomResponseBillingMode
	CLIENT_TOKENS ShowSmartChatRoomResponseBillingMode
}

func GetShowSmartChatRoomResponseBillingModeEnum() ShowSmartChatRoomResponseBillingModeEnum {
	return ShowSmartChatRoomResponseBillingModeEnum{
		CONCURRENCY: ShowSmartChatRoomResponseBillingMode{
			value: "CONCURRENCY",
		},
		CLIENT: ShowSmartChatRoomResponseBillingMode{
...
func (c ShowSmartChatRoomResponseBillingMode) Value() string {
	return c.value
}

func (c ShowSmartChatRoomResponseBillingMode) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *ShowSmartChatRoomResponseBillingMode) UnmarshalJSON(b []byte) error {
