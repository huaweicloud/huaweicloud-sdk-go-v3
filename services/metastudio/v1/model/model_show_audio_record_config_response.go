...
// ShowAudioRecordConfigResponse Response Object
type ShowAudioRecordConfigResponse struct {
...
func (o ShowAudioRecordConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowAudioRecordConfigResponse struct{}"
	}

	return strings.Join([]string{"ShowAudioRecordConfigResponse", string(data)}, " ")
}
