...
// CreateTrainingThirdPartyJobResponse Response Object
type CreateTrainingThirdPartyJobResponse struct {
...
func (o CreateTrainingThirdPartyJobResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateTrainingThirdPartyJobResponse struct{}"
	}

	return strings.Join([]string{"CreateTrainingThirdPartyJobResponse", string(data)}, " ")
}
