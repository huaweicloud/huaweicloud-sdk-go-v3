...
// UpdateDialogReportConfigResponse Response Object
type UpdateDialogReportConfigResponse struct {
...
func (o UpdateDialogReportConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateDialogReportConfigResponse struct{}"
	}

	return strings.Join([]string{"UpdateDialogReportConfigResponse", string(data)}, " ")
}
