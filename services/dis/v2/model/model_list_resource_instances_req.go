...
func (o ListResourceInstancesReq) String() string {
	...
	if err != nil {
		return "ListResourceInstancesReq struct{}"
	}

	return strings.Join([]string{"ListResourceInstancesReq", string(data)}, " ")
}
...
func GetListResourceInstancesReqActionEnum() ListResourceInstancesReqActionEnum {
	return ListResourceInstancesReqActionEnum{
		FILTER: ListResourceInstancesReqAction{
			value: "filter",
		},
		COUNT: ListResourceInstancesReqAction{
...
func (c ListResourceInstancesReqAction) Value() string {
	return c.value
}
