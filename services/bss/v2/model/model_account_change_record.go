...
type AccountChangeRecord struct {
	...
	// 收支明细流水号。
	AccountChangeId *string `json:"account_change_id,omitempty" xml:"account_change_id"`
	...
	TradeDetailType *string `json:"trade_detail_type,omitempty" xml:"trade_detail_type"`
	...
	// 变更金额，单位为元。
	ChangeAmount *string `json:"change_amount,omitempty" xml:"change_amount"`

	// 变更后余额，单位为元。
	BalanceAfterChange *string `json:"balance_after_change,omitempty" xml:"balance_after_change"`
