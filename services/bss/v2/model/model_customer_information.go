...
type CustomerInformation struct {
	...
	// 实名认证名称。
	Customer *string `json:"customer,omitempty" xml:"customer"`

	// 客户经理登录名称。
	AccountName string `json:"account_name" xml:"account_name"`
	...
	AssociatedOn *string `json:"associated_on,omitempty" xml:"associated_on"`
	...
	VerifiedStatus *string `json:"verified_status,omitempty" xml:"verified_status"`
	...
	CustomerType *int32 `json:"customer_type,omitempty" xml:"customer_type"`

	// 是否冻结： 0：否1：是
	IsFrozen *int32 `json:"is_frozen,omitempty" xml:"is_frozen"`

	// 该客户对应的客户经理信息，目前只支持1个，具体参见表2。
	AccountManagers *[]AccountManager `json:"account_managers,omitempty" xml:"account_managers"`

	// 伙伴销售平台的用户唯一标识，该标识的具体值由伙伴分配。
	XaccountId *string `json:"xaccount_id,omitempty" xml:"xaccount_id"`
	...
	CustomerLevel *string `json:"customer_level,omitempty" xml:"customer_level"`
}
