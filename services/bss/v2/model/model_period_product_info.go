...
type PeriodProductInfo struct {
	...
	CloudServiceType string `json:"cloud_service_type" xml:"cloud_service_type"`
	...
	ResourceSpec string `json:"resource_spec" xml:"resource_spec"`
	...
	ResourceSize *int32 `json:"resource_size,omitempty" xml:"resource_size"`
	...
	SizeMeasureId *int32 `json:"size_measure_id,omitempty" xml:"size_measure_id"`

	// 订购包年/包月产品的周期类型。 0：天2：月3：年4：小时
	PeriodType int32 `json:"period_type" xml:"period_type"`

	// 订购包年/包月产品的周期数。
	PeriodNum int32 `json:"period_num" xml:"period_num"`

	// 订购包年/包月产品的数量。
	SubscriptionNum int32 `json:"subscription_num" xml:"subscription_num"`

	// 费用分期模式。 HALF_PAY：半付ZERO_PAY：零付NA：不支持费用分期模式  说明： 此参数不携带或携带值为空串或携带值为null时，默认值为“NA”。暂只支持IES产品。
	FeeInstallmentMode *string `json:"fee_installment_mode,omitempty" xml:"fee_installment_mode"`
}
