...
// Request Object
type ListParnterAdjustRecordsRequest struct {
...
func (o ListParnterAdjustRecordsRequest) String() string {
	data, err := json.Marshal(o)
	if err != nil {
		return "ListParnterAdjustRecordsRequest struct{}"
	}

	return strings.Join([]string{"ListParnterAdjustRecordsRequest", string(data)}, " ")
}
