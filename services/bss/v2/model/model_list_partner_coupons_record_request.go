...
type ListPartnerCouponsRecordRequest struct {
	...
	OperationTypes *[]string `json:"operation_types,omitempty" xml:"operation_types"`
	...
	CouponIds *[]string `json:"coupon_ids,omitempty" xml:"coupon_ids"`
	...
	OperationTimeBegin *string `json:"operation_time_begin,omitempty" xml:"operation_time_begin"`
	...
	OperationTimeEnd *string `json:"operation_time_end,omitempty" xml:"operation_time_end"`
