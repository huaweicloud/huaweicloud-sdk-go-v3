...
type UnsubscribeResourcesReq struct {
	...
	UnsubscribeType int32 `json:"unsubscribe_type" xml:"unsubscribe_type"`

	// 退订理由分类，取值如下： 1：产品不好用2：产品功能无法满足需求3：不会操作/操作过于复杂4：对服务不满意5：其他
	UnsubscribeReasonType *int32 `json:"unsubscribe_reason_type,omitempty" xml:"unsubscribe_reason_type"`

	// 退订原因，一般由客户输入。
	UnsubscribeReason *string `json:"unsubscribe_reason,omitempty" xml:"unsubscribe_reason"`
}
