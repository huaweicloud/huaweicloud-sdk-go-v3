...
type FreeResourcePackageV3 struct {
	...
	OrderInstanceId *string `json:"order_instance_id,omitempty" xml:"order_instance_id"`
	...
	EnterpriseProjectScope *int32 `json:"enterprise_project_scope,omitempty" xml:"enterprise_project_scope"`
	...
	BundleType *string `json:"bundle_type,omitempty" xml:"bundle_type"`
	...
	QuotaReuseMode *int32 `json:"quota_reuse_mode,omitempty" xml:"quota_reuse_mode"`

	// 资源套餐内的资源项信息（资源项ID级的详情），具体参见表3。
	FreeResources *[]FreeResourceV3 `json:"free_resources,omitempty" xml:"free_resources"`
}
