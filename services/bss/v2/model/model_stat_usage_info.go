...
type StatUsageInfo struct {
	...
	StatTime *string `json:"stat_time,omitempty" xml:"stat_time"`

	// 保底带宽。  说明： 该字段为预留值，当前始终为空；当场景为95增强时才返回数值。
	GuaranteedBandWidth *string `json:"guaranteed_band_width,omitempty" xml:"guaranteed_band_width"`

	// 用量。
	Usage *string `json:"usage,omitempty" xml:"usage"`
