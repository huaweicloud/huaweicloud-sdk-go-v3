...
type ApplyIndividualRealnameAuthsReq struct {
	...
	VerifiedType *int32 `json:"verified_type,omitempty" xml:"verified_type"`
	...
	// 变更类型： -1：首次实名认证
	ChangeType *int32 `json:"change_type,omitempty" xml:"change_type"`

	// 华为分给合作伙伴的平台标识。 该标识的具体值由华为分配。获取方法请参见如何获取xaccountType的取值。
	XaccountType string `json:"xaccount_type" xml:"xaccount_type"`

	BankCardInfo *BankCardInfoV2 `json:"bank_card_info,omitempty" xml:"bank_card_info"`
}
