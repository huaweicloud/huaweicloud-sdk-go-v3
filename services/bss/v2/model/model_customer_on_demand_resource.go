...
type CustomerOnDemandResource struct {
	...
	// 所属可用区的编码。
	AvailabilityZoneCode *string `json:"availability_zone_code,omitempty" xml:"availability_zone_code"`
	...
	ResourceInfo *string `json:"resource_info,omitempty" xml:"resource_info"`
