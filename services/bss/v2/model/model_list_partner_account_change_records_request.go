...
type ListPartnerAccountChangeRecordsRequest struct {
	...
	BalanceType string `json:"balance_type" xml:"balance_type"`
	...
	TradeType *string `json:"trade_type,omitempty" xml:"trade_type"`

	// 查询收支明细的开始日期。 说明： 东八区时间，格式为YYYY-MM-DD，如“2017-10-21”。默认值为一年前的当天日期。
	TradeTimeBegin *string `json:"trade_time_begin,omitempty" xml:"trade_time_begin"`

	// 查询收支明细的结束日期。 说明： 东八区时间，格式为YYYY-MM-DD，如“2017-12-21”。默认值为当前日期。
	TradeTimeEnd *string `json:"trade_time_end,omitempty" xml:"trade_time_end"`
