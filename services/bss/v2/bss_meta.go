...
func GenReqDefForListBusinessDiscountInfo() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/promotions/business/discount-info").
		WithResponse(new(model.ListBusinessDiscountInfoResponse)).
		WithContentType("application/json")
...
func GenReqDefForListResourceSpecs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/products/resource-specs-query").
		WithResponse(new(model.ListResourceSpecsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowRealNameAuthQrCode() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/customers/real-name-auth-qrcode").
		WithResponse(new(model.ShowRealNameAuthQrCodeResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowRealNameAuthStatus() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/customers/real-name-auth-status").
		WithResponse(new(model.ShowRealNameAuthStatusResponse)).
		WithContentType("application/json")
