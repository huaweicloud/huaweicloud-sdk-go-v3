...
//
// Please refer to HUAWEI cloud API Explorer for details.
func (c *BssClient) SetResourcesRenewConfig(request *model.SetResourcesRenewConfigRequest) (*model.SetResourcesRenewConfigResponse, error) {
...
func (c *BssClient) SetResourcesRenewConfigInvoker(request *model.SetResourcesRenewConfigRequest) *SetResourcesRenewConfigInvoker {
	requestDef := GenReqDefForSetResourcesRenewConfig()
