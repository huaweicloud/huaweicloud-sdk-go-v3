...
func GenReqDefForBatchCreateBaremetalServerTags() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/baremetalservers/{server_id}/tags/action").
		WithResponse(new(model.BatchCreateBaremetalServerTagsResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForBatchDeleteBaremetalServerTags() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/baremetalservers/{server_id}/tags/action").
		WithResponse(new(model.BatchDeleteBaremetalServerTagsResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForChangeBaremetalServerOs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/baremetalservers/{server_id}/changeos").
		WithResponse(new(model.ChangeBaremetalServerOsResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForDeleteBaremetalServer() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v1/{project_id}/baremetalservers/delete").
		WithResponse(new(model.DeleteBaremetalServerResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForDeleteWindowsBareMetalServerPassword() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		...
		WithResponse(new(model.DeleteWindowsBareMetalServerPasswordResponse)).
...
func GenReqDefForListBareMetalServersDetail() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1.1/{project_id}/baremetalservers/detail").
		WithResponse(new(model.ListBareMetalServersDetailResponse)).
		WithContentType("application/json")
...
func GenReqDefForModifyVmNic() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v1/{project_id}/baremetalservers/nics/{nic_id}").
		WithResponse(new(model.ModifyVmNicResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForShowAvailableResource() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/baremetalservers/available_resource").
		WithResponse(new(model.ShowAvailableResourceResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowBaremetalServerTags() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v1/{project_id}/baremetalservers/{server_id}/tags").
		WithResponse(new(model.ShowBaremetalServerTagsResponse)).
		WithContentType("application/json")
