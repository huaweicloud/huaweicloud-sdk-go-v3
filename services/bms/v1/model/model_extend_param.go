...
type ExtendParam struct {
	...
	ChargingMode *ExtendParamChargingMode `json:"chargingMode,omitempty" xml:"chargingMode"`
	...
	PeriodType *ExtendParamPeriodType `json:"periodType,omitempty" xml:"periodType"`
