...
// RootVolumeMetadata
type RootVolumeMetadata struct {
...
func (o RootVolumeMetadata) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RootVolumeMetadata struct{}"
	}

	return strings.Join([]string{"RootVolumeMetadata", string(data)}, " ")
}
