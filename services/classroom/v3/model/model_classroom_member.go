...
type ClassroomMember struct {
	...
	JoinTime string `json:"join_time" xml:"join_time"`

	// 该成员已接收到的作业数量
	JobReceivedCount int32 `json:"job_received_count" xml:"job_received_count"`

	// 该成员已完成的作业数量
	JobFinishedCount int32 `json:"job_finished_count" xml:"job_finished_count"`

	// 该成员作业完成率
	JobFinishedRate float32 `json:"job_finished_rate" xml:"job_finished_rate"`
}
