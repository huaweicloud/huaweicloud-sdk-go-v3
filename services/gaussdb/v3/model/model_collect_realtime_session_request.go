...
// CollectRealtimeSessionRequest Request Object
type CollectRealtimeSessionRequest struct {
	...
	Body *RealtimeSessionRequest `json:"body,omitempty"`
}

func (o CollectRealtimeSessionRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CollectRealtimeSessionRequest struct{}"
	}

	return strings.Join([]string{"CollectRealtimeSessionRequest", string(data)}, " ")
}
