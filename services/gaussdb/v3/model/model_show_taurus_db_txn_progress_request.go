...
// ShowTaurusDbTxnProgressRequest Request Object
type ShowTaurusDbTxnProgressRequest struct {
	...
	Body *TxnProgressRequestBody `json:"body,omitempty"`
}

func (o ShowTaurusDbTxnProgressRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowTaurusDbTxnProgressRequest struct{}"
	}

	return strings.Join([]string{"ShowTaurusDbTxnProgressRequest", string(data)}, " ")
}
