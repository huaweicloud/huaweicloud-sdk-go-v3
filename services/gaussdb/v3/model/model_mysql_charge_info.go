...
type MysqlChargeInfo struct {
	...
	ChargeMode MysqlChargeInfoChargeMode `json:"charge_mode" xml:"charge_mode"`

	// 订购周期类型。  取值范围：  - month：包月。 - year：包年。  说明：“charge_mode”为“prePaid”时生效，且为必选值。
	PeriodType *MysqlChargeInfoPeriodType `json:"period_type,omitempty" xml:"period_type"`
	...
	IsAutoRenew *string `json:"is_auto_renew,omitempty" xml:"is_auto_renew"`
