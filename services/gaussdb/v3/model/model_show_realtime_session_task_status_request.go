...
// ShowRealtimeSessionTaskStatusRequest Request Object
type ShowRealtimeSessionTaskStatusRequest struct {
...
func (o ShowRealtimeSessionTaskStatusRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowRealtimeSessionTaskStatusRequest struct{}"
	}

	return strings.Join([]string{"ShowRealtimeSessionTaskStatusRequest", string(data)}, " ")
}
