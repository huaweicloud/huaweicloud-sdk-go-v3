...
func (o ListStarRocksDataReplicationConfigByDataBaseResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListStarRocksDataReplicationConfigByDataBaseResponse struct{}"
	}

	return strings.Join([]string{"ListStarRocksDataReplicationConfigByDataBaseResponse", string(data)}, " ")
}
