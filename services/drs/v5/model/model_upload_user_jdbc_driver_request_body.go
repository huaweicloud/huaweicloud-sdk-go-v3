...
type UploadUserJdbcDriverRequestBody struct {
...
func (o UploadUserJdbcDriverRequestBody) String() string {
	...
	if err != nil {
		return "UploadUserJdbcDriverRequestBody struct{}"
	}

	return strings.Join([]string{"UploadUserJdbcDriverRequestBody", string(data)}, " ")
}
