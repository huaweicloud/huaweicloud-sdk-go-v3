...
type LineCompareResultDetails struct {
	...
	// 该库的表的行对比详情。
	LineCompareDetail []LineCompareDetail `json:"LineCompareDetail" xml:"LineCompareDetail"`

	// 该库的行对比结果详情总数。
	LineCompareDetailCount int32 `json:"line_compare_detail_count" xml:"line_compare_detail_count"`
}
