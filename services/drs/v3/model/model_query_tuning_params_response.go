...
// QueryTuningParamsResponse Response Object
type QueryTuningParamsResponse struct {
...
func (o QueryTuningParamsResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "QueryTuningParamsResponse struct{}"
	}

	return strings.Join([]string{"QueryTuningParamsResponse", string(data)}, " ")
}
