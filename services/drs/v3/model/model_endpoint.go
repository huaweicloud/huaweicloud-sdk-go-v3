...
type Endpoint struct {
	...
	// 数据库类型，测试连接之后修改调用时必填。
	DbType *EndpointDbType `json:"db_type,omitempty" xml:"db_type"`
	...
	// RDS实例名称。
	InstName *string `json:"inst_name,omitempty" xml:"inst_name"`

	// 数据库ip
	Ip *string `json:"ip,omitempty" xml:"ip"`

	// mongo ha模式。
	MongoHaMode *string `json:"mongo_ha_mode,omitempty" xml:"mongo_ha_mode"`
	...
	ClusterMode *EndpointClusterMode `json:"cluster_mode,omitempty" xml:"cluster_mode"`
}
