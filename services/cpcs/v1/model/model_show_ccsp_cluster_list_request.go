...
// ShowCcspClusterListRequest Request Object
type ShowCcspClusterListRequest struct {
...
func (o ShowCcspClusterListRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowCcspClusterListRequest struct{}"
	}

	return strings.Join([]string{"ShowCcspClusterListRequest", string(data)}, " ")
}
