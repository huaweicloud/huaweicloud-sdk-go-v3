...
var provider = region.DefaultProviderChain("IDENTITYCENTEROIDC")
...
func ValueOf(regionId string) *region.Region {
	...
	panic(fmt.Sprintf("region id '%s' is not in the following supported regions of service 'IdentityCenterOIDC': [%s]", regionId, strings.Join(getRegionIds(), ", ")))
}
