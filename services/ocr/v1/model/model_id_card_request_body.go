...
type IdCardRequestBody struct {
	...
	ReturnVerification *bool `json:"return_verification,omitempty" xml:"return_verification"`
	...
	DetectReproduce *bool `json:"detect_reproduce,omitempty" xml:"detect_reproduce"`
}
