...
func (o RecognizeHouseholdRegisterRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeHouseholdRegisterRequest struct{}"
	}

	return strings.Join([]string{"RecognizeHouseholdRegisterRequest", string(data)}, " ")
}
