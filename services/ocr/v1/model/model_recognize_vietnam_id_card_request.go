...
func (o RecognizeVietnamIdCardRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeVietnamIdCardRequest struct{}"
	}

	return strings.Join([]string{"RecognizeVietnamIdCardRequest", string(data)}, " ")
}
