...
func (o RecognizeBankReceiptRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeBankReceiptRequest struct{}"
	}

	return strings.Join([]string{"RecognizeBankReceiptRequest", string(data)}, " ")
}
