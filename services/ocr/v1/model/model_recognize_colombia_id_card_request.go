...
func (o RecognizeColombiaIdCardRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeColombiaIdCardRequest struct{}"
	}

	return strings.Join([]string{"RecognizeColombiaIdCardRequest", string(data)}, " ")
}
