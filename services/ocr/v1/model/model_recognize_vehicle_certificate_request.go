...
func (o RecognizeVehicleCertificateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeVehicleCertificateRequest struct{}"
	}

	return strings.Join([]string{"RecognizeVehicleCertificateRequest", string(data)}, " ")
}
