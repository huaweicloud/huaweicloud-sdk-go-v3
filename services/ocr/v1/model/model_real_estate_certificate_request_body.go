...
func (o RealEstateCertificateRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RealEstateCertificateRequestBody struct{}"
	}

	return strings.Join([]string{"RealEstateCertificateRequestBody", string(data)}, " ")
}
