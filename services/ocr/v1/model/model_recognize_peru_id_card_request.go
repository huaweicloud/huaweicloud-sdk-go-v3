...
func (o RecognizePeruIdCardRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizePeruIdCardRequest struct{}"
	}

	return strings.Join([]string{"RecognizePeruIdCardRequest", string(data)}, " ")
}
