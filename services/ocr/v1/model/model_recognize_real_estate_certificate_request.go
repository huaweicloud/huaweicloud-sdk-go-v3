...
func (o RecognizeRealEstateCertificateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeRealEstateCertificateRequest struct{}"
	}

	return strings.Join([]string{"RecognizeRealEstateCertificateRequest", string(data)}, " ")
}
