...
func (o RecognizeSmartDocumentRecognizerRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeSmartDocumentRecognizerRequest struct{}"
	}

	return strings.Join([]string{"RecognizeSmartDocumentRecognizerRequest", string(data)}, " ")
}
