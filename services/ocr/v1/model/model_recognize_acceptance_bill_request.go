...
func (o RecognizeAcceptanceBillRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeAcceptanceBillRequest struct{}"
	}

	return strings.Join([]string{"RecognizeAcceptanceBillRequest", string(data)}, " ")
}
