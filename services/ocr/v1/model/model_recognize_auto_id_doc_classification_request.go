...
// RecognizeAutoIdDocClassificationRequest Request Object
type RecognizeAutoIdDocClassificationRequest struct {
	...
	Body *AutoIdDocClassificationRequestBody `json:"body,omitempty"`
}

func (o RecognizeAutoIdDocClassificationRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeAutoIdDocClassificationRequest struct{}"
	}

	return strings.Join([]string{"RecognizeAutoIdDocClassificationRequest", string(data)}, " ")
}
