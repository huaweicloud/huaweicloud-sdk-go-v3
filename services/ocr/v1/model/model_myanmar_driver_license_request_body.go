...
type MyanmarDriverLicenseRequestBody struct {
	...
	ConvertUnicode *bool `json:"convert_unicode,omitempty" xml:"convert_unicode"`
}

func (o MyanmarDriverLicenseRequestBody) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "MyanmarDriverLicenseRequestBody struct{}"
	}

	return strings.Join([]string{"MyanmarDriverLicenseRequestBody", string(data)}, " ")
}
