...
func (o RecognizeCustomTemplateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RecognizeCustomTemplateRequest struct{}"
	}

	return strings.Join([]string{"RecognizeCustomTemplateRequest", string(data)}, " ")
}
