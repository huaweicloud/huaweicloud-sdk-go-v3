...
type ApiCreate struct {
	...
	Type ApiCreateType `json:"type" xml:"type"`

	// API的版本
	Version *string `json:"version,omitempty" xml:"version"`

	// API的请求协议 - HTTP - HTTPS - BOTH：同时支持HTTP和HTTPS
	ReqProtocol ApiCreateReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// API的请求方式
	ReqMethod ApiCreateReqMethod `json:"req_method" xml:"req_method"`
	...
	AuthType ApiCreateAuthType `json:"auth_type" xml:"auth_type"`
	...
	MatchMode *ApiCreateMatchMode `json:"match_mode,omitempty" xml:"match_mode"`

	// 后端类型[，site暂不支持函数工作流。](tag:Site) - HTTP：web后端 - FUNCTION：函数工作流 - MOCK：模拟的后端
	BackendType ApiCreateBackendType `json:"backend_type" xml:"backend_type"`
	...
	ContentType *ApiCreateContentType `json:"content_type,omitempty" xml:"content_type"`
	...
	BackendApi *BackendApiCreate `json:"backend_api,omitempty" xml:"backend_api"`

	// web策略后端列表
	PolicyHttps *[]ApiPolicyHttpCreate `json:"policy_https,omitempty" xml:"policy_https"`
}
