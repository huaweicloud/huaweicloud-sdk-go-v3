...
type CreateCustomAuthorizerV2Response struct {
	...
	Type CreateCustomAuthorizerV2ResponseType `json:"type" xml:"type"`

	// 自定义认证函数类型： - LD：自定义后端函数 - FUNC：函数服务函数
	AuthorizerType CreateCustomAuthorizerV2ResponseAuthorizerType `json:"authorizer_type" xml:"authorizer_type"`
