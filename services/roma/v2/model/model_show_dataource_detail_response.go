...
type ShowDataourceDetailResponse struct {
	...
	DatasourceType *ShowDataourceDetailResponseDatasourceType `json:"datasource_type,omitempty" xml:"datasource_type"`
	...
	AppPermission  *[]ShowDataourceDetailResponseAppPermission `json:"app_permission,omitempty" xml:"app_permission"`
