...
type CreateProductRequestBody struct {
	...
	ProductType CreateProductRequestBodyProductType `json:"product_type" xml:"product_type"`

	// 产品描述，长度0-200
	Description *string `json:"description,omitempty" xml:"description"`

	// 产品的协议类型 0-mqtt 2-modbus 4-opcua
	ProtocolType CreateProductRequestBodyProtocolType `json:"protocol_type" xml:"protocol_type"`
	...
	DataFormat *CreateProductRequestBodyDataFormat `json:"data_format,omitempty" xml:"data_format"`
}
