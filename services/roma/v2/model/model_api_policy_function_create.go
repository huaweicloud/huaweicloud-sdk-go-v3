...
type ApiPolicyFunctionCreate struct {
	...
	InvocationType ApiPolicyFunctionCreateInvocationType `json:"invocation_type" xml:"invocation_type"`
	...
	EffectMode ApiPolicyFunctionCreateEffectMode `json:"effect_mode" xml:"effect_mode"`
