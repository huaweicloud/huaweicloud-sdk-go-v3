...
type CreateLiveDataApiV2Response struct {
	...
	Method CreateLiveDataApiV2ResponseMethod `json:"method" xml:"method"`
	...
	// 后端API返回类型
	ContentType CreateLiveDataApiV2ResponseContentType `json:"content_type" xml:"content_type"`
	...
	Type *CreateLiveDataApiV2ResponseType `json:"type,omitempty" xml:"type"`

	// 后端API状态： - 1：待开发 - 3：开发中 - 4：已部署
	Status *CreateLiveDataApiV2ResponseStatus `json:"status,omitempty" xml:"status"`
...
func (c CreateLiveDataApiV2ResponseMethod) Value() string {
	return c.value
}
...
func (c CreateLiveDataApiV2ResponseContentType) Value() string {
	return c.value
}
...
func (c CreateLiveDataApiV2ResponseType) Value() string {
	return c.value
}
...
func (c CreateLiveDataApiV2ResponseStatus) Value() int32 {
	return c.value
}
