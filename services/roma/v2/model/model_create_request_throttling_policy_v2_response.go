...
type CreateRequestThrottlingPolicyV2Response struct {
	...
	// 流控的时间单位
	TimeUnit CreateRequestThrottlingPolicyV2ResponseTimeUnit `json:"time_unit" xml:"time_unit"`
	...
	Type *CreateRequestThrottlingPolicyV2ResponseType `json:"type,omitempty" xml:"type"`
	...
	IsIncluSpecialThrottle *CreateRequestThrottlingPolicyV2ResponseIsIncluSpecialThrottle `json:"is_inclu_special_throttle,omitempty" xml:"is_inclu_special_throttle"`
...
func (c CreateRequestThrottlingPolicyV2ResponseTimeUnit) Value() string {
	return c.value
}
...
func (c CreateRequestThrottlingPolicyV2ResponseType) Value() int32 {
	return c.value
}
...
func (c CreateRequestThrottlingPolicyV2ResponseIsIncluSpecialThrottle) Value() int32 {
	return c.value
}
