...
type UpdateDeviceResponse struct {
	...
	// 设备状态 0-启用 1-禁用
	Status *UpdateDeviceResponseStatus `json:"status,omitempty" xml:"status"`

	// 是否在线 0-未连接 1-在线 2-离线
	OnlineStatus *UpdateDeviceResponseOnlineStatus `json:"online_status,omitempty" xml:"online_status"`
	...
	DeviceType *UpdateDeviceResponseDeviceType `json:"device_type,omitempty" xml:"device_type"`
	...
	PluginId *UpdateDeviceResponsePluginId `json:"plugin_id,omitempty" xml:"plugin_id"`
...
func (c UpdateDeviceResponseStatus) Value() int32 {
	return c.value
}
...
func (c UpdateDeviceResponseOnlineStatus) Value() int32 {
	return c.value
}
...
func (c UpdateDeviceResponseDeviceType) Value() int32 {
	return c.value
}
