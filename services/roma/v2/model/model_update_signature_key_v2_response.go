...
type UpdateSignatureKeyV2Response struct {
	...
	SignType *UpdateSignatureKeyV2ResponseSignType `json:"sign_type,omitempty" xml:"sign_type"`
	...
	SignAlgorithm *UpdateSignatureKeyV2ResponseSignAlgorithm `json:"sign_algorithm,omitempty" xml:"sign_algorithm"`
