...
type CreateSignatureKeyV2Response struct {
	...
	SignType *CreateSignatureKeyV2ResponseSignType `json:"sign_type,omitempty" xml:"sign_type"`
	...
	SignAlgorithm *CreateSignatureKeyV2ResponseSignAlgorithm `json:"sign_algorithm,omitempty" xml:"sign_algorithm"`
