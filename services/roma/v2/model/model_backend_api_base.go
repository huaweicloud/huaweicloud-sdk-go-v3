...
type BackendApiBase struct {
	...
	// 请求协议
	ReqProtocol BackendApiBaseReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// 描述。 > 中文字符必须为UTF-8或者unicode编码。
	Remark *string `json:"remark,omitempty" xml:"remark"`

	// 请求方式
	ReqMethod BackendApiBaseReqMethod `json:"req_method" xml:"req_method"`
	...
	// 后端状态   - 1： 有效
	Status *BackendApiBaseStatus `json:"status,omitempty" xml:"status"`
