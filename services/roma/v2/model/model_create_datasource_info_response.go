...
type CreateDatasourceInfoResponse struct {
	...
	DatasourceType *CreateDatasourceInfoResponseDatasourceType `json:"datasource_type,omitempty" xml:"datasource_type"`
	...
	AppPermission  *[]CreateDatasourceInfoResponseAppPermission `json:"app_permission,omitempty" xml:"app_permission"`
