...
type ShowRequestPropertyResponse struct {
	...
	DataType *ShowRequestPropertyResponseDataType `json:"data_type,omitempty" xml:"data_type"`

	// 是否必填 0-非必填 1-必填
	Required *ShowRequestPropertyResponseRequired `json:"required,omitempty" xml:"required"`
...
func (c ShowRequestPropertyResponseDataType) Value() string {
	return c.value
}
...
func (c ShowRequestPropertyResponseRequired) Value() int32 {
	return c.value
}
