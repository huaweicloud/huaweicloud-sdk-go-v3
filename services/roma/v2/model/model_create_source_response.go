...
type CreateSourceResponse struct {
	...
	// 源数据源ID
	SourceId *int32 `json:"source_id,omitempty" xml:"source_id"`

	// 产品ID
	ProductId *int32 `json:"product_id,omitempty" xml:"product_id"`

	// 设备ID，不填为全部设备
	DeviceId *int32 `json:"device_id,omitempty" xml:"device_id"`
	...
	IsBase64 *CreateSourceResponseIsBase64 `json:"is_base64,omitempty" xml:"is_base64"`

	// 是否包含设备信息，0-是，1-否
	ContainDeviceInfo *CreateSourceResponseContainDeviceInfo `json:"contain_device_info,omitempty" xml:"contain_device_info"`
