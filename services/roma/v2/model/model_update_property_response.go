...
type UpdatePropertyResponse struct {
	...
	DataType *UpdatePropertyResponseDataType `json:"data_type,omitempty" xml:"data_type"`

	// 是否必填 0-非必填 1-必填
	Required *UpdatePropertyResponseRequired `json:"required,omitempty" xml:"required"`
...
func (c UpdatePropertyResponseDataType) Value() string {
	return c.value
}
...
func (c UpdatePropertyResponseRequired) Value() int32 {
	return c.value
}
