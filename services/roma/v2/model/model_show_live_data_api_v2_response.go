...
type ShowLiveDataApiV2Response struct {
	...
	Method ShowLiveDataApiV2ResponseMethod `json:"method" xml:"method"`
	...
	// 后端API返回类型
	ContentType ShowLiveDataApiV2ResponseContentType `json:"content_type" xml:"content_type"`
	...
	Type *ShowLiveDataApiV2ResponseType `json:"type,omitempty" xml:"type"`

	// 后端API状态： - 1：待开发 - 3：开发中 - 4：已部署
	Status *ShowLiveDataApiV2ResponseStatus `json:"status,omitempty" xml:"status"`
