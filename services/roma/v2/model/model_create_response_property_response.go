...
type CreateResponsePropertyResponse struct {
	...
	DataType *CreateResponsePropertyResponseDataType `json:"data_type,omitempty" xml:"data_type"`

	// 是否必填 0-非必填 1-必填
	Required *CreateResponsePropertyResponseRequired `json:"required,omitempty" xml:"required"`
