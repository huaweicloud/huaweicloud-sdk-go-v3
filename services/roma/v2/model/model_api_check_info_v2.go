...
type ApiCheckInfoV2 struct {
	...
	// 请求方式。  type = path时必填
	ReqMethod *ApiCheckInfoV2ReqMethod `json:"req_method,omitempty" xml:"req_method"`

	// API的访问地址。  type = path时必填
	ReqUri *string `json:"req_uri,omitempty" xml:"req_uri"`

	// API的匹配方式 - SWA：前缀匹配 - NORMAL：正常匹配（绝对匹配）  type = path时必填
	MatchMode *ApiCheckInfoV2MatchMode `json:"match_mode,omitempty" xml:"match_mode"`
	...
	Type *ApiCheckInfoV2Type `json:"type,omitempty" xml:"type"`
}
