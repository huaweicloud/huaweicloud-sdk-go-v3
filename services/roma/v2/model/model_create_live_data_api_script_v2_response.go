...
type CreateLiveDataApiScriptV2Response struct {
	...
	Method CreateLiveDataApiScriptV2ResponseMethod `json:"method" xml:"method"`
	...
	// 后端API返回类型
	ContentType CreateLiveDataApiScriptV2ResponseContentType `json:"content_type" xml:"content_type"`
	...
	Type *CreateLiveDataApiScriptV2ResponseType `json:"type,omitempty" xml:"type"`

	// 后端API状态： - 1：待开发 - 3：开发中 - 4：已部署
	Status *CreateLiveDataApiScriptV2ResponseStatus `json:"status,omitempty" xml:"status"`
