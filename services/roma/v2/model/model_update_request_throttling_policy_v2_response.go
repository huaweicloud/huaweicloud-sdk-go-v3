...
type UpdateRequestThrottlingPolicyV2Response struct {
	...
	// 流控的时间单位
	TimeUnit UpdateRequestThrottlingPolicyV2ResponseTimeUnit `json:"time_unit" xml:"time_unit"`
	...
	Type *UpdateRequestThrottlingPolicyV2ResponseType `json:"type,omitempty" xml:"type"`
	...
	IsIncluSpecialThrottle *UpdateRequestThrottlingPolicyV2ResponseIsIncluSpecialThrottle `json:"is_inclu_special_throttle,omitempty" xml:"is_inclu_special_throttle"`
