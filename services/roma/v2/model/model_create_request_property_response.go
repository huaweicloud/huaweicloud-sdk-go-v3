...
type CreateRequestPropertyResponse struct {
	...
	DataType *CreateRequestPropertyResponseDataType `json:"data_type,omitempty" xml:"data_type"`

	// 是否必填 0-非必填 1-必填
	Required *CreateRequestPropertyResponseRequired `json:"required,omitempty" xml:"required"`
...
func (c CreateRequestPropertyResponseDataType) Value() string {
	return c.value
}
...
func (c CreateRequestPropertyResponseRequired) Value() int32 {
	return c.value
}
