...
type VpcChannelInfo struct {
	...
	BalanceStrategy VpcChannelInfoBalanceStrategy `json:"balance_strategy" xml:"balance_strategy"`

	// VPC通道的成员类型。[site场景必须修改成IP类型](tag:Site) - ip - ecs
	MemberType VpcChannelInfoMemberType `json:"member_type" xml:"member_type"`
