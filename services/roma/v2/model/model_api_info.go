...
type ApiInfo struct {
	...
	Type ApiInfoType `json:"type" xml:"type"`

	// API的版本
	Version *string `json:"version,omitempty" xml:"version"`

	// API的请求协议 - HTTP - HTTPS - BOTH：同时支持HTTP和HTTPS
	ReqProtocol ApiInfoReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// API的请求方式
	ReqMethod ApiInfoReqMethod `json:"req_method" xml:"req_method"`
	...
	AuthType ApiInfoAuthType `json:"auth_type" xml:"auth_type"`
	...
	MatchMode *ApiInfoMatchMode `json:"match_mode,omitempty" xml:"match_mode"`

	// 后端类型[，site暂不支持函数工作流。](tag:Site) - HTTP：web后端 - FUNCTION：函数工作流 - MOCK：模拟的后端
	BackendType ApiInfoBackendType `json:"backend_type" xml:"backend_type"`
	...
	ContentType *ApiInfoContentType `json:"content_type,omitempty" xml:"content_type"`

	// API编号
	Id *string `json:"id,omitempty" xml:"id"`

	// API状态   - 1： 有效
	Status *ApiInfoStatus `json:"status,omitempty" xml:"status"`
