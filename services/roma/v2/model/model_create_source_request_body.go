...
type CreateSourceRequestBody struct {
	...
	IsBase64 *CreateSourceRequestBodyIsBase64 `json:"is_base64,omitempty" xml:"is_base64"`

	// 是否包含设备信息是否包含设备信息，0-是 1-否
	ContainDeviceInfo *CreateSourceRequestBodyContainDeviceInfo `json:"contain_device_info,omitempty" xml:"contain_device_info"`
}
