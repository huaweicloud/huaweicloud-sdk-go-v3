...
type ListApiVersionDetailV2Response struct {
	...
	Type ListApiVersionDetailV2ResponseType `json:"type" xml:"type"`

	// API的版本
	Version *string `json:"version,omitempty" xml:"version"`

	// API的请求协议 - HTTP - HTTPS - BOTH：同时支持HTTP和HTTPS
	ReqProtocol ListApiVersionDetailV2ResponseReqProtocol `json:"req_protocol" xml:"req_protocol"`

	// API的请求方式
	ReqMethod ListApiVersionDetailV2ResponseReqMethod `json:"req_method" xml:"req_method"`
	...
	AuthType ListApiVersionDetailV2ResponseAuthType `json:"auth_type" xml:"auth_type"`
	...
	MatchMode *ListApiVersionDetailV2ResponseMatchMode `json:"match_mode,omitempty" xml:"match_mode"`

	// 后端类型[，site暂不支持函数工作流。](tag:Site) - HTTP：web后端 - FUNCTION：函数工作流 - MOCK：模拟的后端
	BackendType ListApiVersionDetailV2ResponseBackendType `json:"backend_type" xml:"backend_type"`
	...
	ContentType *ListApiVersionDetailV2ResponseContentType `json:"content_type,omitempty" xml:"content_type"`

	// API编号
	Id *string `json:"id,omitempty" xml:"id"`

	// API状态   - 1： 有效
	Status *ListApiVersionDetailV2ResponseStatus `json:"status,omitempty" xml:"status"`
	...
	// 系统默认分配的子域名
	SlDomain *string `json:"sl_domain,omitempty" xml:"sl_domain"`
