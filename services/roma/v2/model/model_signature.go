...
type Signature struct {
	...
	SignType *SignatureSignType `json:"sign_type,omitempty" xml:"sign_type"`
	...
	SignAlgorithm *SignatureSignAlgorithm `json:"sign_algorithm,omitempty" xml:"sign_algorithm"`
