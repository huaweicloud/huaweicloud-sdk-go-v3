...
type UpdateHealthCheckResponse struct {
	...
	Protocol UpdateHealthCheckResponseProtocol `json:"protocol" xml:"protocol"`

	// 健康检查时的目标路径。protocol = http或https时必选
	Path *string `json:"path,omitempty" xml:"path"`

	// 健康检查时的请求方法
	Method *UpdateHealthCheckResponseMethod `json:"method,omitempty" xml:"method"`
	...
	// 健康检查状态   - 1：可用   - 2：不可用
	Status *UpdateHealthCheckResponseStatus `json:"status,omitempty" xml:"status"`
