...
type BaseSignature struct {
	...
	SignType *BaseSignatureSignType `json:"sign_type,omitempty" xml:"sign_type"`
	...
	SignAlgorithm *BaseSignatureSignAlgorithm `json:"sign_algorithm,omitempty" xml:"sign_algorithm"`
}
