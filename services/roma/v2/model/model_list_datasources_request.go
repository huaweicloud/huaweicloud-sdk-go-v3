...
type ListDatasourcesRequest struct {
	...
	DatasourceType *ListDatasourcesRequestDatasourceType `json:"datasource_type,omitempty" xml:"datasource_type"`

	// 排序字段（CREATED_DATE）
	SortField *string `json:"sort_field,omitempty" xml:"sort_field"`

	// 查询数据源排序的类型，增序还是降序，可为空
	SortType *ListDatasourcesRequestSortType `json:"sort_type,omitempty" xml:"sort_type"`
