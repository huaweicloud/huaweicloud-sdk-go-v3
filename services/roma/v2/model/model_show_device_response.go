...
type ShowDeviceResponse struct {
	...
	// 设备状态 0-启用 1-禁用
	Status *ShowDeviceResponseStatus `json:"status,omitempty" xml:"status"`

	// 是否在线 0-未连接 1-在线 2-离线
	OnlineStatus *ShowDeviceResponseOnlineStatus `json:"online_status,omitempty" xml:"online_status"`
	...
	DeviceType *ShowDeviceResponseDeviceType `json:"device_type,omitempty" xml:"device_type"`
	...
	PluginId *ShowDeviceResponsePluginId `json:"plugin_id,omitempty" xml:"plugin_id"`
