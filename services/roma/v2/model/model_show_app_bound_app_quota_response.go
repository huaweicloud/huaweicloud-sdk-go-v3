...
type ShowAppBoundAppQuotaResponse struct {
	...
	TimeUnit *ShowAppBoundAppQuotaResponseTimeUnit `json:"time_unit,omitempty" xml:"time_unit"`
	...
	// 配额策略已绑定应用数量
	BoundAppNum    *int32 `json:"bound_app_num,omitempty" xml:"bound_app_num"`
...
func (c ShowAppBoundAppQuotaResponseTimeUnit) Value() string {
	return c.value
}
