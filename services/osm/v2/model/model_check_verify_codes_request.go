...
type CheckVerifyCodesRequest struct {
	...
	Body *VerifyVerifyCodeV2Req `json:"body,omitempty" xml:"body"`
}

func (o CheckVerifyCodesRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CheckVerifyCodesRequest struct{}"
	}

	return strings.Join([]string{"CheckVerifyCodesRequest", string(data)}, " ")
}
