...
func (o ListAccessoryAccessUrlsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListAccessoryAccessUrlsRequest struct{}"
	}

	return strings.Join([]string{"ListAccessoryAccessUrlsRequest", string(data)}, " ")
}
