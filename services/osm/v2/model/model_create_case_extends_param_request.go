...
func (o CreateCaseExtendsParamRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateCaseExtendsParamRequest struct{}"
	}

	return strings.Join([]string{"CreateCaseExtendsParamRequest", string(data)}, " ")
}
