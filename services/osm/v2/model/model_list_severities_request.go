...
type ListSeveritiesRequest struct {
	...
	// 产品类型id
	ProductCategoryId string `json:"product_category_id" xml:"product_category_id"`
...
func (o ListSeveritiesRequest) String() string {
	...
	if err != nil {
		return "ListSeveritiesRequest struct{}"
	}

	return strings.Join([]string{"ListSeveritiesRequest", string(data)}, " ")
}
