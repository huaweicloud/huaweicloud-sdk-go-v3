...
func (o ListCaseOperateLogsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListCaseOperateLogsRequest struct{}"
	}

	return strings.Join([]string{"ListCaseOperateLogsRequest", string(data)}, " ")
}
