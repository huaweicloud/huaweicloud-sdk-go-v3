...
func (o SignPublishedAgreementRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SignPublishedAgreementRequest struct{}"
	}

	return strings.Join([]string{"SignPublishedAgreementRequest", string(data)}, " ")
}
