...
func (o UpdateCaseContactInfoRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateCaseContactInfoRequest struct{}"
	}

	return strings.Join([]string{"UpdateCaseContactInfoRequest", string(data)}, " ")
}
