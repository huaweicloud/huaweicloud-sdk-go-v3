...
func (o ListCustomersRegionsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListCustomersRegionsRequest struct{}"
	}

	return strings.Join([]string{"ListCustomersRegionsRequest", string(data)}, " ")
}
