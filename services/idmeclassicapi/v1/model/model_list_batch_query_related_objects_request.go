...
func (o ListBatchQueryRelatedObjectsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListBatchQueryRelatedObjectsRequest struct{}"
	}

	return strings.Join([]string{"ListBatchQueryRelatedObjectsRequest", string(data)}, " ")
}
