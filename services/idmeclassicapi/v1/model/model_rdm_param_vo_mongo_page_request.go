...
type RdmParamVoMongoPageRequest struct {
	...
	Params *MongoPageRequest `json:"params"`
}

func (o RdmParamVoMongoPageRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RdmParamVoMongoPageRequest struct{}"
	}

	return strings.Join([]string{"RdmParamVoMongoPageRequest", string(data)}, " ")
}
