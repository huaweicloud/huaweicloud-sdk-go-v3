...
func (o MultiViewModelMasterViewDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "MultiViewModelMasterViewDto struct{}"
	}

	return strings.Join([]string{"MultiViewModelMasterViewDto", string(data)}, " ")
}
