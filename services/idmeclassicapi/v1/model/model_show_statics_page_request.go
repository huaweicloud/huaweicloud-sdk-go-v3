...
// ShowStaticsPageRequest Request Object
type ShowStaticsPageRequest struct {
...
func (o ShowStaticsPageRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowStaticsPageRequest struct{}"
	}

	return strings.Join([]string{"ShowStaticsPageRequest", string(data)}, " ")
}
