...
type ConfigAlarmTopicRequest struct {
	...
	// CPU告警阈值(%)
	AlarmCpu *int32 `json:"alarm_cpu,omitempty"`

	// 磁盘告警阈值(%)
	AlarmDisk *int32 `json:"alarm_disk,omitempty"`

	// 内存告警阈值(%)
	AlarmMemory *int32 `json:"alarm_memory,omitempty"`

	// 每天发送告警总条数
	AlarmNum *int32 `json:"alarm_num,omitempty"`
