...
type AlarmLogResponseNewAlarmLog struct {
...
func (o AlarmLogResponseNewAlarmLog) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AlarmLogResponseNewAlarmLog struct{}"
	}

	return strings.Join([]string{"AlarmLogResponseNewAlarmLog", string(data)}, " ")
}
