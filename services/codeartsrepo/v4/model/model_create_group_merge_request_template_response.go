...
// CreateGroupMergeRequestTemplateResponse Response Object
type CreateGroupMergeRequestTemplateResponse struct {
...
func (o CreateGroupMergeRequestTemplateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateGroupMergeRequestTemplateResponse struct{}"
	}

	return strings.Join([]string{"CreateGroupMergeRequestTemplateResponse", string(data)}, " ")
}
