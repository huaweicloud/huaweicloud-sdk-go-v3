...
// UpdateProjectReviewSettingsRequest Request Object
type UpdateProjectReviewSettingsRequest struct {
...
func (o UpdateProjectReviewSettingsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProjectReviewSettingsRequest struct{}"
	}

	return strings.Join([]string{"UpdateProjectReviewSettingsRequest", string(data)}, " ")
}
