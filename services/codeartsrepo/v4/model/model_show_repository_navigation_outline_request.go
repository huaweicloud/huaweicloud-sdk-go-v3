...
// ShowRepositoryNavigationOutlineRequest Request Object
type ShowRepositoryNavigationOutlineRequest struct {
...
func (o ShowRepositoryNavigationOutlineRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowRepositoryNavigationOutlineRequest struct{}"
	}

	return strings.Join([]string{"ShowRepositoryNavigationOutlineRequest", string(data)}, " ")
}
