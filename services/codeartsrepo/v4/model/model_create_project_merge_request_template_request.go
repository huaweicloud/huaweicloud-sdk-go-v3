...
// CreateProjectMergeRequestTemplateRequest Request Object
type CreateProjectMergeRequestTemplateRequest struct {
...
func (o CreateProjectMergeRequestTemplateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateProjectMergeRequestTemplateRequest struct{}"
	}

	return strings.Join([]string{"CreateProjectMergeRequestTemplateRequest", string(data)}, " ")
}
