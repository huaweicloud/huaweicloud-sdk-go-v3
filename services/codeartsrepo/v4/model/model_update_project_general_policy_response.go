...
// UpdateProjectGeneralPolicyResponse Response Object
type UpdateProjectGeneralPolicyResponse struct {
...
func (o UpdateProjectGeneralPolicyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProjectGeneralPolicyResponse struct{}"
	}

	return strings.Join([]string{"UpdateProjectGeneralPolicyResponse", string(data)}, " ")
}
