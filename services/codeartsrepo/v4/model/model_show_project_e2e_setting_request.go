...
// ShowProjectE2eSettingRequest Request Object
type ShowProjectE2eSettingRequest struct {
...
func (o ShowProjectE2eSettingRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProjectE2eSettingRequest struct{}"
	}

	return strings.Join([]string{"ShowProjectE2eSettingRequest", string(data)}, " ")
}
