...
// TransferRepositoryResponse Response Object
type TransferRepositoryResponse struct {
	...
	DevelopMode *TransferRepositoryResponseDevelopMode `json:"develop_mode,omitempty"`
	...
	EncryptionStatus *TransferRepositoryResponseEncryptionStatus `json:"encryption_status,omitempty"`
...
func (o TransferRepositoryResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "TransferRepositoryResponse struct{}"
	}

	return strings.Join([]string{"TransferRepositoryResponse", string(data)}, " ")
}

type TransferRepositoryResponseDevelopMode struct {
	value string
}

type TransferRepositoryResponseDevelopModeEnum struct {
	NORMAL TransferRepositoryResponseDevelopMode
	CR     TransferRepositoryResponseDevelopMode
}

func GetTransferRepositoryResponseDevelopModeEnum() TransferRepositoryResponseDevelopModeEnum {
	return TransferRepositoryResponseDevelopModeEnum{
		NORMAL: TransferRepositoryResponseDevelopMode{
			value: "normal",
		},
		CR: TransferRepositoryResponseDevelopMode{
...
func (c TransferRepositoryResponseDevelopMode) Value() string {
	return c.value
}

func (c TransferRepositoryResponseDevelopMode) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *TransferRepositoryResponseDevelopMode) UnmarshalJSON(b []byte) error {
...
type TransferRepositoryResponseEncryptionStatus struct {
	value string
}

type TransferRepositoryResponseEncryptionStatusEnum struct {
	ENCRYPTING TransferRepositoryResponseEncryptionStatus
	ENCRYPTED  TransferRepositoryResponseEncryptionStatus
	DECRYPTING TransferRepositoryResponseEncryptionStatus
	DECRYPTED  TransferRepositoryResponseEncryptionStatus
}

func GetTransferRepositoryResponseEncryptionStatusEnum() TransferRepositoryResponseEncryptionStatusEnum {
	return TransferRepositoryResponseEncryptionStatusEnum{
		ENCRYPTING: TransferRepositoryResponseEncryptionStatus{
			value: "encrypting",
		},
		ENCRYPTED: TransferRepositoryResponseEncryptionStatus{
...
func (c TransferRepositoryResponseEncryptionStatus) Value() string {
	return c.value
}

func (c TransferRepositoryResponseEncryptionStatus) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *TransferRepositoryResponseEncryptionStatus) UnmarshalJSON(b []byte) error {
	myConverter := converter.StringConverterFactory("string")
	if myConverter == nil {
		return errors.New("unsupported StringConverter type: string")
	}
