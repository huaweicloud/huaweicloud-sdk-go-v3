...
// AddRepositoryWebhookResponse Response Object
type AddRepositoryWebhookResponse struct {
...
func (o AddRepositoryWebhookResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AddRepositoryWebhookResponse struct{}"
	}

	return strings.Join([]string{"AddRepositoryWebhookResponse", string(data)}, " ")
}
