...
// UpdateProjectWatermarkRequest Request Object
type UpdateProjectWatermarkRequest struct {
...
func (o UpdateProjectWatermarkRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProjectWatermarkRequest struct{}"
	}

	return strings.Join([]string{"UpdateProjectWatermarkRequest", string(data)}, " ")
}
