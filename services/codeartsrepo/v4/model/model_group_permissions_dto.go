...
// GroupPermissionsDto current user group permission
type GroupPermissionsDto struct {
...
func (o GroupPermissionsDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "GroupPermissionsDto struct{}"
	}

	return strings.Join([]string{"GroupPermissionsDto", string(data)}, " ")
}
