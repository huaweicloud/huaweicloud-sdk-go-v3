...
// ShowProjectsGeneralPolicyRequest Request Object
type ShowProjectsGeneralPolicyRequest struct {
...
func (o ShowProjectsGeneralPolicyRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProjectsGeneralPolicyRequest struct{}"
	}

	return strings.Join([]string{"ShowProjectsGeneralPolicyRequest", string(data)}, " ")
}
