...
// UpdateRepositoryLabelResponse Response Object
...
func (o UpdateRepositoryLabelResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateRepositoryLabelResponse struct{}"
	}

	return strings.Join([]string{"UpdateRepositoryLabelResponse", string(data)}, " ")
}
