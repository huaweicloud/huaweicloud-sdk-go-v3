...
// AssociateRemoteMirrorResponse Response Object
type AssociateRemoteMirrorResponse struct {
...
func (o AssociateRemoteMirrorResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AssociateRemoteMirrorResponse struct{}"
	}

	return strings.Join([]string{"AssociateRemoteMirrorResponse", string(data)}, " ")
}
