...
// RefEntryDto **参数解释：** 代码导航定义相关信息
type RefEntryDto struct {
...
func (o RefEntryDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RefEntryDto struct{}"
	}

	return strings.Join([]string{"RefEntryDto", string(data)}, " ")
}
