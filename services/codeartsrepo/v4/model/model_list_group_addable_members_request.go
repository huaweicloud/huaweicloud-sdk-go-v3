...
// ListGroupAddableMembersRequest Request Object
type ListGroupAddableMembersRequest struct {
...
func (o ListGroupAddableMembersRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListGroupAddableMembersRequest struct{}"
	}

	return strings.Join([]string{"ListGroupAddableMembersRequest", string(data)}, " ")
}
