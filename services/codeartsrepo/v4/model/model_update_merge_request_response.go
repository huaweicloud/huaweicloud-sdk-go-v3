...
// UpdateMergeRequestResponse Response Object
type UpdateMergeRequestResponse struct {
	...
	// 合并请求模式
	ReviewMode *UpdateMergeRequestResponseReviewMode `json:"review_mode,omitempty"`
...
func (o UpdateMergeRequestResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateMergeRequestResponse struct{}"
	}

	return strings.Join([]string{"UpdateMergeRequestResponse", string(data)}, " ")
}

type UpdateMergeRequestResponseReviewMode struct {
	value string
}

type UpdateMergeRequestResponseReviewModeEnum struct {
	VOTE     UpdateMergeRequestResponseReviewMode
	APPROVAL UpdateMergeRequestResponseReviewMode
}

func GetUpdateMergeRequestResponseReviewModeEnum() UpdateMergeRequestResponseReviewModeEnum {
	return UpdateMergeRequestResponseReviewModeEnum{
		VOTE: UpdateMergeRequestResponseReviewMode{
			value: "vote",
		},
		APPROVAL: UpdateMergeRequestResponseReviewMode{
...
func (c UpdateMergeRequestResponseReviewMode) Value() string {
	return c.value
}

func (c UpdateMergeRequestResponseReviewMode) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *UpdateMergeRequestResponseReviewMode) UnmarshalJSON(b []byte) error {
