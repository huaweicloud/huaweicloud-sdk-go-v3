...
// UpdateProjectGeneralPolicyRequest Request Object
type UpdateProjectGeneralPolicyRequest struct {
...
func (o UpdateProjectGeneralPolicyRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProjectGeneralPolicyRequest struct{}"
	}

	return strings.Join([]string{"UpdateProjectGeneralPolicyRequest", string(data)}, " ")
}
