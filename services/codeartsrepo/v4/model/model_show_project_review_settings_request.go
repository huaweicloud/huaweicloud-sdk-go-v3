...
// ShowProjectReviewSettingsRequest Request Object
type ShowProjectReviewSettingsRequest struct {
...
func (o ShowProjectReviewSettingsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProjectReviewSettingsRequest struct{}"
	}

	return strings.Join([]string{"ShowProjectReviewSettingsRequest", string(data)}, " ")
}
