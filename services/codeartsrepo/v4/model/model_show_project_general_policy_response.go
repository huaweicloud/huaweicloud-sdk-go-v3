...
// ShowProjectGeneralPolicyResponse Response Object
type ShowProjectGeneralPolicyResponse struct {
...
func (o ShowProjectGeneralPolicyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProjectGeneralPolicyResponse struct{}"
	}

	return strings.Join([]string{"ShowProjectGeneralPolicyResponse", string(data)}, " ")
}
