...
// UpdateGroupGeneralPolicyResponse Response Object
type UpdateGroupGeneralPolicyResponse struct {
...
func (o UpdateGroupGeneralPolicyResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateGroupGeneralPolicyResponse struct{}"
	}

	return strings.Join([]string{"UpdateGroupGeneralPolicyResponse", string(data)}, " ")
}
