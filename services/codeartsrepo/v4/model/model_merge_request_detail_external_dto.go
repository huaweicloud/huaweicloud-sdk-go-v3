...
type MergeRequestDetailExternalDto struct {
	...
	// 合并请求模式
	ReviewMode *MergeRequestDetailExternalDtoReviewMode `json:"review_mode,omitempty"`
...
func (o MergeRequestDetailExternalDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "MergeRequestDetailExternalDto struct{}"
	}

	return strings.Join([]string{"MergeRequestDetailExternalDto", string(data)}, " ")
}

type MergeRequestDetailExternalDtoReviewMode struct {
	value string
}

type MergeRequestDetailExternalDtoReviewModeEnum struct {
	VOTE     MergeRequestDetailExternalDtoReviewMode
	APPROVAL MergeRequestDetailExternalDtoReviewMode
}

func GetMergeRequestDetailExternalDtoReviewModeEnum() MergeRequestDetailExternalDtoReviewModeEnum {
	return MergeRequestDetailExternalDtoReviewModeEnum{
		VOTE: MergeRequestDetailExternalDtoReviewMode{
			value: "vote",
		},
		APPROVAL: MergeRequestDetailExternalDtoReviewMode{
...
func (c MergeRequestDetailExternalDtoReviewMode) Value() string {
	return c.value
}

func (c MergeRequestDetailExternalDtoReviewMode) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *MergeRequestDetailExternalDtoReviewMode) UnmarshalJSON(b []byte) error {
