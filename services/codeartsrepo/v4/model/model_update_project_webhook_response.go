...
// UpdateProjectWebhookResponse Response Object
...
func (o UpdateProjectWebhookResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProjectWebhookResponse struct{}"
	}

	return strings.Join([]string{"UpdateProjectWebhookResponse", string(data)}, " ")
}
