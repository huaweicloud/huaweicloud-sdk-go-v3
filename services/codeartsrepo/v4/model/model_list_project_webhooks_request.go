...
// ListProjectWebhooksRequest Request Object
type ListProjectWebhooksRequest struct {
...
func (o ListProjectWebhooksRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListProjectWebhooksRequest struct{}"
	}

	return strings.Join([]string{"ListProjectWebhooksRequest", string(data)}, " ")
}
