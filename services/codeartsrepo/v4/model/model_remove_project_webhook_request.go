...
// RemoveProjectWebhookRequest Request Object
type RemoveProjectWebhookRequest struct {
...
func (o RemoveProjectWebhookRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "RemoveProjectWebhookRequest struct{}"
	}

	return strings.Join([]string{"RemoveProjectWebhookRequest", string(data)}, " ")
}
