...
// MergeMergeRequestResponse Response Object
type MergeMergeRequestResponse struct {
	...
	// 合并请求模式
	ReviewMode *MergeMergeRequestResponseReviewMode `json:"review_mode,omitempty"`
...
func (o MergeMergeRequestResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "MergeMergeRequestResponse struct{}"
	}

	return strings.Join([]string{"MergeMergeRequestResponse", string(data)}, " ")
}

type MergeMergeRequestResponseReviewMode struct {
	value string
}

type MergeMergeRequestResponseReviewModeEnum struct {
	VOTE     MergeMergeRequestResponseReviewMode
	APPROVAL MergeMergeRequestResponseReviewMode
}

func GetMergeMergeRequestResponseReviewModeEnum() MergeMergeRequestResponseReviewModeEnum {
	return MergeMergeRequestResponseReviewModeEnum{
		VOTE: MergeMergeRequestResponseReviewMode{
			value: "vote",
		},
		APPROVAL: MergeMergeRequestResponseReviewMode{
...
func (c MergeMergeRequestResponseReviewMode) Value() string {
	return c.value
}

func (c MergeMergeRequestResponseReviewMode) MarshalJSON() ([]byte, error) {
	return utils.Marshal(c.value)
}

func (c *MergeMergeRequestResponseReviewMode) UnmarshalJSON(b []byte) error {
