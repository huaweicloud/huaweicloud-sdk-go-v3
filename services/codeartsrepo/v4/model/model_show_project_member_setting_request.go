...
// ShowProjectMemberSettingRequest Request Object
type ShowProjectMemberSettingRequest struct {
...
func (o ShowProjectMemberSettingRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProjectMemberSettingRequest struct{}"
	}

	return strings.Join([]string{"ShowProjectMemberSettingRequest", string(data)}, " ")
}
