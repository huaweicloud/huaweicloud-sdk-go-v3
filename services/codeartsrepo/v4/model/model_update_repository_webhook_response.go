...
// UpdateRepositoryWebhookResponse Response Object
type UpdateRepositoryWebhookResponse struct {
...
func (o UpdateRepositoryWebhookResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateRepositoryWebhookResponse struct{}"
	}

	return strings.Join([]string{"UpdateRepositoryWebhookResponse", string(data)}, " ")
}
