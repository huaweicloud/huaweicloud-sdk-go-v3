...
// UpdateRepositoryGeneralCommitRuleResponse Response Object
type UpdateRepositoryGeneralCommitRuleResponse struct {
...
func (o UpdateRepositoryGeneralCommitRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateRepositoryGeneralCommitRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateRepositoryGeneralCommitRuleResponse", string(data)}, " ")
}
