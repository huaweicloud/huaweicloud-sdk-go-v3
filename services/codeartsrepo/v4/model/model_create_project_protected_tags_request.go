...
// CreateProjectProtectedTagsRequest Request Object
type CreateProjectProtectedTagsRequest struct {
	...
	Body *ProjectProtectedTagDto `json:"body,omitempty"`
}

func (o CreateProjectProtectedTagsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateProjectProtectedTagsRequest struct{}"
	}

	return strings.Join([]string{"CreateProjectProtectedTagsRequest", string(data)}, " ")
}
