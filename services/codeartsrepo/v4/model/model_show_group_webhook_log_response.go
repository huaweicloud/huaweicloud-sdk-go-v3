...
// ShowGroupWebhookLogResponse Response Object
type ShowGroupWebhookLogResponse struct {
...
func (o ShowGroupWebhookLogResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowGroupWebhookLogResponse struct{}"
	}

	return strings.Join([]string{"ShowGroupWebhookLogResponse", string(data)}, " ")
}
