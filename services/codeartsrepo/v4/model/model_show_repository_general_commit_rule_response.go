...
// ShowRepositoryGeneralCommitRuleResponse Response Object
type ShowRepositoryGeneralCommitRuleResponse struct {
...
func (o ShowRepositoryGeneralCommitRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowRepositoryGeneralCommitRuleResponse struct{}"
	}

	return strings.Join([]string{"ShowRepositoryGeneralCommitRuleResponse", string(data)}, " ")
}
