...
// ShowProjectWatermarkRequest Request Object
type ShowProjectWatermarkRequest struct {
...
func (o ShowProjectWatermarkRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProjectWatermarkRequest struct{}"
	}

	return strings.Join([]string{"ShowProjectWatermarkRequest", string(data)}, " ")
}
