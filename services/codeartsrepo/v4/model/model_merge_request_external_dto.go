...
type MergeRequestExternalDto struct {
...
func (o MergeRequestExternalDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "MergeRequestExternalDto struct{}"
	}

	return strings.Join([]string{"MergeRequestExternalDto", string(data)}, " ")
}
