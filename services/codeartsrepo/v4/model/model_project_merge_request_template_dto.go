...
// ProjectMergeRequestTemplateDto 仓库合并请求模板返回体
type ProjectMergeRequestTemplateDto struct {
...
func (o ProjectMergeRequestTemplateDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ProjectMergeRequestTemplateDto struct{}"
	}

	return strings.Join([]string{"ProjectMergeRequestTemplateDto", string(data)}, " ")
}
