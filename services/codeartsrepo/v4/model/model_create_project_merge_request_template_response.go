...
// CreateProjectMergeRequestTemplateResponse Response Object
type CreateProjectMergeRequestTemplateResponse struct {
...
func (o CreateProjectMergeRequestTemplateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateProjectMergeRequestTemplateResponse struct{}"
	}

	return strings.Join([]string{"CreateProjectMergeRequestTemplateResponse", string(data)}, " ")
}
