...
// CreateSkillResponse Response Object
...
func (o CreateSkillResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateSkillResponse struct{}"
	}

	return strings.Join([]string{"CreateSkillResponse", string(data)}, " ")
}
