...
// ShowSkillResp 查询企业自研技能详情响应（结构同 ShowCommonSkillResp，owner_type 为 TENANT）。
type ShowSkillResp struct {
...
func (o ShowSkillResp) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowSkillResp struct{}"
	}

	return strings.Join([]string{"ShowSkillResp", string(data)}, " ")
}
