...
// UpdateSkillResponse Response Object
...
func (o UpdateSkillResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateSkillResponse struct{}"
	}

	return strings.Join([]string{"UpdateSkillResponse", string(data)}, " ")
}
