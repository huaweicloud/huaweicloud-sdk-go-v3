...
// ExportDesktopUsageMetricNewRequest Request Object
type ExportDesktopUsageMetricNewRequest struct {
...
func (o ExportDesktopUsageMetricNewRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ExportDesktopUsageMetricNewRequest struct{}"
	}

	return strings.Join([]string{"ExportDesktopUsageMetricNewRequest", string(data)}, " ")
}
