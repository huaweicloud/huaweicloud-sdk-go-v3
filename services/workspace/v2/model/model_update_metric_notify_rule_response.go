...
func (o UpdateMetricNotifyRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateMetricNotifyRuleResponse struct{}"
	}

	return strings.Join([]string{"UpdateMetricNotifyRuleResponse", string(data)}, " ")
}
