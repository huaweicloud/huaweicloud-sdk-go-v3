...
// ShowSkillResponse Response Object
...
func (o ShowSkillResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowSkillResponse struct{}"
	}

	return strings.Join([]string{"ShowSkillResponse", string(data)}, " ")
}
