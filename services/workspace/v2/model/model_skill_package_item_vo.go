...
// SkillPackageItemVo 技能包列表项响应。
type SkillPackageItemVo struct {
...
func (o SkillPackageItemVo) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SkillPackageItemVo struct{}"
	}

	return strings.Join([]string{"SkillPackageItemVo", string(data)}, " ")
}
