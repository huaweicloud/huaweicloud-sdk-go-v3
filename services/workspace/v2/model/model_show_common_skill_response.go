...
// ShowCommonSkillResponse Response Object
type ShowCommonSkillResponse struct {
...
func (o ShowCommonSkillResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowCommonSkillResponse struct{}"
	}

	return strings.Join([]string{"ShowCommonSkillResponse", string(data)}, " ")
}
