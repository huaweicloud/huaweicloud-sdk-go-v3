...
// ShowProviderResponse Response Object
type ShowProviderResponse struct {
...
func (o ShowProviderResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProviderResponse struct{}"
	}

	return strings.Join([]string{"ShowProviderResponse", string(data)}, " ")
}
