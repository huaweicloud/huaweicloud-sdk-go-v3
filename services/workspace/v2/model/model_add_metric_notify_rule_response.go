...
func (o AddMetricNotifyRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AddMetricNotifyRuleResponse struct{}"
	}

	return strings.Join([]string{"AddMetricNotifyRuleResponse", string(data)}, " ")
}
