...
func GenReqDefForExportIpTemplate() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/ip/template/download").
		WithResponse(new(model.ExportIpTemplateResponse)).
		WithContentType("application/json")
...
func GenReqDefForImportIp() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/ip/import").
		WithResponse(new(model.ImportIpResponse)).
...
func GenReqDefForListAgentInstances() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/instances").
		WithResponse(new(model.ListAgentInstancesResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("AiAgentType").
		WithJsonTag("ai_agent_type").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("RegionId").
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DesktopStatus").
		WithJsonTag("desktop_status").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DesktopConnection").
		WithJsonTag("desktop_connection").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ModelGroupId").
		WithJsonTag("model_group_id").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ChannelConfigStatus").
		WithJsonTag("channel_config_status").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ModelConfigStatus").
		WithJsonTag("model_config_status").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
...
func GenReqDefForListInstanceModelGroups() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/instances/{instance_id}/model-groups").
		WithResponse(new(model.ListInstanceModelGroupsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListInstanceStatistics() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/instances/statistics").
...
func GenReqDefForListSubscribeAiAssistantUsers() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/users/ai-assistant/subscribe").
		WithResponse(new(model.ListSubscribeAiAssistantUsersResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowAiAssistantUsageFrequency() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/users/ai-assistant/statistics/usage-frequency").
		WithResponse(new(model.ShowAiAssistantUsageFrequencyResponse)).
		WithContentType("application/json")
...
func GenReqDefForSubscribeAiAssistant() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/users/ai-assistant/subscribe").
		WithResponse(new(model.SubscribeAiAssistantResponse)).
		WithContentType("application/json")
...
func GenReqDefForDownloadMetadata() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/auth-config/saml2/metadata").
		WithResponse(new(model.DownloadMetadataResponse)).
		WithContentType("application/json")
...
func GenReqDefForDownloadSpMetadata() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/auth-config/saml2/sp/metadata").
		WithResponse(new(model.DownloadSpMetadataResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("IdentityProvider").
		WithJsonTag("identity_provider").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("AccessServerAddress").
		WithJsonTag("access_server_address").
		WithLocationType(def.Query))
...
func GenReqDefForShowAssistAuthConfig() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("MainAuthConfigId").
		WithJsonTag("main_auth_config_id").
		WithLocationType(def.Query))
...
func GenReqDefForShowAssistAuthConfigApplyObjects() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/assist-auth-config/apply-objects").
		WithResponse(new(model.ShowAssistAuthConfigApplyObjectsResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateAssistAuthConfigApplyObjects() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/assist-auth-config/apply-objects").
		WithResponse(new(model.UpdateAssistAuthConfigApplyObjectsResponse)).
		WithContentType("application/json")
...
func GenReqDefForValidateConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/auth-config/validate-config").
		WithResponse(new(model.ValidateConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateCert() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities").
		WithResponse(new(model.CreateCertResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteCert() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}").
		WithResponse(new(model.DeleteCertResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportCertCrlFile() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}/crl").
		WithResponse(new(model.ExportCertCrlFileResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportCertCsrFile() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/csr").
		WithResponse(new(model.ExportCertCsrFileResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportCertPemFile() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}/export").
		WithResponse(new(model.ExportCertPemFileResponse)).
		WithContentType("application/json")
...
func GenReqDefForImportCert() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/import").
		WithResponse(new(model.ImportCertResponse)).
		WithContentType("application/json")
...
func GenReqDefForSetCertStatus() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}/status/{status}").
		WithResponse(new(model.SetCertStatusResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowCertDetail() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/certmanager/private-certificate-authorities/{cert_id}").
		WithResponse(new(model.ShowCertDetailResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchCheckDesktopRejoinDomain() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/desktops/batch-rejoin-domain/check").
		WithResponse(new(model.BatchCheckDesktopRejoinDomainResponse)).
		WithContentType("application/json")
...
func GenReqDefForCheckDesktopImages() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/desktops/check-images").
		WithResponse(new(model.CheckDesktopImagesResponse)).
		WithContentType("application/json")
...
func GenReqDefForCheckSysprepInfo() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/sysprep").
		WithResponse(new(model.CheckSysprepInfoResponse)).
		WithContentType("application/json")
...
func GenReqDefForListCommonSkills() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/common-skills").
		WithResponse(new(model.ListCommonSkillsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowCommonSkill() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/common-skills/{skill_id}").
		WithResponse(new(model.ShowCommonSkillResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportUserConnectionNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/desktops/connections/export").
		WithResponse(new(model.ExportUserConnectionNewResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("MinE2eRtt").
		WithJsonTag("min_e2e_rtt").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("MaxE2eRtt").
		WithJsonTag("max_e2e_rtt").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("EnterpriseProjectId").
		WithJsonTag("enterprise_project_id").
...
func GenReqDefForBatchUpdateDesktopDomain() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/desktops/batch-rejoin-domain").
		WithResponse(new(model.BatchUpdateDesktopDomainResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportDesktopVersionList() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/desktops/list-by-version/export").
		WithResponse(new(model.ExportDesktopVersionListResponse)).
		WithContentType("application/json")
...
func GenReqDefForListDesktopDetachInfo() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/desktops/{desktop_id}/detach-info").
		WithResponse(new(model.ListDesktopDetachInfoResponse)).
		WithContentType("application/json")
...
func GenReqDefForListDesktopStatisticsByVersion() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/desktops/statistics/by-version").
		WithResponse(new(model.ListDesktopStatisticsByVersionResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Versions").
		WithJsonTag("versions").
		WithLocationType(def.Query))
...
func GenReqDefForListDesktopVersion() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/desktops/list-by-version").
		WithResponse(new(model.ListDesktopVersionResponse)).
		WithContentType("application/json")
...
func GenReqDefForListDesktopsDetail() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ComputerNames").
		WithJsonTag("computer_names").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DesktopIp").
		WithJsonTag("desktop_ip").
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("WithoutAnyTag").
		WithJsonTag("without_any_tag").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("AgentVersion").
		WithJsonTag("agent_version").
...
func GenReqDefForAttachDesktopPoolUser() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/desktop-pools/{pool_id}/attach").
		WithResponse(new(model.AttachDesktopPoolUserResponse)).
		WithContentType("application/json")
...
func GenReqDefForListDesktopPoolsByUsers() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/desktop-pools/statistics/by-users").
		WithResponse(new(model.ListDesktopPoolsByUsersResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("UserIds").
		WithJsonTag("user_ids").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Offset").
		WithJsonTag("offset").
...
func GenReqDefForListInconsistentStatics() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/desktop-pools/{pool_id}/inconsistent-statics").
		WithResponse(new(model.ListInconsistentStaticsResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportDesktopListNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/desktops/export").
		WithResponse(new(model.ExportDesktopListNewResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ConnectionStatusVersion").
		WithJsonTag("connection_status_version").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PoolId").
		WithJsonTag("pool_id").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("IncludePool").
		WithJsonTag("include_pool").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PoolName").
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PoolType").
		WithJsonTag("pool_type").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PoolInMaintenanceMode").
		WithJsonTag("pool_in_maintenance_mode").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PoolEnterpriseProjectId").
		WithJsonTag("pool_enterprise_project_id").
		WithLocationType(def.Query))
...
func GenReqDefForShowHibernateType() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/hibernate-type").
		WithResponse(new(model.ShowHibernateTypeResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteExportTasks() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/export-tasks/batch-delete").
		WithResponse(new(model.DeleteExportTasksResponse)).
...
func GenReqDefForDownloadExportFile() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/export-tasks/{task_id}/download").
		WithResponse(new(model.DownloadExportFileResponse)).
		WithContentType("application/json")
...
func GenReqDefForListExportTasks() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/export-tasks").
...
func GenReqDefForExportUserGroups() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/groups/export").
		WithResponse(new(model.ExportUserGroupsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListUserGroups() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PlatformType").
		WithJsonTag("platform_type").
		WithLocationType(def.Query))
...
func GenReqDefForExportUserGroupUsersNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/groups/{group_id}/users/export").
		WithResponse(new(model.ExportUserGroupUsersNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportHostsDetail() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/hosts/export").
		WithResponse(new(model.ExportHostsDetailResponse)).
		WithContentType("application/json")
...
func GenReqDefForListHostsDetail() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/hosts").
		WithResponse(new(model.ListHostsDetailResponse)).
		WithContentType("application/json")
...
func GenReqDefForListServersByHostId() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/hosts/{host_id}/servers").
		WithResponse(new(model.ListServersByHostIdResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateHosts() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v2/{project_id}/hosts").
		WithResponse(new(model.UpdateHostsResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteImChannel() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/ai-agents/{id}/im-channels/{platform}").
		WithResponse(new(model.DeleteImChannelResponse)).
		WithContentType("application/json")
...
func GenReqDefForListImChannels() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/{id}/im-channels").
		WithResponse(new(model.ListImChannelsResponse)).
		WithContentType("application/json")
...
func GenReqDefForSaveImChannels() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/im-channels").
		WithResponse(new(model.SaveImChannelsResponse)).
		WithContentType("application/json")
...
func GenReqDefForApplyModelConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-configs/apply").
		WithResponse(new(model.ApplyModelConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForRemoveModelConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/ai-agents/model-configs/apply").
		WithResponse(new(model.RemoveModelConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchBindProviders() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-groups/{group_id}/providers/batch").
		WithResponse(new(model.BatchBindProvidersResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchDeleteProviders() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-groups/{group_id}/providers/batch-delete").
		WithResponse(new(model.BatchDeleteProvidersResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateModelGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-groups").
		WithResponse(new(model.CreateModelGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteModelGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/ai-agents/model-groups/{group_id}").
		WithResponse(new(model.DeleteModelGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForListModelGroupProviders() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-groups/{group_id}/providers").
		WithResponse(new(model.ListModelGroupProvidersResponse)).
		WithContentType("application/json")
...
func GenReqDefForListModelGroupResources() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-groups/{group_id}/resources").
		WithResponse(new(model.ListModelGroupResourcesResponse)).
		WithContentType("application/json")
...
func GenReqDefForListModelGroups() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-groups").
		WithResponse(new(model.ListModelGroupsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowModelGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-groups/{group_id}").
		WithResponse(new(model.ShowModelGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateModelGroup() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/ai-agents/model-groups/{group_id}").
		WithResponse(new(model.UpdateModelGroupResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchCreateModel() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-providers/{provider_id}/models/batch").
		WithResponse(new(model.BatchCreateModelResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchDeleteModel() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-providers/{provider_id}/models/batch-delete").
		WithResponse(new(model.BatchDeleteModelResponse)).
		WithContentType("application/json")
...
func GenReqDefForListModels() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-providers/{provider_id}/models").
...
func GenReqDefForShowModel() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-providers/{provider_id}/models/{model_id}").
		WithResponse(new(model.ShowModelResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateModel() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/ai-agents/model-providers/{provider_id}/models/{model_id}").
		WithResponse(new(model.UpdateModelResponse)).
		WithContentType("application/json")
...
func GenReqDefForListSecurityGroups() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/security-groups").
...
func GenReqDefForListSubnets() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/subnets").
...
func GenReqDefForListVpcInfo() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/vpcs").
		WithResponse(new(model.ListVpcInfoResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateResourcePackagesOrder() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/resource-packages/order").
		WithResponse(new(model.CreateResourcePackagesOrderResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreatePolicyTemplate() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/policy-groups/policy-template").
...
func GenReqDefForExportPolicyGroups() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/policy-groups/export").
		WithResponse(new(model.ExportPolicyGroupsResponse)).
		WithContentType("application/json")
...
func GenReqDefForImportPolicyGroups() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/policy-groups/import").
		WithResponse(new(model.ImportPolicyGroupsResponse)).
		WithContentType("multipart/form-data")
...
func GenReqDefForListPolicyGroupInfo() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PolicyGroupNames").
		WithJsonTag("policy_group_names").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Priority").
		WithJsonTag("priority").
...
func GenReqDefForListResourcePackages() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/products/resource-packages").
		WithResponse(new(model.ListResourcePackagesResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateProvider() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-providers").
		WithResponse(new(model.CreateProviderResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteProvider() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/ai-agents/model-providers/{provider_id}").
		WithResponse(new(model.DeleteProviderResponse)).
		WithContentType("application/json")
...
func GenReqDefForListProviderTemplates() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-provider-templates").
		WithResponse(new(model.ListProviderTemplatesResponse)).
		WithContentType("application/json")
...
func GenReqDefForListRemoteProviderModels() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-providers/remote-models/query").
		WithResponse(new(model.ListRemoteProviderModelsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowProvider() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/model-providers/{provider_id}").
		WithResponse(new(model.ShowProviderResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateProvider() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/ai-agents/model-providers/{provider_id}").
		WithResponse(new(model.UpdateProviderResponse)).
		WithContentType("application/json")
...
func GenReqDefForVerifyProvider() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/model-providers/verify").
		WithResponse(new(model.VerifyProviderResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportScheduledTasksRecords() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/scheduled-tasks/{task_id}/records/export").
		WithResponse(new(model.ExportScheduledTasksRecordsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListLifeCycleTypeConfigurations() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/scheduled-tasks/life-cycle-type/configurations").
		WithResponse(new(model.ListLifeCycleTypeConfigurationsResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateUpgradeScheduleTask() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/upgrade-task").
		WithResponse(new(model.CreateUpgradeScheduleTaskResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteUpgradeTask() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/upgrade-task/batch-delete").
		WithResponse(new(model.DeleteUpgradeTaskResponse)).
		WithContentType("application/json")
...
func GenReqDefForExecuteTriggerUpgrade() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/upgrade-task/execute").
		WithResponse(new(model.ExecuteTriggerUpgradeResponse)).
		WithContentType("application/json")
...
func GenReqDefForListTaskApplyObjects() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/upgrade-task/{task_id}/apply-objects").
		WithResponse(new(model.ListTaskApplyObjectsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListUpgradeTasks() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/upgrade-tasks").
		WithResponse(new(model.ListUpgradeTasksResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("IsEnable").
		WithJsonTag("is_enable").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("LastExecuteStatus").
		WithJsonTag("last_execute_status").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Offset").
		WithJsonTag("offset").
...
func GenReqDefForShowUpgradeTaskDetail() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/upgrade-task/{task_id}").
		WithResponse(new(model.ShowUpgradeTaskDetailResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateUpgradeTask() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v2/{project_id}/upgrade-task/{task_id}").
		WithResponse(new(model.UpdateUpgradeTaskResponse)).
		WithContentType("application/json")
...
func GenReqDefForListScreenRecords() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DesktopNames").
		WithJsonTag("desktop_names").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Username").
		WithJsonTag("username").
...
func GenReqDefForListScreenRecordsTrafficLimitConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/screen-records/traffic-limit/configurations").
		WithResponse(new(model.ListScreenRecordsTrafficLimitConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateScreenRecordsTrafficLimitConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/screen-records/traffic-limit/configurations").
		WithResponse(new(model.UpdateScreenRecordsTrafficLimitConfigResponse)).
		WithContentType("application/json;charset=utf-8")
...
func GenReqDefForExecuteScriptByDesktopTag() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/script-executions/by-desktop-tag").
		WithResponse(new(model.ExecuteScriptByDesktopTagResponse)).
		WithContentType("application/json")
...
func GenReqDefForCheckEdgeSiteResources() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/check-edge-site-resources").
		WithResponse(new(model.CheckEdgeSiteResourcesResponse)).
		WithContentType("application/json")
...
func GenReqDefForResetSiteAuthConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/sites/{site_id}/reset-auth-config").
		WithResponse(new(model.ResetSiteAuthConfigResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateDcVnc() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v2/{project_id}/sites/{site_id}/dc-vnc").
		WithResponse(new(model.UpdateDcVncResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateSkillBindings() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skill-bindings").
		WithResponse(new(model.CreateSkillBindingsResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteSkillBindings() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skill-bindings/delete").
		WithResponse(new(model.DeleteSkillBindingsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListCommonSkillResources() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/common-skills/{skill_id}/resources").
		WithResponse(new(model.ListCommonSkillResourcesResponse)).
		WithContentType("application/json")
...
func GenReqDefForListInstanceSkills() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/instances/{instance_id}/skills").
		WithResponse(new(model.ListInstanceSkillsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListSecurityPolicyControlResources() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/security-policy-control/resources").
		WithResponse(new(model.ListSecurityPolicyControlResourcesResponse)).
		WithContentType("application/json")
...
func GenReqDefForListSkillResources() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/skills/{skill_id}/resources").
		WithResponse(new(model.ListSkillResourcesResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateSecurityPolicyControl() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skills/security-policy-control").
		WithResponse(new(model.UpdateSecurityPolicyControlResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchListSkillPackages() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skill-packages/batch-query").
		WithResponse(new(model.BatchListSkillPackagesResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateDownloadUrl() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}/download-url").
		WithResponse(new(model.CreateDownloadUrlResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateSkillPackage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages").
		WithResponse(new(model.CreateSkillPackageResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateUploadUrls() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skill-packages/upload-urls").
		WithResponse(new(model.CreateUploadUrlsResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteSkillPackage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}").
		WithResponse(new(model.DeleteSkillPackageResponse)).
		WithContentType("application/json")
...
func GenReqDefForExpandSkillPackageRegion() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}/regions").
		WithResponse(new(model.ExpandSkillPackageRegionResponse)).
		WithContentType("application/json")
...
func GenReqDefForListCommonSkillPackages() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/common-skills/{skill_id}/packages").
		WithResponse(new(model.ListCommonSkillPackagesResponse)).
		WithContentType("application/json")
...
func GenReqDefForListSkillPackages() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages").
		WithResponse(new(model.ListSkillPackagesResponse)).
		WithContentType("application/json")
...
func GenReqDefForRemoveSkillPackageRegion() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}/regions/delete").
		WithResponse(new(model.RemoveSkillPackageRegionResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowCommonSkillPackage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/common-skills/{skill_id}/packages/{package_id}").
		WithResponse(new(model.ShowCommonSkillPackageResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowSkillPackage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}").
		WithResponse(new(model.ShowSkillPackageResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateSkillPackage() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/ai-agents/skills/{skill_id}/packages/{package_id}").
		WithResponse(new(model.UpdateSkillPackageResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateSkill() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/ai-agents/skills").
		WithResponse(new(model.CreateSkillResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteSkill() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/ai-agents/skills/{skill_id}").
		WithResponse(new(model.DeleteSkillResponse)).
		WithContentType("application/json")
...
func GenReqDefForListSkills() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/skills").
		WithResponse(new(model.ListSkillsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowSkill() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/ai-agents/skills/{skill_id}").
		WithResponse(new(model.ShowSkillResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateSkill() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/ai-agents/skills/{skill_id}").
		WithResponse(new(model.UpdateSkillResponse)).
		WithContentType("application/json")
...
func GenReqDefForListDesktopSnapshot() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("SnapshotNames").
		WithJsonTag("snapshot_names").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DiskType").
...
func GenReqDefForExportAppUserAccessData() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/statistics/metrics/app-user-access/export").
		WithResponse(new(model.ExportAppUserAccessDataResponse)).
		WithContentType("application/json;charset=UTF-8")
...
func GenReqDefForListDesktopsStatistics() *def.HttpRequestDef {
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("DesktopPoolIds").
		WithJsonTag("desktop_pool_ids").
		WithLocationType(def.Query))
...
func GenReqDefForExportDesktopUsageMetricNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/statistics/metrics/desktops/export").
		WithResponse(new(model.ExportDesktopUsageMetricNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportUserUsageMetricNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/statistics/metrics/users/export").
		WithResponse(new(model.ExportUserUsageMetricNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateTenantUpgradeStrategy() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/upgrade-strategy").
		WithResponse(new(model.CreateTenantUpgradeStrategyResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteTenantUpgradeStrategy() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/upgrade-strategy/batch-delete").
		WithResponse(new(model.DeleteTenantUpgradeStrategyResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportTenantUpgradeStrategies() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/upgrade-strategies/export").
		WithResponse(new(model.ExportTenantUpgradeStrategiesResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("StrategyName").
		WithJsonTag("strategy_name").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("StrategyType").
		WithJsonTag("strategy_type").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("IsForceUpgrade").
		WithJsonTag("is_force_upgrade").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Status").
		WithJsonTag("status").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("StrategyPriority").
		WithJsonTag("strategy_priority").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Language").
		WithJsonTag("language").
...
func GenReqDefForListApplyObjects() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/upgrade-strategy/{strategy_id}/apply-objects").
		WithResponse(new(model.ListApplyObjectsResponse)).
		WithContentType("application/json")
...
func GenReqDefForListTenantUpgradeStrategies() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/upgrade-strategies").
		WithResponse(new(model.ListTenantUpgradeStrategiesResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("IsAccurateName").
		WithJsonTag("is_accurate_name").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("StrategyName").
		WithJsonTag("strategy_name").
...
func GenReqDefForUpdateStrategyApplyObjects() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/upgrade-strategy/{strategy_id}/apply-objects").
		WithResponse(new(model.UpdateStrategyApplyObjectsResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateTenantUpgradeStrategy() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v2/{project_id}/upgrade-strategy/{strategy_id}").
		WithResponse(new(model.UpdateTenantUpgradeStrategyResponse)).
		WithContentType("application/json")
...
func GenReqDefForListTenantVersionConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/version-config").
		WithResponse(new(model.ListTenantVersionConfigResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("VersionStatus").
		WithJsonTag("version_status").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PublishTimeBegin").
		WithJsonTag("publish_time_begin").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PublishTimeEnd").
		WithJsonTag("publish_time_end").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("ReleaseNote").
		WithJsonTag("release_note").
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("Offset").
		WithJsonTag("offset").
...
func GenReqDefForShowTenantVersionConfig() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/version-config/{version_config_id}").
		WithResponse(new(model.ShowTenantVersionConfigResponse)).
		WithContentType("application/json")

	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("VersionConfigId").
		WithJsonTag("version_config_id").
		WithLocationType(def.Path))
...
func GenReqDefForExportTerminalsBindingDesktopsTemplate() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/terminals/binding-desktops/template").
		WithResponse(new(model.ExportTerminalsBindingDesktopsTemplateResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportTerminalsBindingDesktopsInfoNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/terminals/binding-desktops/template/export").
		WithResponse(new(model.ExportTerminalsBindingDesktopsInfoNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportUserListTemplate() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/users/desktop-users/template").
		WithResponse(new(model.ExportUserListTemplateResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportUsersTemplate() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v2/{project_id}/users/template/download").
		WithResponse(new(model.ExportUsersTemplateResponse)).
		WithContentType("application/json")
...
func GenReqDefForImportUserList() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/users/desktop-users/action/import").
		WithResponse(new(model.ImportUserListResponse)).
		WithContentType("multipart/form-data")
...
func GenReqDefForExportUserGroupsNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/{project_id}/groups/export").
		WithResponse(new(model.ExportUserGroupsNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportUsersNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/{project_id}/users/export").
		WithResponse(new(model.ExportUsersNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchModifyQosVolumes() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v2/{project_id}/volumes/batch-modify-qos").
		WithResponse(new(model.BatchModifyQosVolumesResponse)).
		WithContentType("application/json")
...
func GenReqDefForCheckEnterpriseId() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v2/{project_id}/workspaces/enterprise-ids/check").
		WithResponse(new(model.CheckEnterpriseIdResponse)).
		WithContentType("application/json")
...
func GenReqDefForCloseDomainNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v3/{project_id}/domains").
		WithResponse(new(model.CloseDomainNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForCreateDomainNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v3/{project_id}/domains").
		WithResponse(new(model.CreateDomainNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowDomainsNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/domains").
		WithResponse(new(model.ShowDomainsNewResponse)).
		WithContentType("application/json")
...
func GenReqDefForSyncExternalUser() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v3/{project_id}/domains/sync-external-user").
		WithResponse(new(model.SyncExternalUserResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpdateDomainNew() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPut).
		WithPath("/v3/{project_id}/domains").
		WithResponse(new(model.UpdateDomainNewResponse)).
		WithContentType("application/json")
