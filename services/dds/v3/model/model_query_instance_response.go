...
type QueryInstanceResponse struct {
	...
	Datastore *DatastoreItem `json:"datastore" xml:"datastore"`
	...
	BackupStrategy *BackupStrategyForItemResponse `json:"backup_strategy" xml:"backup_strategy"`

	// 计费方式。 - 取值为“0”，表示按需计费。 - 取值为“1”，表示包年/包月计费。
	PayMode *string `json:"pay_mode,omitempty" xml:"pay_mode"`

	// 系统可维护时间窗。
	MaintenanceWindow string `json:"maintenance_window" xml:"maintenance_window"`

	// 组信息。
	Groups []GroupResponseItem `json:"groups" xml:"groups"`
