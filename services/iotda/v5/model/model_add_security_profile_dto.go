...
// AddSecurityProfileDto 安全态势感知配置
type AddSecurityProfileDto struct {
...
func (o AddSecurityProfileDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AddSecurityProfileDto struct{}"
	}

	return strings.Join([]string{"AddSecurityProfileDto", string(data)}, " ")
}
