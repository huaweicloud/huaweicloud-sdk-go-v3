...
type ServiceCapability struct {
	...
	Properties *[]ServiceProperty `json:"properties,omitempty" xml:"properties"`

	// **参数说明**：设备服务支持的命令列表。 **取值范围**：数组长度大小不超过500。
	Commands *[]ServiceCommand `json:"commands,omitempty" xml:"commands"`

	// **参数说明**：设备服务支持的事件列表。 **取值范围**：数组长度大小不超过500。
	Events *[]ServiceEvent `json:"events,omitempty" xml:"events"`
