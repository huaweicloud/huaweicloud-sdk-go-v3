...
// ListOtaModulesRequest Request Object
...
func (o ListOtaModulesRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListOtaModulesRequest struct{}"
	}

	return strings.Join([]string{"ListOtaModulesRequest", string(data)}, " ")
}
