...
// ListDeviceRequest 查询指定设备证书的设备列表结构体。
...
func (o ListDeviceRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListDeviceRequest struct{}"
	}

	return strings.Join([]string{"ListDeviceRequest", string(data)}, " ")
}
