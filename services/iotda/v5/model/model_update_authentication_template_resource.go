...
// UpdateAuthenticationTemplateResource 更新鉴权模板设备资源详情结构体。
type UpdateAuthenticationTemplateResource struct {
...
func (o UpdateAuthenticationTemplateResource) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateAuthenticationTemplateResource struct{}"
	}

	return strings.Join([]string{"UpdateAuthenticationTemplateResource", string(data)}, " ")
}
