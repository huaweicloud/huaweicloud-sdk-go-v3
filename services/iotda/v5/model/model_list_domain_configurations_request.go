...
// ListDomainConfigurationsRequest Request Object
...
func (o ListDomainConfigurationsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListDomainConfigurationsRequest struct{}"
	}

	return strings.Join([]string{"ListDomainConfigurationsRequest", string(data)}, " ")
}
