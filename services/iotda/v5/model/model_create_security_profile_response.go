...
// CreateSecurityProfileResponse Response Object
...
func (o CreateSecurityProfileResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateSecurityProfileResponse struct{}"
	}

	return strings.Join([]string{"CreateSecurityProfileResponse", string(data)}, " ")
}
