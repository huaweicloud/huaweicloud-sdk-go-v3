...
type Cmd struct {
	...
	CommandBody *interface{} `json:"command_body" xml:"command_body"`
	...
	BufferTimeout *int32 `json:"buffer_timeout,omitempty" xml:"buffer_timeout"`

	// **参数说明**：命令响应的有效时间，单位为秒，表示设备接收到命令后，在response_timeout时间内响应有效，超过这个时间未收到命令的响应，则认为命令响应超时，默认值为1800s。
	ResponseTimeout *int32 `json:"response_timeout,omitempty" xml:"response_timeout"`
