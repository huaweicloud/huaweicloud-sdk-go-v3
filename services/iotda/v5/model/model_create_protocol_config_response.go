...
// CreateProtocolConfigResponse Response Object
type CreateProtocolConfigResponse struct {
...
func (o CreateProtocolConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateProtocolConfigResponse struct{}"
	}

	return strings.Join([]string{"CreateProtocolConfigResponse", string(data)}, " ")
}
