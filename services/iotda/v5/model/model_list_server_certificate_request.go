...
// ListServerCertificateRequest Request Object
type ListServerCertificateRequest struct {
...
func (o ListServerCertificateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListServerCertificateRequest struct{}"
	}

	return strings.Join([]string{"ListServerCertificateRequest", string(data)}, " ")
}
