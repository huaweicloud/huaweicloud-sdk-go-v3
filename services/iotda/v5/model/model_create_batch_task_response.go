...
type CreateBatchTaskResponse struct {
	...
	TargetsFilter map[string]interface{} `json:"targets_filter,omitempty" xml:"targets_filter"`
	...
	Document *interface{} `json:"document,omitempty" xml:"document"`

	TaskPolicy *TaskPolicy `json:"task_policy,omitempty" xml:"task_policy"`
	...
	StatusDesc *string `json:"status_desc,omitempty" xml:"status_desc"`

	TaskProgress *TaskProgress `json:"task_progress,omitempty" xml:"task_progress"`
