...
// AddHarmonySoftBusResponse Response Object
type AddHarmonySoftBusResponse struct {
...
func (o AddHarmonySoftBusResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "AddHarmonySoftBusResponse struct{}"
	}

	return strings.Join([]string{"AddHarmonySoftBusResponse", string(data)}, " ")
}
