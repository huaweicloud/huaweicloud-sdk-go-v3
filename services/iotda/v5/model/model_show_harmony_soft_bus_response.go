...
// ShowHarmonySoftBusResponse Response Object
type ShowHarmonySoftBusResponse struct {
...
func (o ShowHarmonySoftBusResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowHarmonySoftBusResponse struct{}"
	}

	return strings.Join([]string{"ShowHarmonySoftBusResponse", string(data)}, " ")
}
