...
type ServiceProperty struct {
	...
	Required *bool `json:"required,omitempty" xml:"required"`
	...
	// **参数说明**：设备属性的步长。
	Step *float64 `json:"step,omitempty" xml:"step"`
	...
	DefaultValue *interface{} `json:"default_value,omitempty" xml:"default_value"`
}
