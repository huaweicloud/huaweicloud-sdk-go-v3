...
// CreateProtocolConfigDto 泛协议配置信息
type CreateProtocolConfigDto struct {
...
func (o CreateProtocolConfigDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateProtocolConfigDto struct{}"
	}

	return strings.Join([]string{"CreateProtocolConfigDto", string(data)}, " ")
}
