...
// UpdateDomainConfigurationResponse Response Object
...
func (o UpdateDomainConfigurationResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateDomainConfigurationResponse struct{}"
	}

	return strings.Join([]string{"UpdateDomainConfigurationResponse", string(data)}, " ")
}
