...
// ShowDeviceCertificateRequest Request Object
type ShowDeviceCertificateRequest struct {
...
func (o ShowDeviceCertificateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowDeviceCertificateRequest struct{}"
	}

	return strings.Join([]string{"ShowDeviceCertificateRequest", string(data)}, " ")
}
