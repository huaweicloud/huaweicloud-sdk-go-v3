...
type RuleAction struct {
	...
	SmnForwarding *ActionSmnForwarding `json:"smn_forwarding,omitempty" xml:"smn_forwarding"`

	DeviceAlarm *ActionDeviceAlarm `json:"device_alarm,omitempty" xml:"device_alarm"`

	DeviceCommand *ActionDeviceCommand `json:"device_command,omitempty" xml:"device_command"`
}
