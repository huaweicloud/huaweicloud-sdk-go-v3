...
// ListProtocolConfigsRequest Request Object
type ListProtocolConfigsRequest struct {
...
func (o ListProtocolConfigsRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListProtocolConfigsRequest struct{}"
	}

	return strings.Join([]string{"ListProtocolConfigsRequest", string(data)}, " ")
}
