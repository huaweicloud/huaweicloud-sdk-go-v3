...
// UpdateDeviceCertificateRequest Request Object
type UpdateDeviceCertificateRequest struct {
	...
	Body *UpdateDeviceCertificate `json:"body,omitempty"`
}

func (o UpdateDeviceCertificateRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateDeviceCertificateRequest struct{}"
	}

	return strings.Join([]string{"UpdateDeviceCertificateRequest", string(data)}, " ")
}
