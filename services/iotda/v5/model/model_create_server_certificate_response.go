...
// CreateServerCertificateResponse Response Object
...
func (o CreateServerCertificateResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "CreateServerCertificateResponse struct{}"
	}

	return strings.Join([]string{"CreateServerCertificateResponse", string(data)}, " ")
}
