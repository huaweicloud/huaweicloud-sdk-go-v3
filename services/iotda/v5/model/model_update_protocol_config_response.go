...
// UpdateProtocolConfigResponse Response Object
type UpdateProtocolConfigResponse struct {
...
func (o UpdateProtocolConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "UpdateProtocolConfigResponse struct{}"
	}

	return strings.Join([]string{"UpdateProtocolConfigResponse", string(data)}, " ")
}
