...
// ShowProtocolConfigResponse Response Object
type ShowProtocolConfigResponse struct {
...
func (o ShowProtocolConfigResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowProtocolConfigResponse struct{}"
	}

	return strings.Join([]string{"ShowProtocolConfigResponse", string(data)}, " ")
}
