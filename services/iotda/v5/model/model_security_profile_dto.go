...
func (o SecurityProfileDto) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "SecurityProfileDto struct{}"
	}

	return strings.Join([]string{"SecurityProfileDto", string(data)}, " ")
}
