...
type ShowDeviceMessageResponse struct {
	...
	// 消息内容。
	Message *interface{} `json:"message,omitempty" xml:"message"`
	...
	PayloadFormat *string `json:"payload_format,omitempty" xml:"payload_format"`
	...
	FinishedTime   *string `json:"finished_time,omitempty" xml:"finished_time"`
...
func (o ShowDeviceMessageResponse) String() string {
	...
	if err != nil {
		return "ShowDeviceMessageResponse struct{}"
	}

	return strings.Join([]string{"ShowDeviceMessageResponse", string(data)}, " ")
}
