...
// ListDeviceAuthenticationTemplatesRequest Request Object
type ListDeviceAuthenticationTemplatesRequest struct {
...
func (o ListDeviceAuthenticationTemplatesRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListDeviceAuthenticationTemplatesRequest struct{}"
	}

	return strings.Join([]string{"ListDeviceAuthenticationTemplatesRequest", string(data)}, " ")
}
