...
// ListHarmonySoftBusRequest Request Object
type ListHarmonySoftBusRequest struct {
...
func (o ListHarmonySoftBusRequest) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ListHarmonySoftBusRequest struct{}"
	}

	return strings.Join([]string{"ListHarmonySoftBusRequest", string(data)}, " ")
}
