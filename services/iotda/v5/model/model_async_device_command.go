...
type AsyncDeviceCommand struct {
...
func (o AsyncDeviceCommand) String() string {
	data, err := json.Marshal(o)
	if err != nil {
		return "AsyncDeviceCommand struct{}"
	}

	return strings.Join([]string{"AsyncDeviceCommand", string(data)}, " ")
}
