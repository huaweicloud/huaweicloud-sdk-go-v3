...
// BindResourceLevelComplianceResponse Response Object
type BindResourceLevelComplianceResponse struct {
...
func (o BindResourceLevelComplianceResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "BindResourceLevelComplianceResponse struct{}"
	}

	return strings.Join([]string{"BindResourceLevelComplianceResponse", string(data)}, " ")
}
