...
// ShowComplianceRuleResponse Response Object
type ShowComplianceRuleResponse struct {
...
func (o ShowComplianceRuleResponse) String() string {
	data, err := utils.Marshal(o)
	if err != nil {
		return "ShowComplianceRuleResponse struct{}"
	}

	return strings.Join([]string{"ShowComplianceRuleResponse", string(data)}, " ")
}
