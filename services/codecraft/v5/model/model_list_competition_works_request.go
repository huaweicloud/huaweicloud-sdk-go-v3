...
type ListCompetitionWorksRequest struct {
	...
	// 要查询的大赛ID，由大赛平台提供
	CompetitionId int32 `json:"competition_id" xml:"competition_id"`

	// 要查询的大赛阶段ID，由大赛平台提供
	StageId int32 `json:"stage_id" xml:"stage_id"`

	// 查询的截止时间
	ReadTime string `json:"read_time" xml:"read_time"`

	// 查询的时间范围。day表示以read_time作为结束时间,前一天内作为查询范围,hour表示以read_time作为结束时间,前一小内时作为查询范围。
	TimeUnit *ListCompetitionWorksRequestTimeUnit `json:"time_unit,omitempty" xml:"time_unit"`
	...
	SortDir *ListCompetitionWorksRequestSortDir `json:"sort_dir,omitempty" xml:"sort_dir"`
}
