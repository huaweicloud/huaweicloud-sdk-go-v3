...
type JobQueryBean struct {
	...
	// 作业执行进度。
	JobProgress *float32 `json:"job_progress,omitempty" xml:"job_progress"`
	...
	// 作业开始执行时间。单位：毫秒。
	StartedTime *int64 `json:"started_time,omitempty" xml:"started_time"`

	// 作业提交时间。单位：毫秒。
	SubmittedTime *int64 `json:"submitted_time,omitempty" xml:"submitted_time"`

	// 作业完成时间。单位：毫秒。
	FinishedTime *int64 `json:"finished_time,omitempty" xml:"finished_time"`

	// 作业执行时长。单位：毫秒。
	ElapsedTime *int64 `json:"elapsed_time,omitempty" xml:"elapsed_time"`

	// 运行参数。
	Arguments *string `json:"arguments,omitempty" xml:"arguments"`

	// 实际作业编号。
	LauncherId *string `json:"launcher_id,omitempty" xml:"launcher_id"`

	// 配置参数，用于传-d参数。最多为2048字符，不能包含><|'`&!\\特殊字符，可为空。
	Properties *string `json:"properties,omitempty" xml:"properties"`
	...
	TrackingUrl *string `json:"tracking_url,omitempty" xml:"tracking_url"`
