...
type NodeGroupV2 struct {
	...
	NodeSize string `json:"node_size" xml:"node_size"`

	RootVolume *Volume `json:"root_volume,omitempty" xml:"root_volume"`

	DataVolume *Volume `json:"data_volume,omitempty" xml:"data_volume"`
	...
	AutoScalingPolicy *AutoScalingPolicy `json:"auto_scaling_policy,omitempty" xml:"auto_scaling_policy"`
	...
	AssignedRoles *[]string `json:"assigned_roles,omitempty" xml:"assigned_roles"`
}
