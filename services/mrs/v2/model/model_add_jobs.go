...
type AddJobs struct {
	...
	ShutdownCluster *bool `json:"shutdown_cluster,omitempty" xml:"shutdown_cluster"`

	// - true：创建集群同时提交作业  - false：单独提交作业  此处应设置为true。
	SubmitJobOnceClusterRun bool `json:"submit_job_once_cluster_run" xml:"submit_job_once_cluster_run"`
