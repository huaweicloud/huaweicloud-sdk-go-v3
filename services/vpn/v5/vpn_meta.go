...
func GenReqDefForCreateP2cVgw() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v5/{project_id}/p2c-vpn-gateways").
		WithResponse(new(model.CreateP2cVgwResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteP2cVgw() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v5/{project_id}/p2c-vpn-gateways/{p2c_vgw_id}").
		WithResponse(new(model.DeleteP2cVgwResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteP2cVpnGatewayJob() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v5/{project_id}/p2c-vpn-gateways/jobs/{job_id}").
		WithResponse(new(model.DeleteP2cVpnGatewayJobResponse)).
		WithContentType("application/json")
...
func GenReqDefForListP2cVpnGatewayJobs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5/{project_id}/p2c-vpn-gateways/jobs").
		WithResponse(new(model.ListP2cVpnGatewayJobsResponse)).
		WithContentType("application/json")
...
func GenReqDefForUpgradeP2cVpnGateway() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v5/{project_id}/p2c-vpn-gateways/{p2c_vgw_id}/upgrade").
		WithResponse(new(model.UpgradeP2cVpnGatewayResponse)).
		WithContentType("application/json")
...
func GenReqDefForExportVpnConnectionPeerConfiguration() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v5/{project_id}/vpn-connection/{vpn_connection_id}/peer-configuration/export").
		WithResponse(new(model.ExportVpnConnectionPeerConfigurationResponse)).
		WithContentType("application/json")
...
func GenReqDefForListConnectionIpsecSa() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5/{project_id}/vpn-connection/{vpn_connection_id}/ipsec-sa").
		WithResponse(new(model.ListConnectionIpsecSaResponse)).
		WithContentType("application/json")
...
func GenReqDefForListPeerConfigurationSupportedDevices() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5/{project_id}/peer-configuration/supported-devices").
		WithResponse(new(model.ListPeerConfigurationSupportedDevicesResponse)).
		WithContentType("application/json")
...
func GenReqDefForDeleteVpnGatewayJob() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodDelete).
		WithPath("/v5/{project_id}/vpn-gateways/jobs/{job_id}").
		WithResponse(new(model.DeleteVpnGatewayJobResponse)).
		WithContentType("application/json")
...
func GenReqDefForListExtendedAvailabilityZones() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5.1/{project_id}/vpn-gateways/availability-zones").
		WithResponse(new(model.ListExtendedAvailabilityZonesResponse)).
		WithContentType("application/json")
...
func GenReqDefForListVpnGatewayJobs() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5/{project_id}/vpn-gateways/jobs").
		WithResponse(new(model.ListVpnGatewayJobsResponse)).
		WithContentType("application/json")
...
func GenReqDefForShowVpnGatewayRoutingTable() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5/{project_id}/vpn-gateways/{vgw_id}/routing-table").
		WithResponse(new(model.ShowVpnGatewayRoutingTableResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("IsIncludeNexthopResource").
		WithJsonTag("is_include_nexthop_resource").
		WithLocationType(def.Query))
...
func GenReqDefForUpgradeVpnGateway() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v5/{project_id}/vpn-gateways/{vgw_id}/upgrade").
		WithResponse(new(model.UpgradeVpnGatewayResponse)).
		WithContentType("application/json")
...
func GenReqDefForListVpnGatewayCertificates() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodGet).
		WithPath("/v5/{project_id}/vpn-gateway-certificates").
		WithResponse(new(model.ListVpnGatewayCertificatesResponse)).
		WithContentType("application/json")
	...
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		...
		WithLocationType(def.Query))
	reqDefBuilder.WithRequestField(def.NewFieldDef().
		WithName("PreExpireDays").
		WithJsonTag("pre_expire_days").
		WithLocationType(def.Query))
...
func GenReqDefForBatchCreateVpnUsers() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v5/{project_id}/p2c-vpn-gateways/vpn-servers/{vpn_server_id}/users/batch-create").
		WithResponse(new(model.BatchCreateVpnUsersResponse)).
		WithContentType("application/json")
...
func GenReqDefForBatchDeleteVpnUsers() *def.HttpRequestDef {
	reqDefBuilder := def.NewHttpRequestDefBuilder().
		WithMethod(http.MethodPost).
		WithPath("/v5/{project_id}/p2c-vpn-gateways/vpn-servers/{vpn_server_id}/users/batch-delete").
		WithResponse(new(model.BatchDeleteVpnUsersResponse)).
		WithContentType("application/json")
