...
func (o UpdateResponseVpnConnection) String() string {
	...
	if err != nil {
		return "UpdateResponseVpnConnection struct{}"
	}

	return strings.Join([]string{"UpdateResponseVpnConnection", string(data)}, " ")
}
...
type UpdateResponseVpnConnectionStyleEnum struct {
	POLICY UpdateResponseVpnConnectionStyle
	STATIC UpdateResponseVpnConnectionStyle
	BGP    UpdateResponseVpnConnectionStyle
}

func GetUpdateResponseVpnConnectionStyleEnum() UpdateResponseVpnConnectionStyleEnum {
	return UpdateResponseVpnConnectionStyleEnum{
		POLICY: UpdateResponseVpnConnectionStyle{
			value: "POLICY",
		},
		STATIC: UpdateResponseVpnConnectionStyle{
