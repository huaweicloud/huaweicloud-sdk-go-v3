...
type FreeResourceDetail struct {
	...
	FreeResourceId *string `json:"free_resource_id,omitempty" xml:"free_resource_id"`

	// 资源项类型名称。
	FreeResourceTypeName *string `json:"free_resource_type_name,omitempty" xml:"free_resource_type_name"`

	// 重置周期，只有quota_reuse_mode为可重置，该字段才有意义。 1：小时2：天3：周4：月5：年
	QuotaReuseCycle *int32 `json:"quota_reuse_cycle,omitempty" xml:"quota_reuse_cycle"`
	...
	QuotaReuseCycleType *int32 `json:"quota_reuse_cycle_type,omitempty" xml:"quota_reuse_cycle_type"`

	// 使用量类型名称。
	UsageTypeName *string `json:"usage_type_name,omitempty" xml:"usage_type_name"`
	...
	OriginalAmount *float64 `json:"original_amount,omitempty" xml:"original_amount"`
