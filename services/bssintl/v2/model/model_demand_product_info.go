...
type DemandProductInfo struct {
	...
	UsageFactor string `json:"usage_factor" xml:"usage_factor"`

	// 使用量值。 例如按小时询价，使用量值为1，使用量单位为小时。
	UsageValue float64 `json:"usage_value" xml:"usage_value"`

	// 使用量度量单位，您可以调用查询度量单位列表接口获取。 例如按小时询价，使用量值为1，使用量单位为小时。
	UsageMeasureId int32 `json:"usage_measure_id" xml:"usage_measure_id"`
