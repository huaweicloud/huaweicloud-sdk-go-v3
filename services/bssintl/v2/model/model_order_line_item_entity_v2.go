...
type OrderLineItemEntityV2 struct {
	...
	// 订单项ID。
	OrderLineItemId *string `json:"order_line_item_id,omitempty" xml:"order_line_item_id"`
	...
	// 订购数量。
	SubscriptionNum *int32 `json:"subscription_num,omitempty" xml:"subscription_num"`
	...
	CommercialResource *string `json:"commercial_resource,omitempty" xml:"commercial_resource"`
}
