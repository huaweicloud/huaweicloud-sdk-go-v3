...
type ListServiceDetailsResponse struct {
	...
	CidrType *ListServiceDetailsResponseCidrType `json:"cidr_type,omitempty"`
...
type ListServiceDetailsResponseCidrTypeEnum struct {
	PUBLIC   ListServiceDetailsResponseCidrType
	INTERNAL ListServiceDetailsResponseCidrType
}

func GetListServiceDetailsResponseCidrTypeEnum() ListServiceDetailsResponseCidrTypeEnum {
	return ListServiceDetailsResponseCidrTypeEnum{
		PUBLIC: ListServiceDetailsResponseCidrType{
			value: "public",
		},
		INTERNAL: ListServiceDetailsResponseCidrType{
