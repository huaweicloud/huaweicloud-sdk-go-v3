...
type ListServiceDetailsResponse struct {
	...
	Status *ListServiceDetailsResponseStatus `json:"status,omitempty" xml:"status"`
	...
	ServerType *ListServiceDetailsResponseServerType `json:"server_type,omitempty" xml:"server_type"`
	...
	CidrType *string `json:"cidr_type,omitempty" xml:"cidr_type"`
	...
	TcpProxy *ListServiceDetailsResponseTcpProxy `json:"tcp_proxy,omitempty" xml:"tcp_proxy"`
