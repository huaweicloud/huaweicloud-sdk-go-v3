...
type UpdateEndpointServiceResponse struct {
	...
	ServerType *UpdateEndpointServiceResponseServerType `json:"server_type,omitempty" xml:"server_type"`
	...
	Status *UpdateEndpointServiceResponseStatus `json:"status,omitempty" xml:"status"`
	...
	CidrType *UpdateEndpointServiceResponseCidrType `json:"cidr_type,omitempty" xml:"cidr_type"`
	...
	TcpProxy *UpdateEndpointServiceResponseTcpProxy `json:"tcp_proxy,omitempty" xml:"tcp_proxy"`
