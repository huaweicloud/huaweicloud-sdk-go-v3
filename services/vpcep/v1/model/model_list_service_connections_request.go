...
type ListServiceConnectionsRequest struct {
	...
	// 终端节点服务的ID。
	VpcEndpointServiceId string `json:"vpc_endpoint_service_id" xml:"vpc_endpoint_service_id"`

	// 终端节点的ID，唯一标识。
	Id *string `json:"id,omitempty" xml:"id"`

	// 终端节点的报文标识。
	MarkerId *string `json:"marker_id,omitempty" xml:"marker_id"`
	...
	SortKey *ListServiceConnectionsRequestSortKey `json:"sort_key,omitempty" xml:"sort_key"`

	// 查询结果中终端节点列表的排序方 式，取值为： ● desc：降序排序 ● asc：升序排序 默认值为desc。
	SortDir *ListServiceConnectionsRequestSortDir `json:"sort_dir,omitempty" xml:"sort_dir"`
