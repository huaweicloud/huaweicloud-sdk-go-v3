...
type ServiceList struct {
	...
	Status *ServiceListStatus `json:"status,omitempty" xml:"status"`
	...
	ServerType *ServiceListServerType `json:"server_type,omitempty" xml:"server_type"`
	...
	ConnectionCount *int32 `json:"connection_count,omitempty" xml:"connection_count"`
	...
	TcpProxy *ServiceListTcpProxy `json:"tcp_proxy,omitempty" xml:"tcp_proxy"`
