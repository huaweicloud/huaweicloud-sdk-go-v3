...
type CreateEndpointServiceRequestBody struct {
	...
	ServerType CreateEndpointServiceRequestBodyServerType `json:"server_type" xml:"server_type"`
	...
	Ports []PortList `json:"ports" xml:"ports"`
	...
	TcpProxy *CreateEndpointServiceRequestBodyTcpProxy `json:"tcp_proxy,omitempty" xml:"tcp_proxy"`
