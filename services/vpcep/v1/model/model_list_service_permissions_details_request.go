...
type ListServicePermissionsDetailsRequest struct {
	...
	SortKey *ListServicePermissionsDetailsRequestSortKey `json:"sort_key,omitempty" xml:"sort_key"`

	// 查询结果中白名单列表的排序方 式，取值为： ● desc：降序排序 ● asc：升序排序 默认值为desc。
	SortDir *ListServicePermissionsDetailsRequestSortDir `json:"sort_dir,omitempty" xml:"sort_dir"`
}
