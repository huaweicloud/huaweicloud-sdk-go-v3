...
type AnalysisInfo struct {
	...
	Diarization *bool `json:"diarization,omitempty" xml:"diarization"`
	...
	Channel *AnalysisInfoChannel `json:"channel,omitempty" xml:"channel"`

	// 是否需要做情绪检测, 缺省为true。
	Emotion *bool `json:"emotion,omitempty" xml:"emotion"`

	// 是否需要输出语速信息, 缺省为true。
	Speed *bool `json:"speed,omitempty" xml:"speed"`
}
