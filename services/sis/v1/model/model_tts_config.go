...
type TtsConfig struct {
	...
	AudioFormat *TtsConfigAudioFormat `json:"audio_format,omitempty" xml:"audio_format"`

	// 采样率：16000、8000 默认：8000
	SampleRate *TtsConfigSampleRate `json:"sample_rate,omitempty" xml:"sample_rate"`
	...
	Property *TtsConfigProperty `json:"property,omitempty" xml:"property"`

	// 语速。 取值范围：[-500,500]  默认值：0
	Speed *int32 `json:"speed,omitempty" xml:"speed"`

	// 音高。 取值范围： [-500,500]  默认值：0
	Pitch *int32 `json:"pitch,omitempty" xml:"pitch"`

	// 音量。 取值范围：[0, 100]  默认值：50
	Volume *int32 `json:"volume,omitempty" xml:"volume"`
}
